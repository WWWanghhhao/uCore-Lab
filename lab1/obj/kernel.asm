...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200158:	9d450513          	addi	a0,a0,-1580 # 80200b28 <etext+0xfc>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    8020016c:	05f0006f          	j	802009ca <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200176:	03b0006f          	j	802009b0 <sbi_console_putchar>
...
void idt_init(void) {
  ...
  write_csr(stvec, &__alltraps);
    ...
    80200188:	38878793          	addi	a5,a5,904 # 8020050c <__alltraps>
...
void print_regs(struct pushregs *gpr) {
  ...
  cprintf("  zero     0x%08x\n", gpr->zero);
    ...
    8020019e:	9ae50513          	addi	a0,a0,-1618 # 80200b48 <etext+0x11c>
void print_regs(struct pushregs *gpr) {
  ...
  cprintf("  t6       0x%08x\n", gpr->t6);
    ...
    80200356:	ade50513          	addi	a0,a0,-1314 # 80200e30 <etext+0x404>
}
...
void print_trapframe(struct trapframe *tf) {
  ...
  cprintf("trapframe at %p\n", tf);
    ...
    8020036a:	ae250513          	addi	a0,a0,-1310 # 80200e48 <etext+0x41c>
void print_trapframe(struct trapframe *tf) {
  ...
  cprintf("  cause    0x%08x\n", tf->cause);
    ...
    802003b6:	af650513          	addi	a0,a0,-1290 # 80200ea8 <etext+0x47c>
}
...
void interrupt_handler(struct trapframe *tf) {
  intptr_t cause = (tf->cause << 1) >> 1;
    ...
    802003d0:	ba470713          	addi	a4,a4,-1116 # 80200f70 <etext+0x544>
  ...
  case IRQ_M_SOFT:
    ...
    802003e2:	b4250513          	addi	a0,a0,-1214 # 80200f20 <etext+0x4f4>
    802003e6:	b151                	j	8020006a <cprintf>
    cprintf("Hypervisor software interrupt\n");
    802003e8:	00001517          	auipc	a0,0x1
    802003ec:	b1850513          	addi	a0,a0,-1256 # 80200f00 <etext+0x4d4>
    802003f0:	b9ad                	j	8020006a <cprintf>
    cprintf("User software interrupt\n");
    802003f2:	00001517          	auipc	a0,0x1
    802003f6:	ace50513          	addi	a0,a0,-1330 # 80200ec0 <etext+0x494>
    802003fa:	b985                	j	8020006a <cprintf>
    cprintf("Supervisor software interrupt\n");
    802003fc:	00001517          	auipc	a0,0x1
    80200400:	ae450513          	addi	a0,a0,-1308 # 80200ee0 <etext+0x4b4>
...
void interrupt_handler(struct trapframe *tf) {
  ...
  default:
    ...
    80200432:	b2250513          	addi	a0,a0,-1246 # 80200f50 <etext+0x524>
  ...
  cprintf("%d ticks\n", TICK_NUM);
    ...
    80200442:	b0250513          	addi	a0,a0,-1278 # 80200f40 <etext+0x514>
      ticks = 0;
  ...
  cprintf("%d ticks\n", TICK_NUM);
    ...
    80200464:	fcd792e3          	bne	a5,a3,80200428 <interrupt_handler+0x6a>
}
...
static inline void trap_dispatch(struct trapframe *tf) {
  if ((intptr_t)tf->cause < 0) {
    ...
    interrupt_handler(tf);
    80200508:	bd5d                	j	802003be <interrupt_handler>
	...
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200600:	a2c78793          	addi	a5,a5,-1492 # 80201028 <etext+0x5fc>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020065c:	a04a8a93          	addi	s5,s5,-1532 # 8020105c <etext+0x630>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200664:	bd8b8b93          	addi	s7,s7,-1064 # 80201238 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008ba:	7a260613          	addi	a2,a2,1954 # 80201058 <etext+0x62c>
    ...
    802008cc:	78060613          	addi	a2,a2,1920 # 80201048 <etext+0x61c>
    ...
    802008de:	76640413          	addi	s0,s0,1894 # 80201040 <etext+0x614>
    ...
    80200968:	6dc40413          	addi	s0,s0,1756 # 80201040 <etext+0x614>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020097e:	6c7a0a13          	addi	s4,s4,1735 # 80201041 <etext+0x615>
