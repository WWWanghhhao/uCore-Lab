...
void interrupt_handler(struct trapframe *tf) {
  ...
  default:
    ...
    80200432:	a9a50513          	addi	a0,a0,-1382 # 80200ec8 <etext+0x524>
  ...
  cprintf("%d ticks\n", TICK_NUM);
    ...
    80200442:	a7a50513          	addi	a0,a0,-1414 # 80200eb8 <etext+0x514>
    ...
    8020045c:	fcd796e3          	bne	a5,a3,80200428 <interrupt_handler+0x6a>
}
