...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200176:	05d0006f          	j	802009d2 <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200180:	0390006f          	j	802009b8 <sbi_console_putchar>
...
void interrupt_handler(struct trapframe *tf) {
  ...
  cprintf("%d ticks\n", TICK_NUM);
    ...
    8020047c:	0141                	addi	sp,sp,16
        sbi_shutdown();
    8020047e:	a3bd                	j	802009ec <sbi_shutdown>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200608:	a2c78793          	addi	a5,a5,-1492 # 80201030 <etext+0x5fc>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200664:	a04a8a93          	addi	s5,s5,-1532 # 80201064 <etext+0x630>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    8020066c:	bd8b8b93          	addi	s7,s7,-1064 # 80201240 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008c2:	7a260613          	addi	a2,a2,1954 # 80201060 <etext+0x62c>
    ...
    802008d4:	78060613          	addi	a2,a2,1920 # 80201050 <etext+0x61c>
    ...
    802008e6:	76640413          	addi	s0,s0,1894 # 80201048 <etext+0x614>
    ...
    80200970:	6dc40413          	addi	s0,s0,1756 # 80201048 <etext+0x614>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200986:	6c7a0a13          	addi	s4,s4,1735 # 80201049 <etext+0x615>
