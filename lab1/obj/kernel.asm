...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200436:	b1e50513          	addi	a0,a0,-1250 # 80200f50 <etext+0x520>
    ...
    cprintf("%d ticks\n", TICK_NUM);
    80200452:	c1fff0ef          	jal	ra,80200070 <cprintf>
                num++;
    ...
    8020046c:	60a2                	ld	ra,8(sp)
                    num=0;
    8020046e:	00004797          	auipc	a5,0x4
    80200472:	ba07b523          	sd	zero,-1110(a5) # 80204018 <num>
}
