...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	36c040ef          	jal	ra,ffffffffc02043b6 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	39258593          	addi	a1,a1,914 # ffffffffc02043e0 <etext>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3aa50513          	addi	a0,a0,938 # ffffffffc0204400 <etext+0x20>
...
ffffffffc020006e:	618030ef          	jal	ra,ffffffffc0203686 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	657030ef          	jal	ra,ffffffffc0203f04 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	621030ef          	jal	ra,ffffffffc0203f04 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	30450513          	addi	a0,a0,772 # ffffffffc0204408 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	30e50513          	addi	a0,a0,782 # ffffffffc0204428 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2ba58593          	addi	a1,a1,698 # ffffffffc02043e0 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	31a50513          	addi	a0,a0,794 # ffffffffc0204448 <etext+0x68>
...
ffffffffc0200146:	32650513          	addi	a0,a0,806 # ffffffffc0204468 <etext+0x88>
...
ffffffffc020015a:	33250513          	addi	a0,a0,818 # ffffffffc0204488 <etext+0xa8>
...
ffffffffc0200188:	32450513          	addi	a0,a0,804 # ffffffffc02044a8 <etext+0xc8>
}
...
ffffffffc0200196:	34660613          	addi	a2,a2,838 # ffffffffc02044d8 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	35250513          	addi	a0,a0,850 # ffffffffc02044f0 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	35a60613          	addi	a2,a2,858 # ffffffffc0204508 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	37258593          	addi	a1,a1,882 # ffffffffc0204528 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	37250513          	addi	a0,a0,882 # ffffffffc0204530 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	37460613          	addi	a2,a2,884 # ffffffffc0204540 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	39458593          	addi	a1,a1,916 # ffffffffc0204568 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	35450513          	addi	a0,a0,852 # ffffffffc0204530 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	39060613          	addi	a2,a2,912 # ffffffffc0204578 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3a858593          	addi	a1,a1,936 # ffffffffc0204598 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	33850513          	addi	a0,a0,824 # ffffffffc0204530 <etext+0x150>
...
ffffffffc0200236:	37650513          	addi	a0,a0,886 # ffffffffc02045a8 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	37c50513          	addi	a0,a0,892 # ffffffffc02045d0 <etext+0x1f0>
...
ffffffffc020026e:	3cec0c13          	addi	s8,s8,974 # ffffffffc0204638 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	7d690913          	addi	s2,s2,2006 # ffffffffc0205a48 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	37e48493          	addi	s1,s1,894 # ffffffffc02045f8 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	37cb0b13          	addi	s6,s6,892 # ffffffffc0204600 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	29ca0a13          	addi	s4,s4,668 # ffffffffc0204528 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7ef030ef          	jal	ra,ffffffffc0204286 <readline>
...
ffffffffc02002b2:	38ad0d13          	addi	s10,s10,906 # ffffffffc0204638 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0c6040ef          	jal	ra,ffffffffc0204382 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0b2040ef          	jal	ra,ffffffffc0204382 <strcmp>
...
ffffffffc020030e:	092040ef          	jal	ra,ffffffffc02043a0 <strchr>
...
ffffffffc020034c:	054040ef          	jal	ra,ffffffffc02043a0 <strchr>
...
ffffffffc020036a:	2ba50513          	addi	a0,a0,698 # ffffffffc0204620 <etext+0x240>
...
ffffffffc02003a6:	2de50513          	addi	a0,a0,734 # ffffffffc0204680 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	1e050513          	addi	a0,a0,480 # ffffffffc0205598 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	2aa50513          	addi	a0,a0,682 # ffffffffc02046a0 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	711030ef          	jal	ra,ffffffffc02043c8 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6ed030ef          	jal	ra,ffffffffc02043c8 <memcpy>
    return 0;
}
...
ffffffffc0200528:	19c50513          	addi	a0,a0,412 # ffffffffc02046c0 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7160306f          	j	ffffffffc0203c5e <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	19460613          	addi	a2,a2,404 # ffffffffc02046e0 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	1a050513          	addi	a0,a0,416 # ffffffffc02046f8 <commands+0xc0>
...
ffffffffc020058e:	18650513          	addi	a0,a0,390 # ffffffffc0204710 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	2b650513          	addi	a0,a0,694 # ffffffffc02049f8 <commands+0x3c0>
}
...
ffffffffc020075a:	2ba50513          	addi	a0,a0,698 # ffffffffc0204a10 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	2ba50513          	addi	a0,a0,698 # ffffffffc0204a28 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	2c250513          	addi	a0,a0,706 # ffffffffc0204a40 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	2ca50513          	addi	a0,a0,714 # ffffffffc0204a58 <commands+0x420>
...
ffffffffc02007a6:	2ce50513          	addi	a0,a0,718 # ffffffffc0204a70 <commands+0x438>
}
...
ffffffffc02007c2:	37a70713          	addi	a4,a4,890 # ffffffffc0204b38 <commands+0x500>
...
ffffffffc02007d4:	31850513          	addi	a0,a0,792 # ffffffffc0204ae8 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	2ec50513          	addi	a0,a0,748 # ffffffffc0204ac8 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	2a050513          	addi	a0,a0,672 # ffffffffc0204a88 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	2b450513          	addi	a0,a0,692 # ffffffffc0204aa8 <commands+0x470>
...
ffffffffc020082a:	2f250513          	addi	a0,a0,754 # ffffffffc0204b18 <commands+0x4e0>
...
ffffffffc020083e:	2ce50513          	addi	a0,a0,718 # ffffffffc0204b08 <commands+0x4d0>
}
...
ffffffffc0200860:	4c470713          	addi	a4,a4,1220 # ffffffffc0204d20 <commands+0x6e8>
...
ffffffffc0200872:	49a50513          	addi	a0,a0,1178 # ffffffffc0204d08 <commands+0x6d0>
...
ffffffffc0200894:	2d850513          	addi	a0,a0,728 # ffffffffc0204b68 <commands+0x530>
}
...
ffffffffc02008a8:	2e450513          	addi	a0,a0,740 # ffffffffc0204b88 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	2fa50513          	addi	a0,a0,762 # ffffffffc0204ba8 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	30850513          	addi	a0,a0,776 # ffffffffc0204bc0 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	30e50513          	addi	a0,a0,782 # ffffffffc0204bd0 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	32450513          	addi	a0,a0,804 # ffffffffc0204bf0 <commands+0x5b8>
...
ffffffffc02008ee:	31e60613          	addi	a2,a2,798 # ffffffffc0204c08 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	e0250513          	addi	a0,a0,-510 # ffffffffc02046f8 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	32650513          	addi	a0,a0,806 # ffffffffc0204c28 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	33450513          	addi	a0,a0,820 # ffffffffc0204c40 <commands+0x608>
...
ffffffffc0200998:	27460613          	addi	a2,a2,628 # ffffffffc0204c08 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	d5850513          	addi	a0,a0,-680 # ffffffffc02046f8 <commands+0xc0>
...
ffffffffc02009c4:	24860613          	addi	a2,a2,584 # ffffffffc0204c08 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	d2c50513          	addi	a0,a0,-724 # ffffffffc02046f8 <commands+0xc0>
...
ffffffffc0200b6e:	65e5b583          	ld	a1,1630(a1) # ffffffffc02061c8 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	65a63603          	ld	a2,1626(a2) # ffffffffc02061d0 <nbase>
...
ffffffffc0200dc6:	f9e68693          	addi	a3,a3,-98 # ffffffffc0204d60 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	fa660613          	addi	a2,a2,-90 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	fb250513          	addi	a0,a0,-78 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	03e68693          	addi	a3,a3,62 # ffffffffc0204e20 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	f8660613          	addi	a2,a2,-122 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	f9250513          	addi	a0,a0,-110 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	04668693          	addi	a3,a3,70 # ffffffffc0204e48 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	f6660613          	addi	a2,a2,-154 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f7250513          	addi	a0,a0,-142 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	06668693          	addi	a3,a3,102 # ffffffffc0204e88 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	f4660613          	addi	a2,a2,-186 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	f5250513          	addi	a0,a0,-174 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	0ce68693          	addi	a3,a3,206 # ffffffffc0204f10 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	f2660613          	addi	a2,a2,-218 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	f3250513          	addi	a0,a0,-206 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	f5e68693          	addi	a3,a3,-162 # ffffffffc0204dc0 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	f0660613          	addi	a2,a2,-250 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	f1250513          	addi	a0,a0,-238 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	07e68693          	addi	a3,a3,126 # ffffffffc0204f00 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	ee660613          	addi	a2,a2,-282 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	ef250513          	addi	a0,a0,-270 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	04668693          	addi	a3,a3,70 # ffffffffc0204ee8 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	ec660613          	addi	a2,a2,-314 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	ed250513          	addi	a0,a0,-302 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	00668693          	addi	a3,a3,6 # ffffffffc0204ec8 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	ea660613          	addi	a2,a2,-346 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	eb250513          	addi	a0,a0,-334 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	07668693          	addi	a3,a3,118 # ffffffffc0204f58 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	e8660613          	addi	a2,a2,-378 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	e9250513          	addi	a0,a0,-366 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	04668693          	addi	a3,a3,70 # ffffffffc0204f48 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	e6660613          	addi	a2,a2,-410 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e7250513          	addi	a0,a0,-398 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	fc668693          	addi	a3,a3,-58 # ffffffffc0204ee8 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	e4660613          	addi	a2,a2,-442 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	e5250513          	addi	a0,a0,-430 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	fe668693          	addi	a3,a3,-26 # ffffffffc0204f28 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	e2660613          	addi	a2,a2,-474 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	e3250513          	addi	a0,a0,-462 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	e5e68693          	addi	a3,a3,-418 # ffffffffc0204dc0 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	e0660613          	addi	a2,a2,-506 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	e1250513          	addi	a0,a0,-494 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	f6668693          	addi	a3,a3,-154 # ffffffffc0204ee8 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	de660613          	addi	a2,a2,-538 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	df250513          	addi	a0,a0,-526 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	e5e68693          	addi	a3,a3,-418 # ffffffffc0204e00 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	dc660613          	addi	a2,a2,-570 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	dd250513          	addi	a0,a0,-558 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	e1e68693          	addi	a3,a3,-482 # ffffffffc0204de0 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	da660613          	addi	a2,a2,-602 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	db250513          	addi	a0,a0,-590 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	e1e68693          	addi	a3,a3,-482 # ffffffffc0204e00 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	d8660613          	addi	a2,a2,-634 # ffffffffc0204d70 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	d9250513          	addi	a0,a0,-622 # ffffffffc0204d88 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	0a668693          	addi	a3,a3,166 # ffffffffc02050a8 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	d6660613          	addi	a2,a2,-666 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d7250513          	addi	a0,a0,-654 # ffffffffc0204d88 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	f2668693          	addi	a3,a3,-218 # ffffffffc0204f48 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	d4660613          	addi	a2,a2,-698 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	d5250513          	addi	a0,a0,-686 # ffffffffc0204d88 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	ea668693          	addi	a3,a3,-346 # ffffffffc0204ee8 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	d2660613          	addi	a2,a2,-730 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	d3250513          	addi	a0,a0,-718 # ffffffffc0204d88 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	e4668693          	addi	a3,a3,-442 # ffffffffc0204ea8 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	d0660613          	addi	a2,a2,-762 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	d1250513          	addi	a0,a0,-750 # ffffffffc0204d88 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	fe668693          	addi	a3,a3,-26 # ffffffffc0205068 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	ce660613          	addi	a2,a2,-794 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	cf250513          	addi	a0,a0,-782 # ffffffffc0204d88 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	fa668693          	addi	a3,a3,-90 # ffffffffc0205048 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	cc660613          	addi	a2,a2,-826 # ffffffffc0204d70 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	cd250513          	addi	a0,a0,-814 # ffffffffc0204d88 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	f5e68693          	addi	a3,a3,-162 # ffffffffc0205020 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	ca660613          	addi	a2,a2,-858 # ffffffffc0204d70 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	cb250513          	addi	a0,a0,-846 # ffffffffc0204d88 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	f1668693          	addi	a3,a3,-234 # ffffffffc0204ff8 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	c8660613          	addi	a2,a2,-890 # ffffffffc0204d70 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	c9250513          	addi	a0,a0,-878 # ffffffffc0204d88 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	ee668693          	addi	a3,a3,-282 # ffffffffc0204fe8 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	c6660613          	addi	a2,a2,-922 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c7250513          	addi	a0,a0,-910 # ffffffffc0204d88 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	dc668693          	addi	a3,a3,-570 # ffffffffc0204ee8 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	c4660613          	addi	a2,a2,-954 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	c5250513          	addi	a0,a0,-942 # ffffffffc0204d88 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	e8668693          	addi	a3,a3,-378 # ffffffffc0204fc8 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	c2660613          	addi	a2,a2,-986 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	c3250513          	addi	a0,a0,-974 # ffffffffc0204d88 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	e3668693          	addi	a3,a3,-458 # ffffffffc0204f98 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	c1250513          	addi	a0,a0,-1006 # ffffffffc0204d88 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	dfe68693          	addi	a3,a3,-514 # ffffffffc0204f80 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	be660613          	addi	a2,a2,-1050 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	bf250513          	addi	a0,a0,-1038 # ffffffffc0204d88 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	d4668693          	addi	a3,a3,-698 # ffffffffc0204ee8 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	bc660613          	addi	a2,a2,-1082 # ffffffffc0204d70 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	bd250513          	addi	a0,a0,-1070 # ffffffffc0204d88 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	da668693          	addi	a3,a3,-602 # ffffffffc0204f68 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	ba660613          	addi	a2,a2,-1114 # ffffffffc0204d70 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	bb250513          	addi	a0,a0,-1102 # ffffffffc0204d88 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	ea668693          	addi	a3,a3,-346 # ffffffffc0205088 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	b8660613          	addi	a2,a2,-1146 # ffffffffc0204d70 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	b9250513          	addi	a0,a0,-1134 # ffffffffc0204d88 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	eb668693          	addi	a3,a3,-330 # ffffffffc02050b8 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	b6660613          	addi	a2,a2,-1178 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b7250513          	addi	a0,a0,-1166 # ffffffffc0204d88 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	b7e68693          	addi	a3,a3,-1154 # ffffffffc0204da0 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	b4660613          	addi	a2,a2,-1210 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	b5250513          	addi	a0,a0,-1198 # ffffffffc0204d88 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	b9e68693          	addi	a3,a3,-1122 # ffffffffc0204de0 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	b2660613          	addi	a2,a2,-1242 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	b3250513          	addi	a0,a0,-1230 # ffffffffc0204d88 <commands+0x750>
...
ffffffffc020139e:	d3668693          	addi	a3,a3,-714 # ffffffffc02050d0 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	9ce60613          	addi	a2,a2,-1586 # ffffffffc0204d70 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	9da50513          	addi	a0,a0,-1574 # ffffffffc0204d88 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	d0e68693          	addi	a3,a3,-754 # ffffffffc02050c8 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204d70 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	9ba50513          	addi	a0,a0,-1606 # ffffffffc0204d88 <commands+0x750>
...
ffffffffc0201476:	c5668693          	addi	a3,a3,-938 # ffffffffc02050c8 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	8f660613          	addi	a2,a2,-1802 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	90250513          	addi	a0,a0,-1790 # ffffffffc0204d88 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	bb068693          	addi	a3,a3,-1104 # ffffffffc02050f8 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	82060613          	addi	a2,a2,-2016 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	82c50513          	addi	a0,a0,-2004 # ffffffffc0204d88 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	b6068693          	addi	a3,a3,-1184 # ffffffffc02050c8 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	80060613          	addi	a2,a2,-2048 # ffffffffc0204d70 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	80c50513          	addi	a0,a0,-2036 # ffffffffc0204d88 <commands+0x750>
...
ffffffffc020158e:	bce60613          	addi	a2,a2,-1074 # ffffffffc0205158 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	be250513          	addi	a0,a0,-1054 # ffffffffc0205178 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	be260613          	addi	a2,a2,-1054 # ffffffffc0205188 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	bc650513          	addi	a0,a0,-1082 # ffffffffc0205178 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	aaab3b03          	ld	s6,-1366(s6) # ffffffffc02061c8 <error_string+0x38>
...
ffffffffc0201760:	457020ef          	jal	ra,ffffffffc02043b6 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	9fcb3b03          	ld	s6,-1540(s6) # ffffffffc02061c8 <error_string+0x38>
...
ffffffffc0201802:	3b5020ef          	jal	ra,ffffffffc02043b6 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	95260613          	addi	a2,a2,-1710 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0201866:	10400593          	li	a1,260
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	96e50513          	addi	a0,a0,-1682 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	93a60613          	addi	a2,a2,-1734 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc020187e:	11300593          	li	a1,275
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	95650513          	addi	a0,a0,-1706 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	92060613          	addi	a2,a2,-1760 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0201898:	10e00593          	li	a1,270
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	93c50513          	addi	a0,a0,-1732 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	90660613          	addi	a2,a2,-1786 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	92250513          	addi	a0,a0,-1758 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	7d443403          	ld	s0,2004(s0) # ffffffffc02061c8 <error_string+0x38>
...
ffffffffc0201aba:	66a78793          	addi	a5,a5,1642 # ffffffffc0205120 <default_pmm_manager>
...
ffffffffc0201ac8:	72450513          	addi	a0,a0,1828 # ffffffffc02051e8 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	6e050513          	addi	a0,a0,1760 # ffffffffc0205200 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	70050513          	addi	a0,a0,1792 # ffffffffc0205230 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	6fe50513          	addi	a0,a0,1790 # ffffffffc0205248 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	6c250513          	addi	a0,a0,1730 # ffffffffc0205298 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	3cecbc83          	ld	s9,974(s9) # ffffffffc02061c8 <error_string+0x38>
...
ffffffffc0201ea2:	6e250513          	addi	a0,a0,1762 # ffffffffc0205580 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	76458593          	addi	a1,a1,1892 # ffffffffc02056b8 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	410020ef          	jal	ra,ffffffffc0204370 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	416020ef          	jal	ra,ffffffffc0204382 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	394020ef          	jal	ra,ffffffffc020433a <strlen>
...
ffffffffc020209c:	69850513          	addi	a0,a0,1688 # ffffffffc0205730 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	44268693          	addi	a3,a3,1090 # ffffffffc02055e0 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	bca60613          	addi	a2,a2,-1078 # ffffffffc0204d70 <commands+0x738>
ffffffffc02021ae:	1d400593          	li	a1,468
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	02650513          	addi	a0,a0,38 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	3e268693          	addi	a3,a3,994 # ffffffffc02055a0 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	baa60613          	addi	a2,a2,-1110 # ffffffffc0204d70 <commands+0x738>
ffffffffc02021ce:	1d300593          	li	a1,467
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	00650513          	addi	a0,a0,6 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	fd060613          	addi	a2,a2,-48 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc02021e8:	1d300593          	li	a1,467
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	fec50513          	addi	a0,a0,-20 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	07460613          	addi	a2,a2,116 # ffffffffc0205270 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	fd050513          	addi	a0,a0,-48 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	05c60613          	addi	a2,a2,92 # ffffffffc0205270 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	fb850513          	addi	a0,a0,-72 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	0ac68693          	addi	a3,a3,172 # ffffffffc02052d8 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	b3c60613          	addi	a2,a2,-1220 # ffffffffc0204d70 <commands+0x738>
ffffffffc020223c:	19900593          	li	a1,409
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	f9850513          	addi	a0,a0,-104 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	06c68693          	addi	a3,a3,108 # ffffffffc02052b8 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	b1c60613          	addi	a2,a2,-1252 # ffffffffc0204d70 <commands+0x738>
ffffffffc020225c:	19800593          	li	a1,408
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	f7850513          	addi	a0,a0,-136 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	0f868693          	addi	a3,a3,248 # ffffffffc0205368 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	af860613          	addi	a2,a2,-1288 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202280:	1a000593          	li	a1,416
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	f5450513          	addi	a0,a0,-172 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	0a868693          	addi	a3,a3,168 # ffffffffc0205338 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	ad860613          	addi	a2,a2,-1320 # ffffffffc0204d70 <commands+0x738>
ffffffffc02022a0:	19e00593          	li	a1,414
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	f3450513          	addi	a0,a0,-204 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	06068693          	addi	a3,a3,96 # ffffffffc0205310 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	ab860613          	addi	a2,a2,-1352 # ffffffffc0204d70 <commands+0x738>
ffffffffc02022c0:	19a00593          	li	a1,410
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	f1450513          	addi	a0,a0,-236 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	12068693          	addi	a3,a3,288 # ffffffffc02053f0 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	a9860613          	addi	a2,a2,-1384 # ffffffffc0204d70 <commands+0x738>
ffffffffc02022e0:	1a900593          	li	a1,425
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	ef450513          	addi	a0,a0,-268 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	1a068693          	addi	a3,a3,416 # ffffffffc0205490 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	a7860613          	addi	a2,a2,-1416 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202300:	1ae00593          	li	a1,430
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	ed450513          	addi	a0,a0,-300 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	0b868693          	addi	a3,a3,184 # ffffffffc02053c8 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	a5860613          	addi	a2,a2,-1448 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202320:	1a600593          	li	a1,422
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	eb450513          	addi	a0,a0,-332 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	e7e60613          	addi	a2,a2,-386 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc020233a:	1a500593          	li	a1,421
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	e9a50513          	addi	a0,a0,-358 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	0de68693          	addi	a3,a3,222 # ffffffffc0205428 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0204d70 <commands+0x738>
ffffffffc020235a:	1b300593          	li	a1,435
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	e7a50513          	addi	a0,a0,-390 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	18668693          	addi	a3,a3,390 # ffffffffc02054f0 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	9fe60613          	addi	a2,a2,-1538 # ffffffffc0204d70 <commands+0x738>
ffffffffc020237a:	1b200593          	li	a1,434
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	e5a50513          	addi	a0,a0,-422 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	14e68693          	addi	a3,a3,334 # ffffffffc02054d8 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	9de60613          	addi	a2,a2,-1570 # ffffffffc0204d70 <commands+0x738>
ffffffffc020239a:	1b100593          	li	a1,433
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	e3a50513          	addi	a0,a0,-454 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	0fe68693          	addi	a3,a3,254 # ffffffffc02054a8 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	9be60613          	addi	a2,a2,-1602 # ffffffffc0204d70 <commands+0x738>
ffffffffc02023ba:	1b000593          	li	a1,432
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	e1a50513          	addi	a0,a0,-486 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	29668693          	addi	a3,a3,662 # ffffffffc0205660 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	99e60613          	addi	a2,a2,-1634 # ffffffffc0204d70 <commands+0x738>
ffffffffc02023da:	1de00593          	li	a1,478
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	dfa50513          	addi	a0,a0,-518 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	08e68693          	addi	a3,a3,142 # ffffffffc0205478 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	97e60613          	addi	a2,a2,-1666 # ffffffffc0204d70 <commands+0x738>
ffffffffc02023fa:	1ad00593          	li	a1,429
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	dda50513          	addi	a0,a0,-550 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	05e68693          	addi	a3,a3,94 # ffffffffc0205468 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	95e60613          	addi	a2,a2,-1698 # ffffffffc0204d70 <commands+0x738>
ffffffffc020241a:	1ac00593          	li	a1,428
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	dba50513          	addi	a0,a0,-582 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	13668693          	addi	a3,a3,310 # ffffffffc0205560 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	93e60613          	addi	a2,a2,-1730 # ffffffffc0204d70 <commands+0x738>
ffffffffc020243a:	1ee00593          	li	a1,494
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	d9a50513          	addi	a0,a0,-614 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	00e68693          	addi	a3,a3,14 # ffffffffc0205458 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	91e60613          	addi	a2,a2,-1762 # ffffffffc0204d70 <commands+0x738>
ffffffffc020245a:	1ab00593          	li	a1,427
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	d7a50513          	addi	a0,a0,-646 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	f4668693          	addi	a3,a3,-186 # ffffffffc02053b0 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	8fe60613          	addi	a2,a2,-1794 # ffffffffc0204d70 <commands+0x738>
ffffffffc020247a:	1b800593          	li	a1,440
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	d5a50513          	addi	a0,a0,-678 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	07e68693          	addi	a3,a3,126 # ffffffffc0205508 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	8de60613          	addi	a2,a2,-1826 # ffffffffc0204d70 <commands+0x738>
ffffffffc020249a:	1b500593          	li	a1,437
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	d3a50513          	addi	a0,a0,-710 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	eee68693          	addi	a3,a3,-274 # ffffffffc0205398 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	8be60613          	addi	a2,a2,-1858 # ffffffffc0204d70 <commands+0x738>
ffffffffc02024ba:	1b400593          	li	a1,436
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	d1a50513          	addi	a0,a0,-742 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	ce660613          	addi	a2,a2,-794 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	ca250513          	addi	a0,a0,-862 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	05668693          	addi	a3,a3,86 # ffffffffc0205538 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	88660613          	addi	a2,a2,-1914 # ffffffffc0204d70 <commands+0x738>
ffffffffc02024f2:	1bf00593          	li	a1,447
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	ce250513          	addi	a0,a0,-798 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	fee68693          	addi	a3,a3,-18 # ffffffffc02054f0 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	86660613          	addi	a2,a2,-1946 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202512:	1bd00593          	li	a1,445
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	cc250513          	addi	a0,a0,-830 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	ffe68693          	addi	a3,a3,-2 # ffffffffc0205520 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	84660613          	addi	a2,a2,-1978 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202532:	1bc00593          	li	a1,444
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	ca250513          	addi	a0,a0,-862 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	fae68693          	addi	a3,a3,-82 # ffffffffc02054f0 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	82660613          	addi	a2,a2,-2010 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202552:	1b900593          	li	a1,441
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	c8250513          	addi	a0,a0,-894 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	0e668693          	addi	a3,a3,230 # ffffffffc0205648 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	80660613          	addi	a2,a2,-2042 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202572:	1dd00593          	li	a1,477
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	c6250513          	addi	a0,a0,-926 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	08e68693          	addi	a3,a3,142 # ffffffffc0205610 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00002617          	auipc	a2,0x2
ffffffffc020258e:	7e660613          	addi	a2,a2,2022 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202592:	1dc00593          	li	a1,476
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	c4250513          	addi	a0,a0,-958 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	05668693          	addi	a3,a3,86 # ffffffffc02055f8 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	7c660613          	addi	a2,a2,1990 # ffffffffc0204d70 <commands+0x738>
ffffffffc02025b2:	1d800593          	li	a1,472
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	c2250513          	addi	a0,a0,-990 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	f9e68693          	addi	a3,a3,-98 # ffffffffc0205560 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	7a660613          	addi	a2,a2,1958 # ffffffffc0204d70 <commands+0x738>
ffffffffc02025d2:	1c600593          	li	a1,454
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	c0250513          	addi	a0,a0,-1022 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	db668693          	addi	a3,a3,-586 # ffffffffc0205398 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	78660613          	addi	a2,a2,1926 # ffffffffc0204d70 <commands+0x738>
ffffffffc02025f2:	1a100593          	li	a1,417
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	be250513          	addi	a0,a0,-1054 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	bae60613          	addi	a2,a2,-1106 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc020260a:	1a400593          	li	a1,420
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	bca50513          	addi	a0,a0,-1078 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	d9668693          	addi	a3,a3,-618 # ffffffffc02053b0 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	74e60613          	addi	a2,a2,1870 # ffffffffc0204d70 <commands+0x738>
ffffffffc020262a:	1a200593          	li	a1,418
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	baa50513          	addi	a0,a0,-1110 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	dee68693          	addi	a3,a3,-530 # ffffffffc0205428 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	72e60613          	addi	a2,a2,1838 # ffffffffc0204d70 <commands+0x738>
ffffffffc020264a:	1aa00593          	li	a1,426
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	b8a50513          	addi	a0,a0,-1142 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	0ae68693          	addi	a3,a3,174 # ffffffffc0205708 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	70e60613          	addi	a2,a2,1806 # ffffffffc0204d70 <commands+0x738>
ffffffffc020266a:	1e600593          	li	a1,486
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	b6a50513          	addi	a0,a0,-1174 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	05668693          	addi	a3,a3,86 # ffffffffc02056d0 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	6ee60613          	addi	a2,a2,1774 # ffffffffc0204d70 <commands+0x738>
ffffffffc020268a:	1e300593          	li	a1,483
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	b4a50513          	addi	a0,a0,-1206 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	00668693          	addi	a3,a3,6 # ffffffffc02056a0 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	6ce60613          	addi	a2,a2,1742 # ffffffffc0204d70 <commands+0x738>
ffffffffc02026aa:	1df00593          	li	a1,479
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	b2a50513          	addi	a0,a0,-1238 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	03068693          	addi	a3,a3,48 # ffffffffc0205750 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	64860613          	addi	a2,a2,1608 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202730:	18000593          	li	a1,384
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	aa450513          	addi	a0,a0,-1372 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	a286b683          	ld	a3,-1496(a3) # ffffffffc02061c8 <error_string+0x38>
...
ffffffffc02027dc:	f9068693          	addi	a3,a3,-112 # ffffffffc0205768 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	59060613          	addi	a2,a2,1424 # ffffffffc0204d70 <commands+0x738>
ffffffffc02027e8:	1f600593          	li	a1,502
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	9ec50513          	addi	a0,a0,-1556 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	9b660613          	addi	a2,a2,-1610 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	97250513          	addi	a0,a0,-1678 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f7668693          	addi	a3,a3,-138 # ffffffffc0205788 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	55660613          	addi	a2,a2,1366 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202822:	1f900593          	li	a1,505
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	9b250513          	addi	a0,a0,-1614 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0205270 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	8aa50513          	addi	a0,a0,-1878 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	ebe68693          	addi	a3,a3,-322 # ffffffffc0205798 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	48e60613          	addi	a2,a2,1166 # ffffffffc0204d70 <commands+0x738>
ffffffffc02028ea:	20100593          	li	a1,513
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	8ea50513          	addi	a0,a0,-1814 # ffffffffc02051d8 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	e6e68693          	addi	a3,a3,-402 # ffffffffc0205768 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	46e60613          	addi	a2,a2,1134 # ffffffffc0204d70 <commands+0x738>
ffffffffc020290a:	20000593          	li	a1,512
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	8ca50513          	addi	a0,a0,-1846 # ffffffffc02051d8 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3f6010ef          	jal	ra,ffffffffc0203d2c <swapfs_init>
...
ffffffffc0202994:	e4850513          	addi	a0,a0,-440 # ffffffffc02057d8 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	e1050513          	addi	a0,a0,-496 # ffffffffc02057f0 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	2df000ef          	jal	ra,ffffffffc02034ca <mm_create>
...
ffffffffc0202a20:	2f3000ef          	jal	ra,ffffffffc0203512 <vma_create>
...
ffffffffc0202a2c:	355000ef          	jal	ra,ffffffffc0203580 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	e3050513          	addi	a0,a0,-464 # ffffffffc0205860 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	e6450513          	addi	a0,a0,-412 # ffffffffc02058b0 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	e7850513          	addi	a0,a0,-392 # ffffffffc0205938 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	634c0c13          	addi	s8,s8,1588 # ffffffffc02061d0 <nbase>
...
ffffffffc0202c10:	dd450513          	addi	a0,a0,-556 # ffffffffc02059e0 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	21b000ef          	jal	ra,ffffffffc0203650 <mm_destroy>
...
ffffffffc0202c62:	db250513          	addi	a0,a0,-590 # ffffffffc0205a10 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	dc650513          	addi	a0,a0,-570 # ffffffffc0205a30 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	0e468693          	addi	a3,a3,228 # ffffffffc0204d60 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	0ec60613          	addi	a2,a2,236 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202c8c:	0d800593          	li	a1,216
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	b3850513          	addi	a0,a0,-1224 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	d1c68693          	addi	a3,a3,-740 # ffffffffc02059b8 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	0cc60613          	addi	a2,a2,204 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202cac:	11800593          	li	a1,280
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	b1850513          	addi	a0,a0,-1256 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	4cc60613          	addi	a2,a2,1228 # ffffffffc0205188 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	4b050513          	addi	a0,a0,1200 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	48460613          	addi	a2,a2,1156 # ffffffffc0205158 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	49850513          	addi	a0,a0,1176 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	c0468693          	addi	a3,a3,-1020 # ffffffffc02058f0 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	07c60613          	addi	a2,a2,124 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202cfc:	0f900593          	li	a1,249
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	ac850513          	addi	a0,a0,-1336 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	bcc68693          	addi	a3,a3,-1076 # ffffffffc02058d8 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	05c60613          	addi	a2,a2,92 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202d1c:	0f800593          	li	a1,248
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	aa850513          	addi	a0,a0,-1368 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	a7c60613          	addi	a2,a2,-1412 # ffffffffc02057a8 <default_pmm_manager+0x688>
ffffffffc0202d34:	04400593          	li	a1,68
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	a9050513          	addi	a0,a0,-1392 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	c5c68693          	addi	a3,a3,-932 # ffffffffc02059a0 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	02460613          	addi	a2,a2,36 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202d54:	11700593          	li	a1,279
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a7050513          	addi	a0,a0,-1424 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	c2c68693          	addi	a3,a3,-980 # ffffffffc0205990 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	00460613          	addi	a2,a2,4 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202d74:	0bb00593          	li	a1,187
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	a5050513          	addi	a0,a0,-1456 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	c0c68693          	addi	a3,a3,-1012 # ffffffffc0205990 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	fe460613          	addi	a2,a2,-28 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202d94:	0bd00593          	li	a1,189
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	a3050513          	addi	a0,a0,-1488 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	1a468693          	addi	a3,a3,420 # ffffffffc0204f48 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	fc460613          	addi	a2,a2,-60 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202db4:	10f00593          	li	a1,271
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	a1050513          	addi	a0,a0,-1520 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	c4468693          	addi	a3,a3,-956 # ffffffffc0205a08 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	fa460613          	addi	a2,a2,-92 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202dd4:	11e00593          	li	a1,286
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	9f050513          	addi	a0,a0,-1552 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205840 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	f8460613          	addi	a2,a2,-124 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202df4:	0e800593          	li	a1,232
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	9d050513          	addi	a0,a0,-1584 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	a4c68693          	addi	a3,a3,-1460 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	f6460613          	addi	a2,a2,-156 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202e14:	0eb00593          	li	a1,235
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	9b050513          	addi	a0,a0,-1616 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a7468693          	addi	a3,a3,-1420 # ffffffffc0205898 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	f4460613          	addi	a2,a2,-188 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202e34:	0f300593          	li	a1,243
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	99050513          	addi	a0,a0,-1648 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	f5c68693          	addi	a3,a3,-164 # ffffffffc0204da0 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	f2460613          	addi	a2,a2,-220 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202e54:	0db00593          	li	a1,219
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	97050513          	addi	a0,a0,-1680 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	b0c68693          	addi	a3,a3,-1268 # ffffffffc0205970 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	f0460613          	addi	a2,a2,-252 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202e74:	0b300593          	li	a1,179
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	95050513          	addi	a0,a0,-1712 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	aec68693          	addi	a3,a3,-1300 # ffffffffc0205970 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	ee460613          	addi	a2,a2,-284 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202e94:	0b500593          	li	a1,181
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	93050513          	addi	a0,a0,-1744 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	adc68693          	addi	a3,a3,-1316 # ffffffffc0205980 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	ec460613          	addi	a2,a2,-316 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202eb4:	0b700593          	li	a1,183
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	91050513          	addi	a0,a0,-1776 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	abc68693          	addi	a3,a3,-1348 # ffffffffc0205980 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	ea460613          	addi	a2,a2,-348 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202ed4:	0b900593          	li	a1,185
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	8f050513          	addi	a0,a0,-1808 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	a7c68693          	addi	a3,a3,-1412 # ffffffffc0205960 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	e8460613          	addi	a2,a2,-380 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202ef4:	0af00593          	li	a1,175
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	8d050513          	addi	a0,a0,-1840 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205960 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	e6460613          	addi	a2,a2,-412 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202f14:	0b100593          	li	a1,177
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	8b050513          	addi	a0,a0,-1872 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	8f468693          	addi	a3,a3,-1804 # ffffffffc0205818 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	e4460613          	addi	a2,a2,-444 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202f34:	0e000593          	li	a1,224
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	89050513          	addi	a0,a0,-1904 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	8e468693          	addi	a3,a3,-1820 # ffffffffc0205828 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	e2460613          	addi	a2,a2,-476 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202f54:	0e300593          	li	a1,227
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	87050513          	addi	a0,a0,-1936 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	9ac68693          	addi	a3,a3,-1620 # ffffffffc0205910 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	e0460613          	addi	a2,a2,-508 # ffffffffc0204d70 <commands+0x738>
ffffffffc0202f74:	10600593          	li	a1,262
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	85050513          	addi	a0,a0,-1968 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	aecb0b13          	addi	s6,s6,-1300 # ffffffffc0205ab0 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	accb8b93          	addi	s7,s7,-1332 # ffffffffc0205a98 <default_pmm_manager+0x978>
...
ffffffffc0203040:	5bf000ef          	jal	ra,ffffffffc0203dfe <swapfs_write>
...
ffffffffc0203082:	9d250513          	addi	a0,a0,-1582 # ffffffffc0205a50 <default_pmm_manager+0x930>
...
ffffffffc0203094:	9f068693          	addi	a3,a3,-1552 # ffffffffc0205a80 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	cd860613          	addi	a2,a2,-808 # ffffffffc0204d70 <commands+0x738>
ffffffffc02030a0:	08300593          	li	a1,131
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	72450513          	addi	a0,a0,1828 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	487000ef          	jal	ra,ffffffffc0203d64 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	a1850513          	addi	a0,a0,-1512 # ffffffffc0205b00 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	9e668693          	addi	a3,a3,-1562 # ffffffffc0205af0 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	c5e60613          	addi	a2,a2,-930 # ffffffffc0204d70 <commands+0x738>
ffffffffc020311a:	09a00593          	li	a1,154
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	6aa50513          	addi	a0,a0,1706 # ffffffffc02057c8 <default_pmm_manager+0x6a8>
...
ffffffffc0203210:	78468693          	addi	a3,a3,1924 # ffffffffc0205990 <default_pmm_manager+0x870>
ffffffffc0203214:	00002617          	auipc	a2,0x2
ffffffffc0203218:	b5c60613          	addi	a2,a2,-1188 # ffffffffc0204d70 <commands+0x738>
ffffffffc020321c:	08a00593          	li	a1,138
ffffffffc0203220:	00003517          	auipc	a0,0x3
ffffffffc0203224:	92050513          	addi	a0,a0,-1760 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203228:	94cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020322c:	00003697          	auipc	a3,0x3
ffffffffc0203230:	96468693          	addi	a3,a3,-1692 # ffffffffc0205b90 <default_pmm_manager+0xa70>
ffffffffc0203234:	00002617          	auipc	a2,0x2
ffffffffc0203238:	b3c60613          	addi	a2,a2,-1220 # ffffffffc0204d70 <commands+0x738>
ffffffffc020323c:	0a100593          	li	a1,161
ffffffffc0203240:	00003517          	auipc	a0,0x3
ffffffffc0203244:	90050513          	addi	a0,a0,-1792 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203248:	92cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020324c:	00003697          	auipc	a3,0x3
ffffffffc0203250:	91c68693          	addi	a3,a3,-1764 # ffffffffc0205b68 <default_pmm_manager+0xa48>
ffffffffc0203254:	00002617          	auipc	a2,0x2
ffffffffc0203258:	b1c60613          	addi	a2,a2,-1252 # ffffffffc0204d70 <commands+0x738>
ffffffffc020325c:	09f00593          	li	a1,159
ffffffffc0203260:	00003517          	auipc	a0,0x3
ffffffffc0203264:	8e050513          	addi	a0,a0,-1824 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203268:	90cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020326c:	00003697          	auipc	a3,0x3
ffffffffc0203270:	8ec68693          	addi	a3,a3,-1812 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc0203274:	00002617          	auipc	a2,0x2
ffffffffc0203278:	afc60613          	addi	a2,a2,-1284 # ffffffffc0204d70 <commands+0x738>
ffffffffc020327c:	09e00593          	li	a1,158
ffffffffc0203280:	00003517          	auipc	a0,0x3
ffffffffc0203284:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203288:	8ecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020328c:	00003697          	auipc	a3,0x3
ffffffffc0203290:	8cc68693          	addi	a3,a3,-1844 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc0203294:	00002617          	auipc	a2,0x2
ffffffffc0203298:	adc60613          	addi	a2,a2,-1316 # ffffffffc0204d70 <commands+0x738>
ffffffffc020329c:	09c00593          	li	a1,156
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	8a050513          	addi	a0,a0,-1888 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc02032a8:	8ccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ac:	00003697          	auipc	a3,0x3
ffffffffc02032b0:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc02032b4:	00002617          	auipc	a2,0x2
ffffffffc02032b8:	abc60613          	addi	a2,a2,-1348 # ffffffffc0204d70 <commands+0x738>
ffffffffc02032bc:	09a00593          	li	a1,154
ffffffffc02032c0:	00003517          	auipc	a0,0x3
ffffffffc02032c4:	88050513          	addi	a0,a0,-1920 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc02032c8:	8acfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032cc:	00003697          	auipc	a3,0x3
ffffffffc02032d0:	88c68693          	addi	a3,a3,-1908 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc02032d4:	00002617          	auipc	a2,0x2
ffffffffc02032d8:	a9c60613          	addi	a2,a2,-1380 # ffffffffc0204d70 <commands+0x738>
ffffffffc02032dc:	09800593          	li	a1,152
ffffffffc02032e0:	00003517          	auipc	a0,0x3
ffffffffc02032e4:	86050513          	addi	a0,a0,-1952 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc02032e8:	88cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ec:	00003697          	auipc	a3,0x3
ffffffffc02032f0:	86c68693          	addi	a3,a3,-1940 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc02032f4:	00002617          	auipc	a2,0x2
ffffffffc02032f8:	a7c60613          	addi	a2,a2,-1412 # ffffffffc0204d70 <commands+0x738>
ffffffffc02032fc:	09600593          	li	a1,150
ffffffffc0203300:	00003517          	auipc	a0,0x3
ffffffffc0203304:	84050513          	addi	a0,a0,-1984 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203308:	86cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020330c:	00003697          	auipc	a3,0x3
ffffffffc0203310:	84c68693          	addi	a3,a3,-1972 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	a5c60613          	addi	a2,a2,-1444 # ffffffffc0204d70 <commands+0x738>
ffffffffc020331c:	09400593          	li	a1,148
ffffffffc0203320:	00003517          	auipc	a0,0x3
ffffffffc0203324:	82050513          	addi	a0,a0,-2016 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203328:	84cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020332c:	00003697          	auipc	a3,0x3
ffffffffc0203330:	82c68693          	addi	a3,a3,-2004 # ffffffffc0205b58 <default_pmm_manager+0xa38>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	a3c60613          	addi	a2,a2,-1476 # ffffffffc0204d70 <commands+0x738>
ffffffffc020333c:	09200593          	li	a1,146
ffffffffc0203340:	00003517          	auipc	a0,0x3
ffffffffc0203344:	80050513          	addi	a0,a0,-2048 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	64468693          	addi	a3,a3,1604 # ffffffffc0205990 <default_pmm_manager+0x870>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	a1c60613          	addi	a2,a2,-1508 # ffffffffc0204d70 <commands+0x738>
ffffffffc020335c:	09000593          	li	a1,144
ffffffffc0203360:	00002517          	auipc	a0,0x2
ffffffffc0203364:	7e050513          	addi	a0,a0,2016 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020336c:	00002697          	auipc	a3,0x2
ffffffffc0203370:	62468693          	addi	a3,a3,1572 # ffffffffc0205990 <default_pmm_manager+0x870>
ffffffffc0203374:	00002617          	auipc	a2,0x2
ffffffffc0203378:	9fc60613          	addi	a2,a2,-1540 # ffffffffc0204d70 <commands+0x738>
ffffffffc020337c:	08e00593          	li	a1,142
ffffffffc0203380:	00002517          	auipc	a0,0x2
ffffffffc0203384:	7c050513          	addi	a0,a0,1984 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203388:	fedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020338c:	00002697          	auipc	a3,0x2
ffffffffc0203390:	60468693          	addi	a3,a3,1540 # ffffffffc0205990 <default_pmm_manager+0x870>
ffffffffc0203394:	00002617          	auipc	a2,0x2
ffffffffc0203398:	9dc60613          	addi	a2,a2,-1572 # ffffffffc0204d70 <commands+0x738>
ffffffffc020339c:	08c00593          	li	a1,140
ffffffffc02033a0:	00002517          	auipc	a0,0x2
ffffffffc02033a4:	7a050513          	addi	a0,a0,1952 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc02033a8:	fcdfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033ac <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033ac:	0000e797          	auipc	a5,0xe
ffffffffc02033b0:	1ac7b783          	ld	a5,428(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc02033b4:	cf89                	beqz	a5,ffffffffc02033ce <_clock_map_swappable+0x22>
    list_add_before(mm->sm_priv, entry);
ffffffffc02033b6:	751c                	ld	a5,40(a0)
ffffffffc02033b8:	03060713          	addi	a4,a2,48
}
ffffffffc02033bc:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc02033be:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc02033c0:	e398                	sd	a4,0(a5)
ffffffffc02033c2:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc02033c4:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc02033c6:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc02033c8:	fa14                	sd	a3,48(a2)
ffffffffc02033ca:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc02033d4:	7d068693          	addi	a3,a3,2000 # ffffffffc0205ba0 <default_pmm_manager+0xa80>
ffffffffc02033d8:	00002617          	auipc	a2,0x2
ffffffffc02033dc:	99860613          	addi	a2,a2,-1640 # ffffffffc0204d70 <commands+0x738>
ffffffffc02033e0:	03600593          	li	a1,54
ffffffffc02033e4:	00002517          	auipc	a0,0x2
ffffffffc02033e8:	75c50513          	addi	a0,a0,1884 # ffffffffc0205b40 <default_pmm_manager+0xa20>
{
ffffffffc02033ec:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033ee:	f87fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033f2 <_clock_swap_out_victim>:
         assert(head != NULL);
ffffffffc02033f2:	751c                	ld	a5,40(a0)
{
ffffffffc02033f4:	1141                	addi	sp,sp,-16
ffffffffc02033f6:	e406                	sd	ra,8(sp)
ffffffffc02033f8:	e022                	sd	s0,0(sp)
         assert(head != NULL);
ffffffffc02033fa:	c7b5                	beqz	a5,ffffffffc0203466 <_clock_swap_out_victim+0x74>
     assert(in_tick==0);
ffffffffc02033fc:	e649                	bnez	a2,ffffffffc0203486 <_clock_swap_out_victim+0x94>
ffffffffc02033fe:	0000e417          	auipc	s0,0xe
ffffffffc0203402:	15a40413          	addi	s0,s0,346 # ffffffffc0211558 <curr_ptr>
ffffffffc0203406:	852e                	mv	a0,a1
ffffffffc0203408:	600c                	ld	a1,0(s0)
    return listelm->next;
ffffffffc020340a:	0000e697          	auipc	a3,0xe
ffffffffc020340e:	cde68693          	addi	a3,a3,-802 # ffffffffc02110e8 <pra_list_head>
ffffffffc0203412:	6690                	ld	a2,8(a3)
ffffffffc0203414:	4701                	li	a4,0
        if (curr_ptr == &pra_list_head) {
ffffffffc0203416:	00d58b63          	beq	a1,a3,ffffffffc020342c <_clock_swap_out_victim+0x3a>
        if (p->visited == 0) {
ffffffffc020341a:	fe05b783          	ld	a5,-32(a1) # fe0 <kern_entry-0xffffffffc01ff020>
ffffffffc020341e:	cf81                	beqz	a5,ffffffffc0203436 <_clock_swap_out_victim+0x44>
            p->visited = 0;
ffffffffc0203420:	fe05b023          	sd	zero,-32(a1)
ffffffffc0203424:	658c                	ld	a1,8(a1)
    while (1) {
ffffffffc0203426:	4705                	li	a4,1
        if (curr_ptr == &pra_list_head) {
ffffffffc0203428:	fed599e3          	bne	a1,a3,ffffffffc020341a <_clock_swap_out_victim+0x28>
            curr_ptr = list_next(curr_ptr);
ffffffffc020342c:	85b2                	mv	a1,a2
        if (p->visited == 0) {
ffffffffc020342e:	fe05b783          	ld	a5,-32(a1)
ffffffffc0203432:	4705                	li	a4,1
ffffffffc0203434:	f7f5                	bnez	a5,ffffffffc0203420 <_clock_swap_out_victim+0x2e>
ffffffffc0203436:	c311                	beqz	a4,ffffffffc020343a <_clock_swap_out_victim+0x48>
ffffffffc0203438:	e00c                	sd	a1,0(s0)
        struct Page *p = le2page(curr_ptr, pra_page_link);
ffffffffc020343a:	fd058793          	addi	a5,a1,-48
            *ptr_page = p;
ffffffffc020343e:	e11c                	sd	a5,0(a0)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0203440:	00002517          	auipc	a0,0x2
ffffffffc0203444:	7a850513          	addi	a0,a0,1960 # ffffffffc0205be8 <default_pmm_manager+0xac8>
ffffffffc0203448:	c73fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc0203452:	6798                	ld	a4,8(a5)
    return listelm->prev;
ffffffffc0203454:	631c                	ld	a5,0(a4)
            curr_ptr = list_next(curr_ptr);
ffffffffc0203456:	e018                	sd	a4,0(s0)
}
ffffffffc0203458:	6402                	ld	s0,0(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc020345a:	6398                	ld	a4,0(a5)
ffffffffc020345c:	679c                	ld	a5,8(a5)
    prev->next = next;
ffffffffc020345e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203460:	e398                	sd	a4,0(a5)
ffffffffc0203462:	0141                	addi	sp,sp,16
ffffffffc0203464:	8082                	ret
         assert(head != NULL);
ffffffffc0203466:	00002697          	auipc	a3,0x2
ffffffffc020346a:	76268693          	addi	a3,a3,1890 # ffffffffc0205bc8 <default_pmm_manager+0xaa8>
ffffffffc020346e:	00002617          	auipc	a2,0x2
ffffffffc0203472:	90260613          	addi	a2,a2,-1790 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203476:	04800593          	li	a1,72
ffffffffc020347a:	00002517          	auipc	a0,0x2
ffffffffc020347e:	6c650513          	addi	a0,a0,1734 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203482:	ef3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203486:	00002697          	auipc	a3,0x2
ffffffffc020348a:	75268693          	addi	a3,a3,1874 # ffffffffc0205bd8 <default_pmm_manager+0xab8>
ffffffffc020348e:	00002617          	auipc	a2,0x2
ffffffffc0203492:	8e260613          	addi	a2,a2,-1822 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203496:	04900593          	li	a1,73
ffffffffc020349a:	00002517          	auipc	a0,0x2
ffffffffc020349e:	6a650513          	addi	a0,a0,1702 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc02034a2:	ed3fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034a6 <check_vma_overlap.part.0>:
}
...
ffffffffc02034ac:	76868693          	addi	a3,a3,1896 # ffffffffc0205c10 <default_pmm_manager+0xaf0>
ffffffffc02034b0:	00002617          	auipc	a2,0x2
ffffffffc02034b4:	8c060613          	addi	a2,a2,-1856 # ffffffffc0204d70 <commands+0x738>
ffffffffc02034b8:	08600593          	li	a1,134
ffffffffc02034bc:	00002517          	auipc	a0,0x2
ffffffffc02034c0:	77450513          	addi	a0,a0,1908 # ffffffffc0205c30 <default_pmm_manager+0xb10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02034c4:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02034c6:	eaffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034ca <mm_create>:
mm_create(void) {
ffffffffc02034ca:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034cc:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02034d0:	e022                	sd	s0,0(sp)
ffffffffc02034d2:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034d4:	aa4ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034d8:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034da:	c105                	beqz	a0,ffffffffc02034fa <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034dc:	e408                	sd	a0,8(s0)
ffffffffc02034de:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034e0:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034e4:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034e8:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034ec:	0000e797          	auipc	a5,0xe
ffffffffc02034f0:	0647a783          	lw	a5,100(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034f4:	eb81                	bnez	a5,ffffffffc0203504 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034f6:	02053423          	sd	zero,40(a0)
}
...
ffffffffc0203502:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203504:	a81ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc0203512 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203512:	1101                	addi	sp,sp,-32
ffffffffc0203514:	e04a                	sd	s2,0(sp)
ffffffffc0203516:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203518:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020351c:	e822                	sd	s0,16(sp)
ffffffffc020351e:	e426                	sd	s1,8(sp)
ffffffffc0203520:	ec06                	sd	ra,24(sp)
ffffffffc0203522:	84ae                	mv	s1,a1
ffffffffc0203524:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203526:	a52ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc020352a:	c509                	beqz	a0,ffffffffc0203534 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc020352c:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203530:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203532:	ed00                	sd	s0,24(a0)
}
ffffffffc0203534:	60e2                	ld	ra,24(sp)
ffffffffc0203536:	6442                	ld	s0,16(sp)
ffffffffc0203538:	64a2                	ld	s1,8(sp)
ffffffffc020353a:	6902                	ld	s2,0(sp)
ffffffffc020353c:	6105                	addi	sp,sp,32
ffffffffc020353e:	8082                	ret

ffffffffc0203540 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc0203540:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc0203542:	c505                	beqz	a0,ffffffffc020356a <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203544:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203546:	c501                	beqz	a0,ffffffffc020354e <find_vma+0xe>
ffffffffc0203548:	651c                	ld	a5,8(a0)
ffffffffc020354a:	02f5f263          	bgeu	a1,a5,ffffffffc020356e <find_vma+0x2e>
    return listelm->next;
ffffffffc020354e:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc0203550:	00f68d63          	beq	a3,a5,ffffffffc020356a <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203554:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203558:	00e5e663          	bltu	a1,a4,ffffffffc0203564 <find_vma+0x24>
ffffffffc020355c:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203560:	00e5ec63          	bltu	a1,a4,ffffffffc0203578 <find_vma+0x38>
ffffffffc0203564:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203566:	fef697e3          	bne	a3,a5,ffffffffc0203554 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc020356a:	4501                	li	a0,0
}
ffffffffc020356c:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020356e:	691c                	ld	a5,16(a0)
ffffffffc0203570:	fcf5ffe3          	bgeu	a1,a5,ffffffffc020354e <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203574:	ea88                	sd	a0,16(a3)
ffffffffc0203576:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203578:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc020357c:	ea88                	sd	a0,16(a3)
ffffffffc020357e:	8082                	ret

ffffffffc0203580 <insert_vma_struct>:
...
ffffffffc0203580:	6590                	ld	a2,8(a1)
ffffffffc0203582:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203586:	1141                	addi	sp,sp,-16
ffffffffc0203588:	e406                	sd	ra,8(sp)
ffffffffc020358a:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc020358c:	01066763          	bltu	a2,a6,ffffffffc020359a <insert_vma_struct+0x1a>
ffffffffc0203590:	a085                	j	ffffffffc02035f0 <insert_vma_struct+0x70>
...
ffffffffc0203596:	04e66863          	bltu	a2,a4,ffffffffc02035e6 <insert_vma_struct+0x66>
ffffffffc020359a:	86be                	mv	a3,a5
ffffffffc020359c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020359e:	fef51ae3          	bne	a0,a5,ffffffffc0203592 <insert_vma_struct+0x12>
        }
    ...
    if (le_prev != list) {
ffffffffc02035a2:	02a68463          	beq	a3,a0,ffffffffc02035ca <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035a6:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035aa:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035ae:	08e8f163          	bgeu	a7,a4,ffffffffc0203630 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035b2:	04e66f63          	bltu	a2,a4,ffffffffc0203610 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035b6:	00f50a63          	beq	a0,a5,ffffffffc02035ca <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035ba:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035be:	05076963          	bltu	a4,a6,ffffffffc0203610 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02035c2:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035c6:	02c77363          	bgeu	a4,a2,ffffffffc02035ec <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035ca:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035cc:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035ce:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035d2:	e390                	sd	a2,0(a5)
ffffffffc02035d4:	e690                	sd	a2,8(a3)
}
ffffffffc02035d6:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035d8:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035da:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035dc:	0017079b          	addiw	a5,a4,1
ffffffffc02035e0:	d11c                	sw	a5,32(a0)
}
ffffffffc02035e2:	0141                	addi	sp,sp,16
ffffffffc02035e4:	8082                	ret
    if (le_prev != list) {
ffffffffc02035e6:	fca690e3          	bne	a3,a0,ffffffffc02035a6 <insert_vma_struct+0x26>
ffffffffc02035ea:	bfd1                	j	ffffffffc02035be <insert_vma_struct+0x3e>
ffffffffc02035ec:	ebbff0ef          	jal	ra,ffffffffc02034a6 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035f0:	00002697          	auipc	a3,0x2
ffffffffc02035f4:	65068693          	addi	a3,a3,1616 # ffffffffc0205c40 <default_pmm_manager+0xb20>
ffffffffc02035f8:	00001617          	auipc	a2,0x1
ffffffffc02035fc:	77860613          	addi	a2,a2,1912 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203600:	08d00593          	li	a1,141
ffffffffc0203604:	00002517          	auipc	a0,0x2
ffffffffc0203608:	62c50513          	addi	a0,a0,1580 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc020360c:	d69fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203610:	00002697          	auipc	a3,0x2
ffffffffc0203614:	67068693          	addi	a3,a3,1648 # ffffffffc0205c80 <default_pmm_manager+0xb60>
ffffffffc0203618:	00001617          	auipc	a2,0x1
ffffffffc020361c:	75860613          	addi	a2,a2,1880 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203620:	08500593          	li	a1,133
ffffffffc0203624:	00002517          	auipc	a0,0x2
ffffffffc0203628:	60c50513          	addi	a0,a0,1548 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc020362c:	d49fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203630:	00002697          	auipc	a3,0x2
ffffffffc0203634:	63068693          	addi	a3,a3,1584 # ffffffffc0205c60 <default_pmm_manager+0xb40>
ffffffffc0203638:	00001617          	auipc	a2,0x1
ffffffffc020363c:	73860613          	addi	a2,a2,1848 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203640:	08400593          	li	a1,132
ffffffffc0203644:	00002517          	auipc	a0,0x2
ffffffffc0203648:	5ec50513          	addi	a0,a0,1516 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc020364c:	d29fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203650 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203650:	1141                	addi	sp,sp,-16
ffffffffc0203652:	e022                	sd	s0,0(sp)
ffffffffc0203654:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203656:	6508                	ld	a0,8(a0)
ffffffffc0203658:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc020365a:	00a40e63          	beq	s0,a0,ffffffffc0203676 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc020365e:	6118                	ld	a4,0(a0)
ffffffffc0203660:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203662:	03000593          	li	a1,48
ffffffffc0203666:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203668:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020366a:	e398                	sd	a4,0(a5)
ffffffffc020366c:	9c6ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203670:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203672:	fea416e3          	bne	s0,a0,ffffffffc020365e <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203676:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203678:	6402                	ld	s0,0(sp)
ffffffffc020367a:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020367c:	03000593          	li	a1,48
}
ffffffffc0203680:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203682:	9b0ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203686 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203686:	715d                	addi	sp,sp,-80
ffffffffc0203688:	e486                	sd	ra,72(sp)
ffffffffc020368a:	f44e                	sd	s3,40(sp)
ffffffffc020368c:	f052                	sd	s4,32(sp)
ffffffffc020368e:	e0a2                	sd	s0,64(sp)
ffffffffc0203690:	fc26                	sd	s1,56(sp)
ffffffffc0203692:	f84a                	sd	s2,48(sp)
ffffffffc0203694:	ec56                	sd	s5,24(sp)
ffffffffc0203696:	e85a                	sd	s6,16(sp)
ffffffffc0203698:	e45e                	sd	s7,8(sp)
}
...
ffffffffc020369a:	ff9fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
ffffffffc02036aa:	8ceff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036ae:	56050863          	beqz	a0,ffffffffc0203c1e <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc02036b2:	e508                	sd	a0,8(a0)
ffffffffc02036b4:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02036b6:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02036ba:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02036be:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036c2:	0000e797          	auipc	a5,0xe
ffffffffc02036c6:	e8e7a783          	lw	a5,-370(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02036ca:	84aa                	mv	s1,a0
ffffffffc02036cc:	e7b9                	bnez	a5,ffffffffc020371a <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036ce:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036d2:	03200413          	li	s0,50
ffffffffc02036d6:	a811                	j	ffffffffc02036ea <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036d8:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036da:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036dc:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036e0:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036e2:	8526                	mv	a0,s1
ffffffffc02036e4:	e9dff0ef          	jal	ra,ffffffffc0203580 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036e8:	cc05                	beqz	s0,ffffffffc0203720 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036ea:	03000513          	li	a0,48
ffffffffc02036ee:	88aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036f2:	85aa                	mv	a1,a0
ffffffffc02036f4:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036f8:	f165                	bnez	a0,ffffffffc02036d8 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036fa:	00002697          	auipc	a3,0x2
ffffffffc02036fe:	15668693          	addi	a3,a3,342 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203702:	00001617          	auipc	a2,0x1
ffffffffc0203706:	66e60613          	addi	a2,a2,1646 # ffffffffc0204d70 <commands+0x738>
ffffffffc020370a:	0d700593          	li	a1,215
ffffffffc020370e:	00002517          	auipc	a0,0x2
ffffffffc0203712:	52250513          	addi	a0,a0,1314 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203716:	c5ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020371a:	86bff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc020371e:	bf55                	j	ffffffffc02036d2 <vmm_init+0x4c>
ffffffffc0203720:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203724:	1f900913          	li	s2,505
ffffffffc0203728:	a819                	j	ffffffffc020373e <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc020372a:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc020372c:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020372e:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203732:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203734:	8526                	mv	a0,s1
ffffffffc0203736:	e4bff0ef          	jal	ra,ffffffffc0203580 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020373a:	03240a63          	beq	s0,s2,ffffffffc020376e <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020373e:	03000513          	li	a0,48
ffffffffc0203742:	836ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203746:	85aa                	mv	a1,a0
ffffffffc0203748:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc020374c:	fd79                	bnez	a0,ffffffffc020372a <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc020374e:	00002697          	auipc	a3,0x2
ffffffffc0203752:	10268693          	addi	a3,a3,258 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203756:	00001617          	auipc	a2,0x1
ffffffffc020375a:	61a60613          	addi	a2,a2,1562 # ffffffffc0204d70 <commands+0x738>
ffffffffc020375e:	0dd00593          	li	a1,221
ffffffffc0203762:	00002517          	auipc	a0,0x2
ffffffffc0203766:	4ce50513          	addi	a0,a0,1230 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc020376a:	c0bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc020376e:	649c                	ld	a5,8(s1)
ffffffffc0203770:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203772:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203776:	2ef48463          	beq	s1,a5,ffffffffc0203a5e <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020377a:	fe87b603          	ld	a2,-24(a5)
ffffffffc020377e:	ffe70693          	addi	a3,a4,-2
ffffffffc0203782:	26d61e63          	bne	a2,a3,ffffffffc02039fe <vmm_init+0x378>
ffffffffc0203786:	ff07b683          	ld	a3,-16(a5)
ffffffffc020378a:	26e69a63          	bne	a3,a4,ffffffffc02039fe <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc020378e:	0715                	addi	a4,a4,5
ffffffffc0203790:	679c                	ld	a5,8(a5)
ffffffffc0203792:	feb712e3          	bne	a4,a1,ffffffffc0203776 <vmm_init+0xf0>
ffffffffc0203796:	4b1d                	li	s6,7
ffffffffc0203798:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020379a:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020379e:	85a2                	mv	a1,s0
ffffffffc02037a0:	8526                	mv	a0,s1
ffffffffc02037a2:	d9fff0ef          	jal	ra,ffffffffc0203540 <find_vma>
ffffffffc02037a6:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037a8:	2c050b63          	beqz	a0,ffffffffc0203a7e <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037ac:	00140593          	addi	a1,s0,1
ffffffffc02037b0:	8526                	mv	a0,s1
ffffffffc02037b2:	d8fff0ef          	jal	ra,ffffffffc0203540 <find_vma>
ffffffffc02037b6:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037b8:	2e050363          	beqz	a0,ffffffffc0203a9e <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037bc:	85da                	mv	a1,s6
ffffffffc02037be:	8526                	mv	a0,s1
ffffffffc02037c0:	d81ff0ef          	jal	ra,ffffffffc0203540 <find_vma>
        assert(vma3 == NULL);
ffffffffc02037c4:	2e051d63          	bnez	a0,ffffffffc0203abe <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037c8:	00340593          	addi	a1,s0,3
ffffffffc02037cc:	8526                	mv	a0,s1
ffffffffc02037ce:	d73ff0ef          	jal	ra,ffffffffc0203540 <find_vma>
        assert(vma4 == NULL);
ffffffffc02037d2:	30051663          	bnez	a0,ffffffffc0203ade <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037d6:	00440593          	addi	a1,s0,4
ffffffffc02037da:	8526                	mv	a0,s1
ffffffffc02037dc:	d65ff0ef          	jal	ra,ffffffffc0203540 <find_vma>
        assert(vma5 == NULL);
ffffffffc02037e0:	30051f63          	bnez	a0,ffffffffc0203afe <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037e4:	00893783          	ld	a5,8(s2)
ffffffffc02037e8:	24879b63          	bne	a5,s0,ffffffffc0203a3e <vmm_init+0x3b8>
ffffffffc02037ec:	01093783          	ld	a5,16(s2)
ffffffffc02037f0:	25679763          	bne	a5,s6,ffffffffc0203a3e <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037f4:	008ab783          	ld	a5,8(s5)
ffffffffc02037f8:	22879363          	bne	a5,s0,ffffffffc0203a1e <vmm_init+0x398>
ffffffffc02037fc:	010ab783          	ld	a5,16(s5)
ffffffffc0203800:	21679f63          	bne	a5,s6,ffffffffc0203a1e <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203804:	0415                	addi	s0,s0,5
ffffffffc0203806:	0b15                	addi	s6,s6,5
ffffffffc0203808:	f9741be3          	bne	s0,s7,ffffffffc020379e <vmm_init+0x118>
ffffffffc020380c:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc020380e:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203810:	85a2                	mv	a1,s0
ffffffffc0203812:	8526                	mv	a0,s1
ffffffffc0203814:	d2dff0ef          	jal	ra,ffffffffc0203540 <find_vma>
ffffffffc0203818:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc020381c:	c90d                	beqz	a0,ffffffffc020384e <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc020381e:	6914                	ld	a3,16(a0)
ffffffffc0203820:	6510                	ld	a2,8(a0)
ffffffffc0203822:	00002517          	auipc	a0,0x2
ffffffffc0203826:	57e50513          	addi	a0,a0,1406 # ffffffffc0205da0 <default_pmm_manager+0xc80>
ffffffffc020382a:	891fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020382e:	00002697          	auipc	a3,0x2
ffffffffc0203832:	59a68693          	addi	a3,a3,1434 # ffffffffc0205dc8 <default_pmm_manager+0xca8>
ffffffffc0203836:	00001617          	auipc	a2,0x1
ffffffffc020383a:	53a60613          	addi	a2,a2,1338 # ffffffffc0204d70 <commands+0x738>
ffffffffc020383e:	0ff00593          	li	a1,255
ffffffffc0203842:	00002517          	auipc	a0,0x2
ffffffffc0203846:	3ee50513          	addi	a0,a0,1006 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc020384a:	b2bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc020384e:	147d                	addi	s0,s0,-1
ffffffffc0203850:	fd2410e3          	bne	s0,s2,ffffffffc0203810 <vmm_init+0x18a>
ffffffffc0203854:	a811                	j	ffffffffc0203868 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203856:	6118                	ld	a4,0(a0)
ffffffffc0203858:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020385a:	03000593          	li	a1,48
ffffffffc020385e:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203860:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203862:	e398                	sd	a4,0(a5)
ffffffffc0203864:	fcffe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203868:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc020386a:	fea496e3          	bne	s1,a0,ffffffffc0203856 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020386e:	03000593          	li	a1,48
ffffffffc0203872:	8526                	mv	a0,s1
ffffffffc0203874:	fbffe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203878:	e1bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020387c:	3caa1163          	bne	s4,a0,ffffffffc0203c3e <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203880:	00002517          	auipc	a0,0x2
ffffffffc0203884:	58850513          	addi	a0,a0,1416 # ffffffffc0205e08 <default_pmm_manager+0xce8>
ffffffffc0203888:	833fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020388c:	e07fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203890:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203892:	03000513          	li	a0,48
ffffffffc0203896:	ee3fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020389a:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc020389c:	2a050163          	beqz	a0,ffffffffc0203b3e <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038a0:	0000e797          	auipc	a5,0xe
ffffffffc02038a4:	cb07a783          	lw	a5,-848(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
...
ffffffffc02038b4:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038b8:	14079063          	bnez	a5,ffffffffc02039f8 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038bc:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038c0:	0000e917          	auipc	s2,0xe
ffffffffc02038c4:	c5893903          	ld	s2,-936(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038c8:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038cc:	0000e717          	auipc	a4,0xe
ffffffffc02038d0:	c8873a23          	sd	s0,-876(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038d4:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038d8:	24079363          	bnez	a5,ffffffffc0203b1e <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038dc:	03000513          	li	a0,48
ffffffffc02038e0:	e99fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038e4:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038e6:	28050063          	beqz	a0,ffffffffc0203b66 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038ea:	002007b7          	lui	a5,0x200
ffffffffc02038ee:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038f2:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02038f4:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038f6:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038fa:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038fc:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203900:	c81ff0ef          	jal	ra,ffffffffc0203580 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203904:	10000593          	li	a1,256
ffffffffc0203908:	8522                	mv	a0,s0
ffffffffc020390a:	c37ff0ef          	jal	ra,ffffffffc0203540 <find_vma>
ffffffffc020390e:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203912:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203916:	26aa1863          	bne	s4,a0,ffffffffc0203b86 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc020391a:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc020391e:	0785                	addi	a5,a5,1
ffffffffc0203920:	fee79de3          	bne	a5,a4,ffffffffc020391a <vmm_init+0x294>
        sum += i;
ffffffffc0203924:	6705                	lui	a4,0x1
ffffffffc0203926:	10000793          	li	a5,256
ffffffffc020392a:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc020392e:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203932:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203936:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203938:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc020393a:	fec79ce3          	bne	a5,a2,ffffffffc0203932 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc020393e:	26071463          	bnez	a4,ffffffffc0203ba6 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203942:	4581                	li	a1,0
ffffffffc0203944:	854a                	mv	a0,s2
ffffffffc0203946:	fd7fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc020394a:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc020394e:	0000e717          	auipc	a4,0xe
ffffffffc0203952:	bd273703          	ld	a4,-1070(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203956:	078a                	slli	a5,a5,0x2
ffffffffc0203958:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc020395a:	26e7f663          	bgeu	a5,a4,ffffffffc0203bc6 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc020395e:	00003717          	auipc	a4,0x3
ffffffffc0203962:	87273703          	ld	a4,-1934(a4) # ffffffffc02061d0 <nbase>
ffffffffc0203966:	8f99                	sub	a5,a5,a4
ffffffffc0203968:	00379713          	slli	a4,a5,0x3
ffffffffc020396c:	97ba                	add	a5,a5,a4
ffffffffc020396e:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203970:	0000e517          	auipc	a0,0xe
ffffffffc0203974:	bb853503          	ld	a0,-1096(a0) # ffffffffc0211528 <pages>
ffffffffc0203978:	953e                	add	a0,a0,a5
ffffffffc020397a:	4585                	li	a1,1
ffffffffc020397c:	cd7fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203980:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203982:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203986:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020398a:	00a40e63          	beq	s0,a0,ffffffffc02039a6 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc020398e:	6118                	ld	a4,0(a0)
ffffffffc0203990:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203992:	03000593          	li	a1,48
ffffffffc0203996:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203998:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020399a:	e398                	sd	a4,0(a5)
ffffffffc020399c:	e97fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02039a0:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039a2:	fea416e3          	bne	s0,a0,ffffffffc020398e <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02039a6:	03000593          	li	a1,48
ffffffffc02039aa:	8522                	mv	a0,s0
ffffffffc02039ac:	e87fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc02039b0:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039b2:	0000e797          	auipc	a5,0xe
ffffffffc02039b6:	ba07b723          	sd	zero,-1106(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039ba:	cd9fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02039be:	22a49063          	bne	s1,a0,ffffffffc0203bde <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039c2:	00002517          	auipc	a0,0x2
ffffffffc02039c6:	49650513          	addi	a0,a0,1174 # ffffffffc0205e58 <default_pmm_manager+0xd38>
...
ffffffffc02039d2:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d4:	22a99563          	bne	s3,a0,ffffffffc0203bfe <vmm_init+0x578>
}
ffffffffc02039d8:	6406                	ld	s0,64(sp)
ffffffffc02039da:	60a6                	ld	ra,72(sp)
ffffffffc02039dc:	74e2                	ld	s1,56(sp)
ffffffffc02039de:	7942                	ld	s2,48(sp)
ffffffffc02039e0:	79a2                	ld	s3,40(sp)
ffffffffc02039e2:	7a02                	ld	s4,32(sp)
ffffffffc02039e4:	6ae2                	ld	s5,24(sp)
ffffffffc02039e6:	6b42                	ld	s6,16(sp)
ffffffffc02039e8:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039ea:	00002517          	auipc	a0,0x2
ffffffffc02039ee:	48e50513          	addi	a0,a0,1166 # ffffffffc0205e78 <default_pmm_manager+0xd58>
}
ffffffffc02039f2:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039f4:	ec6fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039f8:	d8cff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039fc:	b5d1                	j	ffffffffc02038c0 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039fe:	00002697          	auipc	a3,0x2
ffffffffc0203a02:	2ba68693          	addi	a3,a3,698 # ffffffffc0205cb8 <default_pmm_manager+0xb98>
ffffffffc0203a06:	00001617          	auipc	a2,0x1
ffffffffc0203a0a:	36a60613          	addi	a2,a2,874 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a0e:	0e600593          	li	a1,230
ffffffffc0203a12:	00002517          	auipc	a0,0x2
ffffffffc0203a16:	21e50513          	addi	a0,a0,542 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a1a:	95bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a1e:	00002697          	auipc	a3,0x2
ffffffffc0203a22:	35268693          	addi	a3,a3,850 # ffffffffc0205d70 <default_pmm_manager+0xc50>
ffffffffc0203a26:	00001617          	auipc	a2,0x1
ffffffffc0203a2a:	34a60613          	addi	a2,a2,842 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a2e:	0f700593          	li	a1,247
ffffffffc0203a32:	00002517          	auipc	a0,0x2
ffffffffc0203a36:	1fe50513          	addi	a0,a0,510 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a3a:	93bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a3e:	00002697          	auipc	a3,0x2
ffffffffc0203a42:	30268693          	addi	a3,a3,770 # ffffffffc0205d40 <default_pmm_manager+0xc20>
ffffffffc0203a46:	00001617          	auipc	a2,0x1
ffffffffc0203a4a:	32a60613          	addi	a2,a2,810 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a4e:	0f600593          	li	a1,246
ffffffffc0203a52:	00002517          	auipc	a0,0x2
ffffffffc0203a56:	1de50513          	addi	a0,a0,478 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a5a:	91bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a5e:	00002697          	auipc	a3,0x2
ffffffffc0203a62:	24268693          	addi	a3,a3,578 # ffffffffc0205ca0 <default_pmm_manager+0xb80>
ffffffffc0203a66:	00001617          	auipc	a2,0x1
ffffffffc0203a6a:	30a60613          	addi	a2,a2,778 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a6e:	0e400593          	li	a1,228
ffffffffc0203a72:	00002517          	auipc	a0,0x2
ffffffffc0203a76:	1be50513          	addi	a0,a0,446 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a7a:	8fbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a7e:	00002697          	auipc	a3,0x2
ffffffffc0203a82:	27268693          	addi	a3,a3,626 # ffffffffc0205cf0 <default_pmm_manager+0xbd0>
ffffffffc0203a86:	00001617          	auipc	a2,0x1
ffffffffc0203a8a:	2ea60613          	addi	a2,a2,746 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a8e:	0ec00593          	li	a1,236
ffffffffc0203a92:	00002517          	auipc	a0,0x2
ffffffffc0203a96:	19e50513          	addi	a0,a0,414 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a9a:	8dbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a9e:	00002697          	auipc	a3,0x2
ffffffffc0203aa2:	26268693          	addi	a3,a3,610 # ffffffffc0205d00 <default_pmm_manager+0xbe0>
ffffffffc0203aa6:	00001617          	auipc	a2,0x1
ffffffffc0203aaa:	2ca60613          	addi	a2,a2,714 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203aae:	0ee00593          	li	a1,238
ffffffffc0203ab2:	00002517          	auipc	a0,0x2
ffffffffc0203ab6:	17e50513          	addi	a0,a0,382 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203aba:	8bbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203abe:	00002697          	auipc	a3,0x2
ffffffffc0203ac2:	25268693          	addi	a3,a3,594 # ffffffffc0205d10 <default_pmm_manager+0xbf0>
ffffffffc0203ac6:	00001617          	auipc	a2,0x1
ffffffffc0203aca:	2aa60613          	addi	a2,a2,682 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203ace:	0f000593          	li	a1,240
ffffffffc0203ad2:	00002517          	auipc	a0,0x2
ffffffffc0203ad6:	15e50513          	addi	a0,a0,350 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203ada:	89bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ade:	00002697          	auipc	a3,0x2
ffffffffc0203ae2:	24268693          	addi	a3,a3,578 # ffffffffc0205d20 <default_pmm_manager+0xc00>
ffffffffc0203ae6:	00001617          	auipc	a2,0x1
ffffffffc0203aea:	28a60613          	addi	a2,a2,650 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203aee:	0f200593          	li	a1,242
ffffffffc0203af2:	00002517          	auipc	a0,0x2
ffffffffc0203af6:	13e50513          	addi	a0,a0,318 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203afa:	87bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203afe:	00002697          	auipc	a3,0x2
ffffffffc0203b02:	23268693          	addi	a3,a3,562 # ffffffffc0205d30 <default_pmm_manager+0xc10>
ffffffffc0203b06:	00001617          	auipc	a2,0x1
ffffffffc0203b0a:	26a60613          	addi	a2,a2,618 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b0e:	0f400593          	li	a1,244
ffffffffc0203b12:	00002517          	auipc	a0,0x2
ffffffffc0203b16:	11e50513          	addi	a0,a0,286 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b1a:	85bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b1e:	00002697          	auipc	a3,0x2
ffffffffc0203b22:	d2268693          	addi	a3,a3,-734 # ffffffffc0205840 <default_pmm_manager+0x720>
ffffffffc0203b26:	00001617          	auipc	a2,0x1
ffffffffc0203b2a:	24a60613          	addi	a2,a2,586 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b2e:	11600593          	li	a1,278
ffffffffc0203b32:	00002517          	auipc	a0,0x2
ffffffffc0203b36:	0fe50513          	addi	a0,a0,254 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b3a:	83bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b3e:	00002697          	auipc	a3,0x2
ffffffffc0203b42:	35268693          	addi	a3,a3,850 # ffffffffc0205e90 <default_pmm_manager+0xd70>
ffffffffc0203b46:	00001617          	auipc	a2,0x1
ffffffffc0203b4a:	22a60613          	addi	a2,a2,554 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b4e:	11300593          	li	a1,275
ffffffffc0203b52:	00002517          	auipc	a0,0x2
ffffffffc0203b56:	0de50513          	addi	a0,a0,222 # ffffffffc0205c30 <default_pmm_manager+0xb10>
    check_mm_struct = mm_create();
ffffffffc0203b5a:	0000e797          	auipc	a5,0xe
ffffffffc0203b5e:	a007b323          	sd	zero,-1530(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b62:	813fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b66:	00002697          	auipc	a3,0x2
ffffffffc0203b6a:	cea68693          	addi	a3,a3,-790 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203b6e:	00001617          	auipc	a2,0x1
ffffffffc0203b72:	20260613          	addi	a2,a2,514 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b76:	11a00593          	li	a1,282
ffffffffc0203b7a:	00002517          	auipc	a0,0x2
ffffffffc0203b7e:	0b650513          	addi	a0,a0,182 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b82:	ff2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b86:	00002697          	auipc	a3,0x2
ffffffffc0203b8a:	2a268693          	addi	a3,a3,674 # ffffffffc0205e28 <default_pmm_manager+0xd08>
ffffffffc0203b8e:	00001617          	auipc	a2,0x1
ffffffffc0203b92:	1e260613          	addi	a2,a2,482 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b96:	11f00593          	li	a1,287
ffffffffc0203b9a:	00002517          	auipc	a0,0x2
ffffffffc0203b9e:	09650513          	addi	a0,a0,150 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203ba2:	fd2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ba6:	00002697          	auipc	a3,0x2
ffffffffc0203baa:	2a268693          	addi	a3,a3,674 # ffffffffc0205e48 <default_pmm_manager+0xd28>
ffffffffc0203bae:	00001617          	auipc	a2,0x1
ffffffffc0203bb2:	1c260613          	addi	a2,a2,450 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203bb6:	12900593          	li	a1,297
ffffffffc0203bba:	00002517          	auipc	a0,0x2
ffffffffc0203bbe:	07650513          	addi	a0,a0,118 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203bc2:	fb2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bc6:	00001617          	auipc	a2,0x1
ffffffffc0203bca:	59260613          	addi	a2,a2,1426 # ffffffffc0205158 <default_pmm_manager+0x38>
ffffffffc0203bce:	06500593          	li	a1,101
ffffffffc0203bd2:	00001517          	auipc	a0,0x1
ffffffffc0203bd6:	5a650513          	addi	a0,a0,1446 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203bda:	f9afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bde:	00002697          	auipc	a3,0x2
ffffffffc0203be2:	20268693          	addi	a3,a3,514 # ffffffffc0205de0 <default_pmm_manager+0xcc0>
ffffffffc0203be6:	00001617          	auipc	a2,0x1
ffffffffc0203bea:	18a60613          	addi	a2,a2,394 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203bee:	13700593          	li	a1,311
ffffffffc0203bf2:	00002517          	auipc	a0,0x2
ffffffffc0203bf6:	03e50513          	addi	a0,a0,62 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203bfa:	f7afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bfe:	00002697          	auipc	a3,0x2
ffffffffc0203c02:	1e268693          	addi	a3,a3,482 # ffffffffc0205de0 <default_pmm_manager+0xcc0>
ffffffffc0203c06:	00001617          	auipc	a2,0x1
ffffffffc0203c0a:	16a60613          	addi	a2,a2,362 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c0e:	0c600593          	li	a1,198
ffffffffc0203c12:	00002517          	auipc	a0,0x2
ffffffffc0203c16:	01e50513          	addi	a0,a0,30 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203c1a:	f5afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c1e:	00002697          	auipc	a3,0x2
ffffffffc0203c22:	bfa68693          	addi	a3,a3,-1030 # ffffffffc0205818 <default_pmm_manager+0x6f8>
ffffffffc0203c26:	00001617          	auipc	a2,0x1
ffffffffc0203c2a:	14a60613          	addi	a2,a2,330 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c2e:	0d000593          	li	a1,208
ffffffffc0203c32:	00002517          	auipc	a0,0x2
ffffffffc0203c36:	ffe50513          	addi	a0,a0,-2 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203c3a:	f3afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c3e:	00002697          	auipc	a3,0x2
ffffffffc0203c42:	1a268693          	addi	a3,a3,418 # ffffffffc0205de0 <default_pmm_manager+0xcc0>
ffffffffc0203c46:	00001617          	auipc	a2,0x1
ffffffffc0203c4a:	12a60613          	addi	a2,a2,298 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c4e:	10400593          	li	a1,260
ffffffffc0203c52:	00002517          	auipc	a0,0x2
ffffffffc0203c56:	fde50513          	addi	a0,a0,-34 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203c5a:	f1afc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c5e <do_pgfault>:
...
ffffffffc0203c60:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c62:	f022                	sd	s0,32(sp)
ffffffffc0203c64:	ec26                	sd	s1,24(sp)
ffffffffc0203c66:	f406                	sd	ra,40(sp)
ffffffffc0203c68:	e84a                	sd	s2,16(sp)
ffffffffc0203c6a:	8432                	mv	s0,a2
ffffffffc0203c6c:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c6e:	8d3ff0ef          	jal	ra,ffffffffc0203540 <find_vma>

    pgfault_num++;
ffffffffc0203c72:	0000e797          	auipc	a5,0xe
ffffffffc0203c76:	8f67a783          	lw	a5,-1802(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c7a:	2785                	addiw	a5,a5,1
ffffffffc0203c7c:	0000e717          	auipc	a4,0xe
ffffffffc0203c80:	8ef72623          	sw	a5,-1812(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c84:	c159                	beqz	a0,ffffffffc0203d0a <do_pgfault+0xac>
ffffffffc0203c86:	651c                	ld	a5,8(a0)
ffffffffc0203c88:	08f46163          	bltu	s0,a5,ffffffffc0203d0a <do_pgfault+0xac>
...
ffffffffc0203c8c:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c8e:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c90:	8b89                	andi	a5,a5,2
ffffffffc0203c92:	ebb1                	bnez	a5,ffffffffc0203ce6 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c94:	75fd                	lui	a1,0xfffff
    *
    */
...
ffffffffc0203c96:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c98:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c9a:	85a2                	mv	a1,s0
ffffffffc0203c9c:	4605                	li	a2,1
ffffffffc0203c9e:	a2ffd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203ca2:	610c                	ld	a1,0(a0)
ffffffffc0203ca4:	c1b9                	beqz	a1,ffffffffc0203cea <do_pgfault+0x8c>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203ca6:	0000e797          	auipc	a5,0xe
ffffffffc0203caa:	8aa7a783          	lw	a5,-1878(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203cae:	c7bd                	beqz	a5,ffffffffc0203d1c <do_pgfault+0xbe>
            //map of phy addr <--->
            //logical addr
...
ffffffffc0203cb2:	0030                	addi	a2,sp,8
ffffffffc0203cb4:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203cb6:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);  //(1）According to the mm AND addr, try
ffffffffc0203cb8:	bf8ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
                                       //to load the content of right disk page
                                       //into the memory which page managed.
            page_insert(mm->pgdir, page, addr, perm); //更新页表，插入新的页表项
ffffffffc0203cbc:	65a2                	ld	a1,8(sp)
ffffffffc0203cbe:	6c88                	ld	a0,24(s1)
ffffffffc0203cc0:	86ca                	mv	a3,s2
ffffffffc0203cc2:	8622                	mv	a2,s0
ffffffffc0203cc4:	cf3fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            //(2) According to the mm, addr AND page, 
            // setup the map of phy addr <---> virtual addr
            swap_map_swappable(mm, addr, page, 1);  //(3) make the page swappable.
ffffffffc0203cc8:	6622                	ld	a2,8(sp)
ffffffffc0203cca:	4685                	li	a3,1
...
ffffffffc0203cd0:	ac0ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            //标记这个页面将来是可以再换出的
            page->pra_vaddr = addr;
ffffffffc0203cd4:	67a2                	ld	a5,8(sp)
...
ffffffffc0203cd6:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203cd8:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203cda:	70a2                	ld	ra,40(sp)
ffffffffc0203cdc:	7402                	ld	s0,32(sp)
ffffffffc0203cde:	64e2                	ld	s1,24(sp)
ffffffffc0203ce0:	6942                	ld	s2,16(sp)
ffffffffc0203ce2:	6145                	addi	sp,sp,48
ffffffffc0203ce4:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203ce6:	4959                	li	s2,22
ffffffffc0203ce8:	b775                	j	ffffffffc0203c94 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cea:	6c88                	ld	a0,24(s1)
ffffffffc0203cec:	864a                	mv	a2,s2
ffffffffc0203cee:	85a2                	mv	a1,s0
ffffffffc0203cf0:	9d1fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203cf4:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203cf6:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cf8:	f3ed                	bnez	a5,ffffffffc0203cda <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cfa:	00002517          	auipc	a0,0x2
ffffffffc0203cfe:	1de50513          	addi	a0,a0,478 # ffffffffc0205ed8 <default_pmm_manager+0xdb8>
ffffffffc0203d02:	bb8fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d06:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d08:	bfc9                	j	ffffffffc0203cda <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d0a:	85a2                	mv	a1,s0
ffffffffc0203d0c:	00002517          	auipc	a0,0x2
ffffffffc0203d10:	19c50513          	addi	a0,a0,412 # ffffffffc0205ea8 <default_pmm_manager+0xd88>
ffffffffc0203d14:	ba6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d18:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d1a:	b7c1                	j	ffffffffc0203cda <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d1c:	00002517          	auipc	a0,0x2
ffffffffc0203d20:	1e450513          	addi	a0,a0,484 # ffffffffc0205f00 <default_pmm_manager+0xde0>
ffffffffc0203d24:	b96fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d28:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d2a:	bf45                	j	ffffffffc0203cda <do_pgfault+0x7c>

ffffffffc0203d2c <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203d2c:	1141                	addi	sp,sp,-16
...
ffffffffc0203d30:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d32:	f62fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d36:	cd01                	beqz	a0,ffffffffc0203d4e <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    //swap.c/swap.h里的全局变量
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d38:	4505                	li	a0,1
ffffffffc0203d3a:	f60fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d3e:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d40:	810d                	srli	a0,a0,0x3
ffffffffc0203d42:	0000d797          	auipc	a5,0xd
ffffffffc0203d46:	7ea7bf23          	sd	a0,2046(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d4a:	0141                	addi	sp,sp,16
ffffffffc0203d4c:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d4e:	00002617          	auipc	a2,0x2
ffffffffc0203d52:	1da60613          	addi	a2,a2,474 # ffffffffc0205f28 <default_pmm_manager+0xe08>
ffffffffc0203d56:	45b5                	li	a1,13
ffffffffc0203d58:	00002517          	auipc	a0,0x2
ffffffffc0203d5c:	1f050513          	addi	a0,a0,496 # ffffffffc0205f48 <default_pmm_manager+0xe28>
ffffffffc0203d60:	e14fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d64 <swapfs_read>:
...
ffffffffc0203d6c:	c3a5                	beqz	a5,ffffffffc0203dcc <swapfs_read+0x68>
ffffffffc0203d6e:	0000d717          	auipc	a4,0xd
ffffffffc0203d72:	7d273703          	ld	a4,2002(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d76:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dcc <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d7a:	0000d617          	auipc	a2,0xd
ffffffffc0203d7e:	7ae63603          	ld	a2,1966(a2) # ffffffffc0211528 <pages>
ffffffffc0203d82:	8d91                	sub	a1,a1,a2
ffffffffc0203d84:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d88:	00002597          	auipc	a1,0x2
ffffffffc0203d8c:	4405b583          	ld	a1,1088(a1) # ffffffffc02061c8 <error_string+0x38>
ffffffffc0203d90:	02b60633          	mul	a2,a2,a1
ffffffffc0203d94:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d98:	00002797          	auipc	a5,0x2
ffffffffc0203d9c:	4387b783          	ld	a5,1080(a5) # ffffffffc02061d0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203da0:	0000d717          	auipc	a4,0xd
ffffffffc0203da4:	78073703          	ld	a4,1920(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203da8:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203daa:	00c61793          	slli	a5,a2,0xc
ffffffffc0203dae:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203db0:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203db2:	02e7f963          	bgeu	a5,a4,ffffffffc0203de4 <swapfs_read+0x80>
}
ffffffffc0203db6:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203db8:	0000d797          	auipc	a5,0xd
ffffffffc0203dbc:	7807b783          	ld	a5,1920(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203dc0:	46a1                	li	a3,8
ffffffffc0203dc2:	963e                	add	a2,a2,a5
ffffffffc0203dc4:	4505                	li	a0,1
}
ffffffffc0203dc6:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dc8:	ed8fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dcc:	86aa                	mv	a3,a0
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	19260613          	addi	a2,a2,402 # ffffffffc0205f60 <default_pmm_manager+0xe40>
ffffffffc0203dd6:	45d5                	li	a1,21
ffffffffc0203dd8:	00002517          	auipc	a0,0x2
ffffffffc0203ddc:	17050513          	addi	a0,a0,368 # ffffffffc0205f48 <default_pmm_manager+0xe28>
ffffffffc0203de0:	d94fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203de4:	86b2                	mv	a3,a2
ffffffffc0203de6:	06a00593          	li	a1,106
ffffffffc0203dea:	00001617          	auipc	a2,0x1
ffffffffc0203dee:	3c660613          	addi	a2,a2,966 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0203df2:	00001517          	auipc	a0,0x1
ffffffffc0203df6:	38650513          	addi	a0,a0,902 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203dfa:	d7afc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203dfe <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc0203dfe:	1141                	addi	sp,sp,-16
ffffffffc0203e00:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e02:	00855793          	srli	a5,a0,0x8
ffffffffc0203e06:	c3a5                	beqz	a5,ffffffffc0203e66 <swapfs_write+0x68>
ffffffffc0203e08:	0000d717          	auipc	a4,0xd
ffffffffc0203e0c:	73873703          	ld	a4,1848(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e10:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e66 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e14:	0000d617          	auipc	a2,0xd
ffffffffc0203e18:	71463603          	ld	a2,1812(a2) # ffffffffc0211528 <pages>
ffffffffc0203e1c:	8d91                	sub	a1,a1,a2
ffffffffc0203e1e:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e22:	00002597          	auipc	a1,0x2
ffffffffc0203e26:	3a65b583          	ld	a1,934(a1) # ffffffffc02061c8 <error_string+0x38>
ffffffffc0203e2a:	02b60633          	mul	a2,a2,a1
ffffffffc0203e2e:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e32:	00002797          	auipc	a5,0x2
ffffffffc0203e36:	39e7b783          	ld	a5,926(a5) # ffffffffc02061d0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e3a:	0000d717          	auipc	a4,0xd
ffffffffc0203e3e:	6e673703          	ld	a4,1766(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e42:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e44:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e48:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e4a:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e4c:	02e7f963          	bgeu	a5,a4,ffffffffc0203e7e <swapfs_write+0x80>
}
ffffffffc0203e50:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e52:	0000d797          	auipc	a5,0xd
ffffffffc0203e56:	6e67b783          	ld	a5,1766(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203e5a:	46a1                	li	a3,8
ffffffffc0203e5c:	963e                	add	a2,a2,a5
ffffffffc0203e5e:	4505                	li	a0,1
}
ffffffffc0203e60:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e62:	e62fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e66:	86aa                	mv	a3,a0
ffffffffc0203e68:	00002617          	auipc	a2,0x2
ffffffffc0203e6c:	0f860613          	addi	a2,a2,248 # ffffffffc0205f60 <default_pmm_manager+0xe40>
ffffffffc0203e70:	45e9                	li	a1,26
ffffffffc0203e72:	00002517          	auipc	a0,0x2
ffffffffc0203e76:	0d650513          	addi	a0,a0,214 # ffffffffc0205f48 <default_pmm_manager+0xe28>
ffffffffc0203e7a:	cfafc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e7e:	86b2                	mv	a3,a2
ffffffffc0203e80:	06a00593          	li	a1,106
ffffffffc0203e84:	00001617          	auipc	a2,0x1
ffffffffc0203e88:	32c60613          	addi	a2,a2,812 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0203e8c:	00001517          	auipc	a0,0x1
ffffffffc0203e90:	2ec50513          	addi	a0,a0,748 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203e94:	ce0fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e98 <printnum>:
 * */
static void
...
ffffffffc0203e98:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e9c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e9e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea2:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203ea4:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea8:	f022                	sd	s0,32(sp)
ffffffffc0203eaa:	ec26                	sd	s1,24(sp)
ffffffffc0203eac:	e84a                	sd	s2,16(sp)
ffffffffc0203eae:	f406                	sd	ra,40(sp)
ffffffffc0203eb0:	e44e                	sd	s3,8(sp)
ffffffffc0203eb2:	84aa                	mv	s1,a0
ffffffffc0203eb4:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203eb6:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203eba:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203ebc:	03067e63          	bgeu	a2,a6,ffffffffc0203ef8 <printnum+0x60>
ffffffffc0203ec0:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ec2:	00805763          	blez	s0,ffffffffc0203ed0 <printnum+0x38>
ffffffffc0203ec6:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203ec8:	85ca                	mv	a1,s2
ffffffffc0203eca:	854e                	mv	a0,s3
ffffffffc0203ecc:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203ece:	fc65                	bnez	s0,ffffffffc0203ec6 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ed0:	1a02                	slli	s4,s4,0x20
ffffffffc0203ed2:	00002797          	auipc	a5,0x2
ffffffffc0203ed6:	0ae78793          	addi	a5,a5,174 # ffffffffc0205f80 <default_pmm_manager+0xe60>
ffffffffc0203eda:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203ede:	9a3e                	add	s4,s4,a5
}
ffffffffc0203ee0:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ee2:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203ee6:	70a2                	ld	ra,40(sp)
ffffffffc0203ee8:	69a2                	ld	s3,8(sp)
ffffffffc0203eea:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eec:	85ca                	mv	a1,s2
ffffffffc0203eee:	87a6                	mv	a5,s1
}
ffffffffc0203ef0:	6942                	ld	s2,16(sp)
ffffffffc0203ef2:	64e2                	ld	s1,24(sp)
ffffffffc0203ef4:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ef6:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203ef8:	03065633          	divu	a2,a2,a6
ffffffffc0203efc:	8722                	mv	a4,s0
ffffffffc0203efe:	f9bff0ef          	jal	ra,ffffffffc0203e98 <printnum>
ffffffffc0203f02:	b7f9                	j	ffffffffc0203ed0 <printnum+0x38>

ffffffffc0203f04 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f04:	7119                	addi	sp,sp,-128
ffffffffc0203f06:	f4a6                	sd	s1,104(sp)
ffffffffc0203f08:	f0ca                	sd	s2,96(sp)
ffffffffc0203f0a:	ecce                	sd	s3,88(sp)
ffffffffc0203f0c:	e8d2                	sd	s4,80(sp)
ffffffffc0203f0e:	e4d6                	sd	s5,72(sp)
ffffffffc0203f10:	e0da                	sd	s6,64(sp)
ffffffffc0203f12:	fc5e                	sd	s7,56(sp)
ffffffffc0203f14:	f06a                	sd	s10,32(sp)
ffffffffc0203f16:	fc86                	sd	ra,120(sp)
ffffffffc0203f18:	f8a2                	sd	s0,112(sp)
ffffffffc0203f1a:	f862                	sd	s8,48(sp)
ffffffffc0203f1c:	f466                	sd	s9,40(sp)
ffffffffc0203f1e:	ec6e                	sd	s11,24(sp)
ffffffffc0203f20:	892a                	mv	s2,a0
ffffffffc0203f22:	84ae                	mv	s1,a1
ffffffffc0203f24:	8d32                	mv	s10,a2
ffffffffc0203f26:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f28:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f2c:	5b7d                	li	s6,-1
ffffffffc0203f2e:	00002a97          	auipc	s5,0x2
ffffffffc0203f32:	086a8a93          	addi	s5,s5,134 # ffffffffc0205fb4 <default_pmm_manager+0xe94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f36:	00002b97          	auipc	s7,0x2
ffffffffc0203f3a:	25ab8b93          	addi	s7,s7,602 # ffffffffc0206190 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f3e:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f42:	001d0413          	addi	s0,s10,1
ffffffffc0203f46:	01350a63          	beq	a0,s3,ffffffffc0203f5a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f4a:	c121                	beqz	a0,ffffffffc0203f8a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f4c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f4e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f50:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f52:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f56:	ff351ae3          	bne	a0,s3,ffffffffc0203f4a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f5a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f5e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f62:	4c81                	li	s9,0
ffffffffc0203f64:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f66:	5c7d                	li	s8,-1
ffffffffc0203f68:	5dfd                	li	s11,-1
ffffffffc0203f6a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f6e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f70:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f74:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f78:	00140d13          	addi	s10,s0,1
ffffffffc0203f7c:	04b56263          	bltu	a0,a1,ffffffffc0203fc0 <vprintfmt+0xbc>
ffffffffc0203f80:	058a                	slli	a1,a1,0x2
ffffffffc0203f82:	95d6                	add	a1,a1,s5
ffffffffc0203f84:	4194                	lw	a3,0(a1)
ffffffffc0203f86:	96d6                	add	a3,a3,s5
ffffffffc0203f88:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f8a:	70e6                	ld	ra,120(sp)
ffffffffc0203f8c:	7446                	ld	s0,112(sp)
ffffffffc0203f8e:	74a6                	ld	s1,104(sp)
ffffffffc0203f90:	7906                	ld	s2,96(sp)
ffffffffc0203f92:	69e6                	ld	s3,88(sp)
ffffffffc0203f94:	6a46                	ld	s4,80(sp)
ffffffffc0203f96:	6aa6                	ld	s5,72(sp)
ffffffffc0203f98:	6b06                	ld	s6,64(sp)
ffffffffc0203f9a:	7be2                	ld	s7,56(sp)
ffffffffc0203f9c:	7c42                	ld	s8,48(sp)
ffffffffc0203f9e:	7ca2                	ld	s9,40(sp)
ffffffffc0203fa0:	7d02                	ld	s10,32(sp)
ffffffffc0203fa2:	6de2                	ld	s11,24(sp)
ffffffffc0203fa4:	6109                	addi	sp,sp,128
ffffffffc0203fa6:	8082                	ret
            padc = '0';
ffffffffc0203fa8:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203faa:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fae:	846a                	mv	s0,s10
ffffffffc0203fb0:	00140d13          	addi	s10,s0,1
ffffffffc0203fb4:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fb8:	0ff5f593          	zext.b	a1,a1
ffffffffc0203fbc:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f80 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203fc0:	85a6                	mv	a1,s1
ffffffffc0203fc2:	02500513          	li	a0,37
ffffffffc0203fc6:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fc8:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fcc:	8d22                	mv	s10,s0
ffffffffc0203fce:	f73788e3          	beq	a5,s3,ffffffffc0203f3e <vprintfmt+0x3a>
ffffffffc0203fd2:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fd6:	1d7d                	addi	s10,s10,-1
ffffffffc0203fd8:	ff379de3          	bne	a5,s3,ffffffffc0203fd2 <vprintfmt+0xce>
ffffffffc0203fdc:	b78d                	j	ffffffffc0203f3e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fde:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203fe2:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fe6:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203fe8:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fec:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203ff0:	02d86463          	bltu	a6,a3,ffffffffc0204018 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203ff4:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203ff8:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203ffc:	0186873b          	addw	a4,a3,s8
ffffffffc0204000:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204004:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204006:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020400a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020400c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204010:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204014:	fed870e3          	bgeu	a6,a3,ffffffffc0203ff4 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204018:	f40ddce3          	bgez	s11,ffffffffc0203f70 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020401c:	8de2                	mv	s11,s8
ffffffffc020401e:	5c7d                	li	s8,-1
ffffffffc0204020:	bf81                	j	ffffffffc0203f70 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204022:	fffdc693          	not	a3,s11
ffffffffc0204026:	96fd                	srai	a3,a3,0x3f
ffffffffc0204028:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020402c:	00144603          	lbu	a2,1(s0)
ffffffffc0204030:	2d81                	sext.w	s11,s11
ffffffffc0204032:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204034:	bf35                	j	ffffffffc0203f70 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204036:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020403a:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc020403e:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204040:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204042:	bfd9                	j	ffffffffc0204018 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204044:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204046:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020404a:	01174463          	blt	a4,a7,ffffffffc0204052 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020404e:	1a088e63          	beqz	a7,ffffffffc020420a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204052:	000a3603          	ld	a2,0(s4)
ffffffffc0204056:	46c1                	li	a3,16
ffffffffc0204058:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020405a:	2781                	sext.w	a5,a5
ffffffffc020405c:	876e                	mv	a4,s11
ffffffffc020405e:	85a6                	mv	a1,s1
ffffffffc0204060:	854a                	mv	a0,s2
ffffffffc0204062:	e37ff0ef          	jal	ra,ffffffffc0203e98 <printnum>
            break;
ffffffffc0204066:	bde1                	j	ffffffffc0203f3e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204068:	000a2503          	lw	a0,0(s4)
ffffffffc020406c:	85a6                	mv	a1,s1
ffffffffc020406e:	0a21                	addi	s4,s4,8
ffffffffc0204070:	9902                	jalr	s2
            break;
ffffffffc0204072:	b5f1                	j	ffffffffc0203f3e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204074:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204076:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020407a:	01174463          	blt	a4,a7,ffffffffc0204082 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020407e:	18088163          	beqz	a7,ffffffffc0204200 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204082:	000a3603          	ld	a2,0(s4)
ffffffffc0204086:	46a9                	li	a3,10
ffffffffc0204088:	8a2e                	mv	s4,a1
ffffffffc020408a:	bfc1                	j	ffffffffc020405a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020408c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204090:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204092:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204094:	bdf1                	j	ffffffffc0203f70 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204096:	85a6                	mv	a1,s1
ffffffffc0204098:	02500513          	li	a0,37
ffffffffc020409c:	9902                	jalr	s2
            break;
ffffffffc020409e:	b545                	j	ffffffffc0203f3e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a0:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040a4:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040a8:	b5e1                	j	ffffffffc0203f70 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040aa:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040ac:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040b0:	01174463          	blt	a4,a7,ffffffffc02040b8 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040b4:	14088163          	beqz	a7,ffffffffc02041f6 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040b8:	000a3603          	ld	a2,0(s4)
ffffffffc02040bc:	46a1                	li	a3,8
ffffffffc02040be:	8a2e                	mv	s4,a1
ffffffffc02040c0:	bf69                	j	ffffffffc020405a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040c2:	03000513          	li	a0,48
ffffffffc02040c6:	85a6                	mv	a1,s1
ffffffffc02040c8:	e03e                	sd	a5,0(sp)
ffffffffc02040ca:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040cc:	85a6                	mv	a1,s1
ffffffffc02040ce:	07800513          	li	a0,120
ffffffffc02040d2:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040d4:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040d6:	6782                	ld	a5,0(sp)
ffffffffc02040d8:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040da:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040de:	bfb5                	j	ffffffffc020405a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040e0:	000a3403          	ld	s0,0(s4)
ffffffffc02040e4:	008a0713          	addi	a4,s4,8
ffffffffc02040e8:	e03a                	sd	a4,0(sp)
ffffffffc02040ea:	14040263          	beqz	s0,ffffffffc020422e <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040ee:	0fb05763          	blez	s11,ffffffffc02041dc <vprintfmt+0x2d8>
ffffffffc02040f2:	02d00693          	li	a3,45
ffffffffc02040f6:	0cd79163          	bne	a5,a3,ffffffffc02041b8 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040fa:	00044783          	lbu	a5,0(s0)
ffffffffc02040fe:	0007851b          	sext.w	a0,a5
ffffffffc0204102:	cf85                	beqz	a5,ffffffffc020413a <vprintfmt+0x236>
ffffffffc0204104:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204108:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020410c:	000c4563          	bltz	s8,ffffffffc0204116 <vprintfmt+0x212>
ffffffffc0204110:	3c7d                	addiw	s8,s8,-1
ffffffffc0204112:	036c0263          	beq	s8,s6,ffffffffc0204136 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204116:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204118:	0e0c8e63          	beqz	s9,ffffffffc0204214 <vprintfmt+0x310>
ffffffffc020411c:	3781                	addiw	a5,a5,-32
ffffffffc020411e:	0ef47b63          	bgeu	s0,a5,ffffffffc0204214 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204122:	03f00513          	li	a0,63
ffffffffc0204126:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204128:	000a4783          	lbu	a5,0(s4)
ffffffffc020412c:	3dfd                	addiw	s11,s11,-1
ffffffffc020412e:	0a05                	addi	s4,s4,1
ffffffffc0204130:	0007851b          	sext.w	a0,a5
ffffffffc0204134:	ffe1                	bnez	a5,ffffffffc020410c <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204136:	01b05963          	blez	s11,ffffffffc0204148 <vprintfmt+0x244>
ffffffffc020413a:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020413c:	85a6                	mv	a1,s1
ffffffffc020413e:	02000513          	li	a0,32
ffffffffc0204142:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204144:	fe0d9be3          	bnez	s11,ffffffffc020413a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204148:	6a02                	ld	s4,0(sp)
ffffffffc020414a:	bbd5                	j	ffffffffc0203f3e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020414c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020414e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204152:	01174463          	blt	a4,a7,ffffffffc020415a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204156:	08088d63          	beqz	a7,ffffffffc02041f0 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc020415a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020415e:	0a044d63          	bltz	s0,ffffffffc0204218 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204162:	8622                	mv	a2,s0
ffffffffc0204164:	8a66                	mv	s4,s9
ffffffffc0204166:	46a9                	li	a3,10
ffffffffc0204168:	bdcd                	j	ffffffffc020405a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc020416a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020416e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204170:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204172:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204176:	8fb5                	xor	a5,a5,a3
ffffffffc0204178:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020417c:	02d74163          	blt	a4,a3,ffffffffc020419e <vprintfmt+0x29a>
ffffffffc0204180:	00369793          	slli	a5,a3,0x3
ffffffffc0204184:	97de                	add	a5,a5,s7
ffffffffc0204186:	639c                	ld	a5,0(a5)
ffffffffc0204188:	cb99                	beqz	a5,ffffffffc020419e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020418a:	86be                	mv	a3,a5
ffffffffc020418c:	00002617          	auipc	a2,0x2
ffffffffc0204190:	e2460613          	addi	a2,a2,-476 # ffffffffc0205fb0 <default_pmm_manager+0xe90>
ffffffffc0204194:	85a6                	mv	a1,s1
ffffffffc0204196:	854a                	mv	a0,s2
ffffffffc0204198:	0ce000ef          	jal	ra,ffffffffc0204266 <printfmt>
ffffffffc020419c:	b34d                	j	ffffffffc0203f3e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020419e:	00002617          	auipc	a2,0x2
ffffffffc02041a2:	e0260613          	addi	a2,a2,-510 # ffffffffc0205fa0 <default_pmm_manager+0xe80>
ffffffffc02041a6:	85a6                	mv	a1,s1
ffffffffc02041a8:	854a                	mv	a0,s2
ffffffffc02041aa:	0bc000ef          	jal	ra,ffffffffc0204266 <printfmt>
ffffffffc02041ae:	bb41                	j	ffffffffc0203f3e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041b0:	00002417          	auipc	s0,0x2
ffffffffc02041b4:	de840413          	addi	s0,s0,-536 # ffffffffc0205f98 <default_pmm_manager+0xe78>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041b8:	85e2                	mv	a1,s8
ffffffffc02041ba:	8522                	mv	a0,s0
ffffffffc02041bc:	e43e                	sd	a5,8(sp)
ffffffffc02041be:	196000ef          	jal	ra,ffffffffc0204354 <strnlen>
ffffffffc02041c2:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041c6:	01b05b63          	blez	s11,ffffffffc02041dc <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041ca:	67a2                	ld	a5,8(sp)
ffffffffc02041cc:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
...
ffffffffc02041d6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041d8:	fe0d9ce3          	bnez	s11,ffffffffc02041d0 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041dc:	00044783          	lbu	a5,0(s0)
ffffffffc02041e0:	00140a13          	addi	s4,s0,1
ffffffffc02041e4:	0007851b          	sext.w	a0,a5
ffffffffc02041e8:	d3a5                	beqz	a5,ffffffffc0204148 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041ea:	05e00413          	li	s0,94
ffffffffc02041ee:	bf39                	j	ffffffffc020410c <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041f0:	000a2403          	lw	s0,0(s4)
ffffffffc02041f4:	b7ad                	j	ffffffffc020415e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041f6:	000a6603          	lwu	a2,0(s4)
ffffffffc02041fa:	46a1                	li	a3,8
ffffffffc02041fc:	8a2e                	mv	s4,a1
ffffffffc02041fe:	bdb1                	j	ffffffffc020405a <vprintfmt+0x156>
ffffffffc0204200:	000a6603          	lwu	a2,0(s4)
ffffffffc0204204:	46a9                	li	a3,10
ffffffffc0204206:	8a2e                	mv	s4,a1
ffffffffc0204208:	bd89                	j	ffffffffc020405a <vprintfmt+0x156>
ffffffffc020420a:	000a6603          	lwu	a2,0(s4)
ffffffffc020420e:	46c1                	li	a3,16
ffffffffc0204210:	8a2e                	mv	s4,a1
ffffffffc0204212:	b5a1                	j	ffffffffc020405a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204214:	9902                	jalr	s2
ffffffffc0204216:	bf09                	j	ffffffffc0204128 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204218:	85a6                	mv	a1,s1
ffffffffc020421a:	02d00513          	li	a0,45
ffffffffc020421e:	e03e                	sd	a5,0(sp)
ffffffffc0204220:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204222:	6782                	ld	a5,0(sp)
ffffffffc0204224:	8a66                	mv	s4,s9
ffffffffc0204226:	40800633          	neg	a2,s0
ffffffffc020422a:	46a9                	li	a3,10
ffffffffc020422c:	b53d                	j	ffffffffc020405a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc020422e:	03b05163          	blez	s11,ffffffffc0204250 <vprintfmt+0x34c>
ffffffffc0204232:	02d00693          	li	a3,45
ffffffffc0204236:	f6d79de3          	bne	a5,a3,ffffffffc02041b0 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc020423a:	00002417          	auipc	s0,0x2
ffffffffc020423e:	d5e40413          	addi	s0,s0,-674 # ffffffffc0205f98 <default_pmm_manager+0xe78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204242:	02800793          	li	a5,40
ffffffffc0204246:	02800513          	li	a0,40
ffffffffc020424a:	00140a13          	addi	s4,s0,1
ffffffffc020424e:	bd6d                	j	ffffffffc0204108 <vprintfmt+0x204>
ffffffffc0204250:	00002a17          	auipc	s4,0x2
ffffffffc0204254:	d49a0a13          	addi	s4,s4,-695 # ffffffffc0205f99 <default_pmm_manager+0xe79>
ffffffffc0204258:	02800513          	li	a0,40
ffffffffc020425c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204260:	05e00413          	li	s0,94
ffffffffc0204264:	b565                	j	ffffffffc020410c <vprintfmt+0x208>

ffffffffc0204266 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204266:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204268:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020426c:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020426e:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204270:	ec06                	sd	ra,24(sp)
ffffffffc0204272:	f83a                	sd	a4,48(sp)
ffffffffc0204274:	fc3e                	sd	a5,56(sp)
ffffffffc0204276:	e0c2                	sd	a6,64(sp)
ffffffffc0204278:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020427a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020427c:	c89ff0ef          	jal	ra,ffffffffc0203f04 <vprintfmt>
}
ffffffffc0204280:	60e2                	ld	ra,24(sp)
ffffffffc0204282:	6161                	addi	sp,sp,80
ffffffffc0204284:	8082                	ret

ffffffffc0204286 <readline>:
...
ffffffffc0204286:	715d                	addi	sp,sp,-80
ffffffffc0204288:	e486                	sd	ra,72(sp)
ffffffffc020428a:	e0a6                	sd	s1,64(sp)
ffffffffc020428c:	fc4a                	sd	s2,56(sp)
ffffffffc020428e:	f84e                	sd	s3,48(sp)
ffffffffc0204290:	f452                	sd	s4,40(sp)
ffffffffc0204292:	f056                	sd	s5,32(sp)
ffffffffc0204294:	ec5a                	sd	s6,24(sp)
ffffffffc0204296:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204298:	c901                	beqz	a0,ffffffffc02042a8 <readline+0x22>
ffffffffc020429a:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc020429c:	00002517          	auipc	a0,0x2
ffffffffc02042a0:	d1450513          	addi	a0,a0,-748 # ffffffffc0205fb0 <default_pmm_manager+0xe90>
ffffffffc02042a4:	e17fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc02042aa:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042ac:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042ae:	4aa9                	li	s5,10
ffffffffc02042b0:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042b2:	0000db97          	auipc	s7,0xd
ffffffffc02042b6:	e46b8b93          	addi	s7,s7,-442 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042ba:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042be:	e35fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042c2:	00054a63          	bltz	a0,ffffffffc02042d6 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042c6:	00a95a63          	bge	s2,a0,ffffffffc02042da <readline+0x54>
ffffffffc02042ca:	029a5263          	bge	s4,s1,ffffffffc02042ee <readline+0x68>
        c = getchar();
ffffffffc02042ce:	e25fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042d2:	fe055ae3          	bgez	a0,ffffffffc02042c6 <readline+0x40>
            return NULL;
ffffffffc02042d6:	4501                	li	a0,0
ffffffffc02042d8:	a091                	j	ffffffffc020431c <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042da:	03351463          	bne	a0,s3,ffffffffc0204302 <readline+0x7c>
ffffffffc02042de:	e8a9                	bnez	s1,ffffffffc0204330 <readline+0xaa>
        c = getchar();
ffffffffc02042e0:	e13fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042e4:	fe0549e3          	bltz	a0,ffffffffc02042d6 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042e8:	fea959e3          	bge	s2,a0,ffffffffc02042da <readline+0x54>
ffffffffc02042ec:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042ee:	e42a                	sd	a0,8(sp)
ffffffffc02042f0:	e01fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042f4:	6522                	ld	a0,8(sp)
ffffffffc02042f6:	009b87b3          	add	a5,s7,s1
ffffffffc02042fa:	2485                	addiw	s1,s1,1
ffffffffc02042fc:	00a78023          	sb	a0,0(a5)
ffffffffc0204300:	bf7d                	j	ffffffffc02042be <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204302:	01550463          	beq	a0,s5,ffffffffc020430a <readline+0x84>
ffffffffc0204306:	fb651ce3          	bne	a0,s6,ffffffffc02042be <readline+0x38>
            cputchar(c);
ffffffffc020430a:	de7fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc020430e:	0000d517          	auipc	a0,0xd
ffffffffc0204312:	dea50513          	addi	a0,a0,-534 # ffffffffc02110f8 <buf>
ffffffffc0204316:	94aa                	add	s1,s1,a0
ffffffffc0204318:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc020431c:	60a6                	ld	ra,72(sp)
ffffffffc020431e:	6486                	ld	s1,64(sp)
ffffffffc0204320:	7962                	ld	s2,56(sp)
ffffffffc0204322:	79c2                	ld	s3,48(sp)
ffffffffc0204324:	7a22                	ld	s4,40(sp)
ffffffffc0204326:	7a82                	ld	s5,32(sp)
ffffffffc0204328:	6b62                	ld	s6,24(sp)
ffffffffc020432a:	6bc2                	ld	s7,16(sp)
ffffffffc020432c:	6161                	addi	sp,sp,80
ffffffffc020432e:	8082                	ret
            cputchar(c);
ffffffffc0204330:	4521                	li	a0,8
ffffffffc0204332:	dbffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204336:	34fd                	addiw	s1,s1,-1
ffffffffc0204338:	b759                	j	ffffffffc02042be <readline+0x38>

ffffffffc020433a <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc020433a:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc020433e:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204340:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204342:	cb81                	beqz	a5,ffffffffc0204352 <strlen+0x18>
        cnt ++;
ffffffffc0204344:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204346:	00a707b3          	add	a5,a4,a0
ffffffffc020434a:	0007c783          	lbu	a5,0(a5)
ffffffffc020434e:	fbfd                	bnez	a5,ffffffffc0204344 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204354:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204356:	e589                	bnez	a1,ffffffffc0204360 <strnlen+0xc>
ffffffffc0204358:	a811                	j	ffffffffc020436c <strnlen+0x18>
        cnt ++;
ffffffffc020435a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020435c:	00f58863          	beq	a1,a5,ffffffffc020436c <strnlen+0x18>
ffffffffc0204360:	00f50733          	add	a4,a0,a5
ffffffffc0204364:	00074703          	lbu	a4,0(a4)
ffffffffc0204368:	fb6d                	bnez	a4,ffffffffc020435a <strnlen+0x6>
ffffffffc020436a:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020436c:	852e                	mv	a0,a1
ffffffffc020436e:	8082                	ret

ffffffffc0204370 <strcpy>:
char *
...
ffffffffc0204370:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204372:	0005c703          	lbu	a4,0(a1)
ffffffffc0204376:	0785                	addi	a5,a5,1
ffffffffc0204378:	0585                	addi	a1,a1,1
ffffffffc020437a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020437e:	fb75                	bnez	a4,ffffffffc0204372 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204382:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204386:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020438a:	cb89                	beqz	a5,ffffffffc020439c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020438c:	0505                	addi	a0,a0,1
ffffffffc020438e:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204390:	fee789e3          	beq	a5,a4,ffffffffc0204382 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204394:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204398:	9d19                	subw	a0,a0,a4
ffffffffc020439a:	8082                	ret
ffffffffc020439c:	4501                	li	a0,0
ffffffffc020439e:	bfed                	j	ffffffffc0204398 <strcmp+0x16>

ffffffffc02043a0 <strchr>:
...
ffffffffc02043a4:	c799                	beqz	a5,ffffffffc02043b2 <strchr+0x12>
        if (*s == c) {
ffffffffc02043a6:	00f58763          	beq	a1,a5,ffffffffc02043b4 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043aa:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043ae:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043b0:	fbfd                	bnez	a5,ffffffffc02043a6 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043b6:	ca01                	beqz	a2,ffffffffc02043c6 <memset+0x10>
ffffffffc02043b8:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043ba:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043bc:	0785                	addi	a5,a5,1
ffffffffc02043be:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043c2:	fec79de3          	bne	a5,a2,ffffffffc02043bc <memset+0x6>
    }
    return s;
...
ffffffffc02043c8 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043c8:	ca19                	beqz	a2,ffffffffc02043de <memcpy+0x16>
ffffffffc02043ca:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043cc:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043ce:	0005c703          	lbu	a4,0(a1)
ffffffffc02043d2:	0585                	addi	a1,a1,1
ffffffffc02043d4:	0785                	addi	a5,a5,1
ffffffffc02043d6:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043da:	fec59ae3          	bne	a1,a2,ffffffffc02043ce <memcpy+0x6>
    }
    return dst;
