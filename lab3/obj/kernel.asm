...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	44c040ef          	jal	ra,ffffffffc0204496 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	47258593          	addi	a1,a1,1138 # ffffffffc02044c0 <etext>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	48a50513          	addi	a0,a0,1162 # ffffffffc02044e0 <etext+0x20>
...
ffffffffc020006e:	6e2030ef          	jal	ra,ffffffffc0203750 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	737030ef          	jal	ra,ffffffffc0203fe4 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	701030ef          	jal	ra,ffffffffc0203fe4 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	3e450513          	addi	a0,a0,996 # ffffffffc02044e8 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	3ee50513          	addi	a0,a0,1006 # ffffffffc0204508 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	39a58593          	addi	a1,a1,922 # ffffffffc02044c0 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	3fa50513          	addi	a0,a0,1018 # ffffffffc0204528 <etext+0x68>
...
ffffffffc0200146:	40650513          	addi	a0,a0,1030 # ffffffffc0204548 <etext+0x88>
...
ffffffffc020015a:	41250513          	addi	a0,a0,1042 # ffffffffc0204568 <etext+0xa8>
...
ffffffffc0200188:	40450513          	addi	a0,a0,1028 # ffffffffc0204588 <etext+0xc8>
}
...
ffffffffc0200196:	42660613          	addi	a2,a2,1062 # ffffffffc02045b8 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	43250513          	addi	a0,a0,1074 # ffffffffc02045d0 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	43a60613          	addi	a2,a2,1082 # ffffffffc02045e8 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	45258593          	addi	a1,a1,1106 # ffffffffc0204608 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	45250513          	addi	a0,a0,1106 # ffffffffc0204610 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	45460613          	addi	a2,a2,1108 # ffffffffc0204620 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	47458593          	addi	a1,a1,1140 # ffffffffc0204648 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	43450513          	addi	a0,a0,1076 # ffffffffc0204610 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	47060613          	addi	a2,a2,1136 # ffffffffc0204658 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	48858593          	addi	a1,a1,1160 # ffffffffc0204678 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	41850513          	addi	a0,a0,1048 # ffffffffc0204610 <etext+0x150>
...
ffffffffc0200236:	45650513          	addi	a0,a0,1110 # ffffffffc0204688 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	45c50513          	addi	a0,a0,1116 # ffffffffc02046b0 <etext+0x1f0>
...
ffffffffc020026e:	4aec0c13          	addi	s8,s8,1198 # ffffffffc0204718 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00006917          	auipc	s2,0x6
ffffffffc0200276:	8b690913          	addi	s2,s2,-1866 # ffffffffc0205b28 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	45e48493          	addi	s1,s1,1118 # ffffffffc02046d8 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	45cb0b13          	addi	s6,s6,1116 # ffffffffc02046e0 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	37ca0a13          	addi	s4,s4,892 # ffffffffc0204608 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	0ce040ef          	jal	ra,ffffffffc0204366 <readline>
...
ffffffffc02002b2:	46ad0d13          	addi	s10,s10,1130 # ffffffffc0204718 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	1a6040ef          	jal	ra,ffffffffc0204462 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	192040ef          	jal	ra,ffffffffc0204462 <strcmp>
...
ffffffffc020030e:	172040ef          	jal	ra,ffffffffc0204480 <strchr>
...
ffffffffc020034c:	134040ef          	jal	ra,ffffffffc0204480 <strchr>
...
ffffffffc020036a:	39a50513          	addi	a0,a0,922 # ffffffffc0204700 <etext+0x240>
...
ffffffffc02003a6:	3be50513          	addi	a0,a0,958 # ffffffffc0204760 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	2c050513          	addi	a0,a0,704 # ffffffffc0205678 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	38a50513          	addi	a0,a0,906 # ffffffffc0204780 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	7f1030ef          	jal	ra,ffffffffc02044a8 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	7cd030ef          	jal	ra,ffffffffc02044a8 <memcpy>
    return 0;
}
...
ffffffffc0200528:	27c50513          	addi	a0,a0,636 # ffffffffc02047a0 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7e00306f          	j	ffffffffc0203d28 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	27460613          	addi	a2,a2,628 # ffffffffc02047c0 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	28050513          	addi	a0,a0,640 # ffffffffc02047d8 <commands+0xc0>
...
ffffffffc020058e:	26650513          	addi	a0,a0,614 # ffffffffc02047f0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	39650513          	addi	a0,a0,918 # ffffffffc0204ad8 <commands+0x3c0>
}
...
ffffffffc020075a:	39a50513          	addi	a0,a0,922 # ffffffffc0204af0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	39a50513          	addi	a0,a0,922 # ffffffffc0204b08 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	3a250513          	addi	a0,a0,930 # ffffffffc0204b20 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	3aa50513          	addi	a0,a0,938 # ffffffffc0204b38 <commands+0x420>
...
ffffffffc02007a6:	3ae50513          	addi	a0,a0,942 # ffffffffc0204b50 <commands+0x438>
}
...
ffffffffc02007c2:	45a70713          	addi	a4,a4,1114 # ffffffffc0204c18 <commands+0x500>
...
ffffffffc02007d4:	3f850513          	addi	a0,a0,1016 # ffffffffc0204bc8 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	3cc50513          	addi	a0,a0,972 # ffffffffc0204ba8 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	38050513          	addi	a0,a0,896 # ffffffffc0204b68 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	39450513          	addi	a0,a0,916 # ffffffffc0204b88 <commands+0x470>
...
ffffffffc020082a:	3d250513          	addi	a0,a0,978 # ffffffffc0204bf8 <commands+0x4e0>
...
ffffffffc020083e:	3ae50513          	addi	a0,a0,942 # ffffffffc0204be8 <commands+0x4d0>
}
...
ffffffffc0200860:	5a470713          	addi	a4,a4,1444 # ffffffffc0204e00 <commands+0x6e8>
...
ffffffffc0200872:	57a50513          	addi	a0,a0,1402 # ffffffffc0204de8 <commands+0x6d0>
...
ffffffffc0200894:	3b850513          	addi	a0,a0,952 # ffffffffc0204c48 <commands+0x530>
}
...
ffffffffc02008a8:	3c450513          	addi	a0,a0,964 # ffffffffc0204c68 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	3da50513          	addi	a0,a0,986 # ffffffffc0204c88 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	3e850513          	addi	a0,a0,1000 # ffffffffc0204ca0 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	3ee50513          	addi	a0,a0,1006 # ffffffffc0204cb0 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	40450513          	addi	a0,a0,1028 # ffffffffc0204cd0 <commands+0x5b8>
...
ffffffffc02008ee:	3fe60613          	addi	a2,a2,1022 # ffffffffc0204ce8 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	ee250513          	addi	a0,a0,-286 # ffffffffc02047d8 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	40650513          	addi	a0,a0,1030 # ffffffffc0204d08 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	41450513          	addi	a0,a0,1044 # ffffffffc0204d20 <commands+0x608>
...
ffffffffc0200998:	35460613          	addi	a2,a2,852 # ffffffffc0204ce8 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	e3850513          	addi	a0,a0,-456 # ffffffffc02047d8 <commands+0xc0>
...
ffffffffc02009c4:	32860613          	addi	a2,a2,808 # ffffffffc0204ce8 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	e0c50513          	addi	a0,a0,-500 # ffffffffc02047d8 <commands+0xc0>
...
ffffffffc0200dc6:	07e68693          	addi	a3,a3,126 # ffffffffc0204e40 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	08660613          	addi	a2,a2,134 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200dd2:	0ef00593          	li	a1,239
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	09250513          	addi	a0,a0,146 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	11e68693          	addi	a3,a3,286 # ffffffffc0204f00 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	06660613          	addi	a2,a2,102 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200df2:	0bc00593          	li	a1,188
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	07250513          	addi	a0,a0,114 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	12668693          	addi	a3,a3,294 # ffffffffc0204f28 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	04660613          	addi	a2,a2,70 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200e12:	0bd00593          	li	a1,189
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	05250513          	addi	a0,a0,82 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	14668693          	addi	a3,a3,326 # ffffffffc0204f68 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	02660613          	addi	a2,a2,38 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200e32:	0bf00593          	li	a1,191
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	03250513          	addi	a0,a0,50 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	1ae68693          	addi	a3,a3,430 # ffffffffc0204ff0 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	00660613          	addi	a2,a2,6 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200e52:	0d800593          	li	a1,216
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	01250513          	addi	a0,a0,18 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	03e68693          	addi	a3,a3,62 # ffffffffc0204ea0 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	fe660613          	addi	a2,a2,-26 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200e72:	0d100593          	li	a1,209
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	ff250513          	addi	a0,a0,-14 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	15e68693          	addi	a3,a3,350 # ffffffffc0204fe0 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	fc660613          	addi	a2,a2,-58 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200e92:	0cf00593          	li	a1,207
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	fd250513          	addi	a0,a0,-46 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	12668693          	addi	a3,a3,294 # ffffffffc0204fc8 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	fa660613          	addi	a2,a2,-90 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200eb2:	0ca00593          	li	a1,202
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	fb250513          	addi	a0,a0,-78 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	0e668693          	addi	a3,a3,230 # ffffffffc0204fa8 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	f8660613          	addi	a2,a2,-122 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200ed2:	0c100593          	li	a1,193
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	f9250513          	addi	a0,a0,-110 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	15668693          	addi	a3,a3,342 # ffffffffc0205038 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	f6660613          	addi	a2,a2,-154 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200ef2:	0f700593          	li	a1,247
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	f7250513          	addi	a0,a0,-142 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	12668693          	addi	a3,a3,294 # ffffffffc0205028 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	f4660613          	addi	a2,a2,-186 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200f12:	0de00593          	li	a1,222
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	f5250513          	addi	a0,a0,-174 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	0a668693          	addi	a3,a3,166 # ffffffffc0204fc8 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	f2660613          	addi	a2,a2,-218 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200f32:	0dc00593          	li	a1,220
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	f3250513          	addi	a0,a0,-206 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	0c668693          	addi	a3,a3,198 # ffffffffc0205008 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	f0660613          	addi	a2,a2,-250 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200f52:	0db00593          	li	a1,219
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	f1250513          	addi	a0,a0,-238 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	f3e68693          	addi	a3,a3,-194 # ffffffffc0204ea0 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	ee660613          	addi	a2,a2,-282 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200f72:	0b800593          	li	a1,184
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	ef250513          	addi	a0,a0,-270 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	04668693          	addi	a3,a3,70 # ffffffffc0204fc8 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	ec660613          	addi	a2,a2,-314 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200f92:	0d500593          	li	a1,213
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	ed250513          	addi	a0,a0,-302 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	f3e68693          	addi	a3,a3,-194 # ffffffffc0204ee0 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	ea660613          	addi	a2,a2,-346 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200fb2:	0d300593          	li	a1,211
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	eb250513          	addi	a0,a0,-334 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	efe68693          	addi	a3,a3,-258 # ffffffffc0204ec0 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	e8660613          	addi	a2,a2,-378 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200fd2:	0d200593          	li	a1,210
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	e9250513          	addi	a0,a0,-366 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	efe68693          	addi	a3,a3,-258 # ffffffffc0204ee0 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	e6660613          	addi	a2,a2,-410 # ffffffffc0204e50 <commands+0x738>
ffffffffc0200ff2:	0ba00593          	li	a1,186
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	e7250513          	addi	a0,a0,-398 # ffffffffc0204e68 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	18668693          	addi	a3,a3,390 # ffffffffc0205188 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	e4660613          	addi	a2,a2,-442 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201012:	12400593          	li	a1,292
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	e5250513          	addi	a0,a0,-430 # ffffffffc0204e68 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	00668693          	addi	a3,a3,6 # ffffffffc0205028 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	e2660613          	addi	a2,a2,-474 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201032:	11900593          	li	a1,281
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	e3250513          	addi	a0,a0,-462 # ffffffffc0204e68 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	f8668693          	addi	a3,a3,-122 # ffffffffc0204fc8 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	e0660613          	addi	a2,a2,-506 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201052:	11700593          	li	a1,279
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	e1250513          	addi	a0,a0,-494 # ffffffffc0204e68 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	f2668693          	addi	a3,a3,-218 # ffffffffc0204f88 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	de660613          	addi	a2,a2,-538 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201072:	0c000593          	li	a1,192
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	df250513          	addi	a0,a0,-526 # ffffffffc0204e68 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	0c668693          	addi	a3,a3,198 # ffffffffc0205148 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	dc660613          	addi	a2,a2,-570 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201092:	11100593          	li	a1,273
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	dd250513          	addi	a0,a0,-558 # ffffffffc0204e68 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	08668693          	addi	a3,a3,134 # ffffffffc0205128 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	da660613          	addi	a2,a2,-602 # ffffffffc0204e50 <commands+0x738>
ffffffffc02010b2:	10f00593          	li	a1,271
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	db250513          	addi	a0,a0,-590 # ffffffffc0204e68 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	03e68693          	addi	a3,a3,62 # ffffffffc0205100 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	d8660613          	addi	a2,a2,-634 # ffffffffc0204e50 <commands+0x738>
ffffffffc02010d2:	10d00593          	li	a1,269
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	d9250513          	addi	a0,a0,-622 # ffffffffc0204e68 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	ff668693          	addi	a3,a3,-10 # ffffffffc02050d8 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	d6660613          	addi	a2,a2,-666 # ffffffffc0204e50 <commands+0x738>
ffffffffc02010f2:	10c00593          	li	a1,268
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	d7250513          	addi	a0,a0,-654 # ffffffffc0204e68 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	fc668693          	addi	a3,a3,-58 # ffffffffc02050c8 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	d4660613          	addi	a2,a2,-698 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201112:	10700593          	li	a1,263
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	d5250513          	addi	a0,a0,-686 # ffffffffc0204e68 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	ea668693          	addi	a3,a3,-346 # ffffffffc0204fc8 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	d2660613          	addi	a2,a2,-730 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201132:	10600593          	li	a1,262
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	d3250513          	addi	a0,a0,-718 # ffffffffc0204e68 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	f6668693          	addi	a3,a3,-154 # ffffffffc02050a8 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	d0660613          	addi	a2,a2,-762 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201152:	10500593          	li	a1,261
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	d1250513          	addi	a0,a0,-750 # ffffffffc0204e68 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	f1668693          	addi	a3,a3,-234 # ffffffffc0205078 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	ce660613          	addi	a2,a2,-794 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201172:	10400593          	li	a1,260
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	cf250513          	addi	a0,a0,-782 # ffffffffc0204e68 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	ede68693          	addi	a3,a3,-290 # ffffffffc0205060 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	cc660613          	addi	a2,a2,-826 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201192:	10300593          	li	a1,259
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	cd250513          	addi	a0,a0,-814 # ffffffffc0204e68 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	e2668693          	addi	a3,a3,-474 # ffffffffc0204fc8 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	ca660613          	addi	a2,a2,-858 # ffffffffc0204e50 <commands+0x738>
ffffffffc02011b2:	0fd00593          	li	a1,253
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	cb250513          	addi	a0,a0,-846 # ffffffffc0204e68 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	e8668693          	addi	a3,a3,-378 # ffffffffc0205048 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	c8660613          	addi	a2,a2,-890 # ffffffffc0204e50 <commands+0x738>
ffffffffc02011d2:	0f800593          	li	a1,248
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	c9250513          	addi	a0,a0,-878 # ffffffffc0204e68 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	f8668693          	addi	a3,a3,-122 # ffffffffc0205168 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	c6660613          	addi	a2,a2,-922 # ffffffffc0204e50 <commands+0x738>
ffffffffc02011f2:	11600593          	li	a1,278
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	c7250513          	addi	a0,a0,-910 # ffffffffc0204e68 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	f9668693          	addi	a3,a3,-106 # ffffffffc0205198 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	c4660613          	addi	a2,a2,-954 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201212:	12500593          	li	a1,293
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	c5250513          	addi	a0,a0,-942 # ffffffffc0204e68 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	c5e68693          	addi	a3,a3,-930 # ffffffffc0204e80 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	c2660613          	addi	a2,a2,-986 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201232:	0f200593          	li	a1,242
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	c3250513          	addi	a0,a0,-974 # ffffffffc0204e68 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	c7e68693          	addi	a3,a3,-898 # ffffffffc0204ec0 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201252:	0b900593          	li	a1,185
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	c1250513          	addi	a0,a0,-1006 # ffffffffc0204e68 <commands+0x750>
...
ffffffffc020139e:	e1668693          	addi	a3,a3,-490 # ffffffffc02051b0 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	aae60613          	addi	a2,a2,-1362 # ffffffffc0204e50 <commands+0x738>
ffffffffc02013aa:	08200593          	li	a1,130
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	aba50513          	addi	a0,a0,-1350 # ffffffffc0204e68 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	dee68693          	addi	a3,a3,-530 # ffffffffc02051a8 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0204e50 <commands+0x738>
ffffffffc02013ca:	07f00593          	li	a1,127
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0204e68 <commands+0x750>
...
ffffffffc0201476:	d3668693          	addi	a3,a3,-714 # ffffffffc02051a8 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	9d660613          	addi	a2,a2,-1578 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201482:	06100593          	li	a1,97
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	9e250513          	addi	a0,a0,-1566 # ffffffffc0204e68 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	c9068693          	addi	a3,a3,-880 # ffffffffc02051d8 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	90060613          	addi	a2,a2,-1792 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201558:	04800593          	li	a1,72
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	90c50513          	addi	a0,a0,-1780 # ffffffffc0204e68 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	c4068693          	addi	a3,a3,-960 # ffffffffc02051a8 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	8e060613          	addi	a2,a2,-1824 # ffffffffc0204e50 <commands+0x738>
ffffffffc0201578:	04500593          	li	a1,69
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0204e68 <commands+0x750>
...
ffffffffc020158e:	cae60613          	addi	a2,a2,-850 # ffffffffc0205238 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	cc250513          	addi	a0,a0,-830 # ffffffffc0205258 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	cc260613          	addi	a2,a2,-830 # ffffffffc0205268 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	ca650513          	addi	a0,a0,-858 # ffffffffc0205258 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201760:	537020ef          	jal	ra,ffffffffc0204496 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	495020ef          	jal	ra,ffffffffc0204496 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	a3260613          	addi	a2,a2,-1486 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	a4e50513          	addi	a0,a0,-1458 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	a1a60613          	addi	a2,a2,-1510 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	a3650513          	addi	a0,a0,-1482 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	a0060613          	addi	a2,a2,-1536 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	a1c50513          	addi	a0,a0,-1508 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	9e660613          	addi	a2,a2,-1562 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	a0250513          	addi	a0,a0,-1534 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0201aba:	74a78793          	addi	a5,a5,1866 # ffffffffc0205200 <default_pmm_manager>
...
ffffffffc0201ac8:	80450513          	addi	a0,a0,-2044 # ffffffffc02052c8 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	7c050513          	addi	a0,a0,1984 # ffffffffc02052e0 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	7e050513          	addi	a0,a0,2016 # ffffffffc0205310 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	7de50513          	addi	a0,a0,2014 # ffffffffc0205328 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	7a250513          	addi	a0,a0,1954 # ffffffffc0205378 <default_pmm_manager+0x178>
...
ffffffffc0201ea2:	7c250513          	addi	a0,a0,1986 # ffffffffc0205660 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	84458593          	addi	a1,a1,-1980 # ffffffffc0205798 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	4f0020ef          	jal	ra,ffffffffc0204450 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	4f6020ef          	jal	ra,ffffffffc0204462 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb9c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	474020ef          	jal	ra,ffffffffc020441a <strlen>
...
ffffffffc020209c:	77850513          	addi	a0,a0,1912 # ffffffffc0205810 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	52268693          	addi	a3,a3,1314 # ffffffffc02056c0 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	caa60613          	addi	a2,a2,-854 # ffffffffc0204e50 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	10650513          	addi	a0,a0,262 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	4c268693          	addi	a3,a3,1218 # ffffffffc0205680 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	c8a60613          	addi	a2,a2,-886 # ffffffffc0204e50 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	0e650513          	addi	a0,a0,230 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	0b060613          	addi	a2,a2,176 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	0cc50513          	addi	a0,a0,204 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	15460613          	addi	a2,a2,340 # ffffffffc0205350 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	0b050513          	addi	a0,a0,176 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	13c60613          	addi	a2,a2,316 # ffffffffc0205350 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	09850513          	addi	a0,a0,152 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	18c68693          	addi	a3,a3,396 # ffffffffc02053b8 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	c1c60613          	addi	a2,a2,-996 # ffffffffc0204e50 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	07850513          	addi	a0,a0,120 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	14c68693          	addi	a3,a3,332 # ffffffffc0205398 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	bfc60613          	addi	a2,a2,-1028 # ffffffffc0204e50 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	05850513          	addi	a0,a0,88 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	1d868693          	addi	a3,a3,472 # ffffffffc0205448 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	bd860613          	addi	a2,a2,-1064 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	03450513          	addi	a0,a0,52 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	18868693          	addi	a3,a3,392 # ffffffffc0205418 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	bb860613          	addi	a2,a2,-1096 # ffffffffc0204e50 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	01450513          	addi	a0,a0,20 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	14068693          	addi	a3,a3,320 # ffffffffc02053f0 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	b9860613          	addi	a2,a2,-1128 # ffffffffc0204e50 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	ff450513          	addi	a0,a0,-12 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	20068693          	addi	a3,a3,512 # ffffffffc02054d0 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	b7860613          	addi	a2,a2,-1160 # ffffffffc0204e50 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	fd450513          	addi	a0,a0,-44 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	28068693          	addi	a3,a3,640 # ffffffffc0205570 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	b5860613          	addi	a2,a2,-1192 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	fb450513          	addi	a0,a0,-76 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	19868693          	addi	a3,a3,408 # ffffffffc02054a8 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	b3860613          	addi	a2,a2,-1224 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	f9450513          	addi	a0,a0,-108 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	f5e60613          	addi	a2,a2,-162 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	f7a50513          	addi	a0,a0,-134 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	1be68693          	addi	a3,a3,446 # ffffffffc0205508 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	afe60613          	addi	a2,a2,-1282 # ffffffffc0204e50 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	f5a50513          	addi	a0,a0,-166 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	26668693          	addi	a3,a3,614 # ffffffffc02055d0 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	ade60613          	addi	a2,a2,-1314 # ffffffffc0204e50 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	f3a50513          	addi	a0,a0,-198 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	22e68693          	addi	a3,a3,558 # ffffffffc02055b8 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	abe60613          	addi	a2,a2,-1346 # ffffffffc0204e50 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	f1a50513          	addi	a0,a0,-230 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	1de68693          	addi	a3,a3,478 # ffffffffc0205588 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0204e50 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	efa50513          	addi	a0,a0,-262 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	37668693          	addi	a3,a3,886 # ffffffffc0205740 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0204e50 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	eda50513          	addi	a0,a0,-294 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	16e68693          	addi	a3,a3,366 # ffffffffc0205558 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0204e50 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	eba50513          	addi	a0,a0,-326 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	13e68693          	addi	a3,a3,318 # ffffffffc0205548 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	a3e60613          	addi	a2,a2,-1474 # ffffffffc0204e50 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	e9a50513          	addi	a0,a0,-358 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	21668693          	addi	a3,a3,534 # ffffffffc0205640 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0204e50 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	e7a50513          	addi	a0,a0,-390 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	0ee68693          	addi	a3,a3,238 # ffffffffc0205538 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	9fe60613          	addi	a2,a2,-1538 # ffffffffc0204e50 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	e5a50513          	addi	a0,a0,-422 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	02668693          	addi	a3,a3,38 # ffffffffc0205490 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	9de60613          	addi	a2,a2,-1570 # ffffffffc0204e50 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	e3a50513          	addi	a0,a0,-454 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	15e68693          	addi	a3,a3,350 # ffffffffc02055e8 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	9be60613          	addi	a2,a2,-1602 # ffffffffc0204e50 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	e1a50513          	addi	a0,a0,-486 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	fce68693          	addi	a3,a3,-50 # ffffffffc0205478 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	99e60613          	addi	a2,a2,-1634 # ffffffffc0204e50 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	dfa50513          	addi	a0,a0,-518 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	dc660613          	addi	a2,a2,-570 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	d8250513          	addi	a0,a0,-638 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	13668693          	addi	a3,a3,310 # ffffffffc0205618 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	96660613          	addi	a2,a2,-1690 # ffffffffc0204e50 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	dc250513          	addi	a0,a0,-574 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	0ce68693          	addi	a3,a3,206 # ffffffffc02055d0 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	94660613          	addi	a2,a2,-1722 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	da250513          	addi	a0,a0,-606 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	0de68693          	addi	a3,a3,222 # ffffffffc0205600 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	92660613          	addi	a2,a2,-1754 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	d8250513          	addi	a0,a0,-638 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	08e68693          	addi	a3,a3,142 # ffffffffc02055d0 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	90660613          	addi	a2,a2,-1786 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	d6250513          	addi	a0,a0,-670 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	1c668693          	addi	a3,a3,454 # ffffffffc0205728 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	d4250513          	addi	a0,a0,-702 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	16e68693          	addi	a3,a3,366 # ffffffffc02056f0 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	d2250513          	addi	a0,a0,-734 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	13668693          	addi	a3,a3,310 # ffffffffc02056d8 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00003617          	auipc	a2,0x3
ffffffffc02025ae:	8a660613          	addi	a2,a2,-1882 # ffffffffc0204e50 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	d0250513          	addi	a0,a0,-766 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	07e68693          	addi	a3,a3,126 # ffffffffc0205640 <default_pmm_manager+0x440>
ffffffffc02025ca:	00003617          	auipc	a2,0x3
ffffffffc02025ce:	88660613          	addi	a2,a2,-1914 # ffffffffc0204e50 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	ce250513          	addi	a0,a0,-798 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	e9668693          	addi	a3,a3,-362 # ffffffffc0205478 <default_pmm_manager+0x278>
ffffffffc02025ea:	00003617          	auipc	a2,0x3
ffffffffc02025ee:	86660613          	addi	a2,a2,-1946 # ffffffffc0204e50 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	cc250513          	addi	a0,a0,-830 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	c8e60613          	addi	a2,a2,-882 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	caa50513          	addi	a0,a0,-854 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	e7668693          	addi	a3,a3,-394 # ffffffffc0205490 <default_pmm_manager+0x290>
ffffffffc0202622:	00003617          	auipc	a2,0x3
ffffffffc0202626:	82e60613          	addi	a2,a2,-2002 # ffffffffc0204e50 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	c8a50513          	addi	a0,a0,-886 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	ece68693          	addi	a3,a3,-306 # ffffffffc0205508 <default_pmm_manager+0x308>
ffffffffc0202642:	00003617          	auipc	a2,0x3
ffffffffc0202646:	80e60613          	addi	a2,a2,-2034 # ffffffffc0204e50 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	c6a50513          	addi	a0,a0,-918 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	18e68693          	addi	a3,a3,398 # ffffffffc02057e8 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	7ee60613          	addi	a2,a2,2030 # ffffffffc0204e50 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	c4a50513          	addi	a0,a0,-950 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	13668693          	addi	a3,a3,310 # ffffffffc02057b0 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	7ce60613          	addi	a2,a2,1998 # ffffffffc0204e50 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	c2a50513          	addi	a0,a0,-982 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	0e668693          	addi	a3,a3,230 # ffffffffc0205780 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	7ae60613          	addi	a2,a2,1966 # ffffffffc0204e50 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	c0a50513          	addi	a0,a0,-1014 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	11068693          	addi	a3,a3,272 # ffffffffc0205830 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	72860613          	addi	a2,a2,1832 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	b8450513          	addi	a0,a0,-1148 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc02027dc:	07068693          	addi	a3,a3,112 # ffffffffc0205848 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	67060613          	addi	a2,a2,1648 # ffffffffc0204e50 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	acc50513          	addi	a0,a0,-1332 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	a9660613          	addi	a2,a2,-1386 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	a5250513          	addi	a0,a0,-1454 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	05668693          	addi	a3,a3,86 # ffffffffc0205868 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	63660613          	addi	a2,a2,1590 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	a9250513          	addi	a0,a0,-1390 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0205350 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	98a50513          	addi	a0,a0,-1654 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	f9e68693          	addi	a3,a3,-98 # ffffffffc0205878 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	56e60613          	addi	a2,a2,1390 # ffffffffc0204e50 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	9ca50513          	addi	a0,a0,-1590 # ffffffffc02052b8 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	f4e68693          	addi	a3,a3,-178 # ffffffffc0205848 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	54e60613          	addi	a2,a2,1358 # ffffffffc0204e50 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	9aa50513          	addi	a0,a0,-1622 # ffffffffc02052b8 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	4d6010ef          	jal	ra,ffffffffc0203e0c <swapfs_init>
...
ffffffffc0202994:	f2850513          	addi	a0,a0,-216 # ffffffffc02058b8 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	ef050513          	addi	a0,a0,-272 # ffffffffc02058d0 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	3a9000ef          	jal	ra,ffffffffc0203594 <mm_create>
...
ffffffffc0202a20:	3bd000ef          	jal	ra,ffffffffc02035dc <vma_create>
...
ffffffffc0202a2c:	41f000ef          	jal	ra,ffffffffc020364a <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	f1050513          	addi	a0,a0,-240 # ffffffffc0205940 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	f4450513          	addi	a0,a0,-188 # ffffffffc0205990 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	f5850513          	addi	a0,a0,-168 # ffffffffc0205a18 <default_pmm_manager+0x818>
...
ffffffffc0202c10:	eb450513          	addi	a0,a0,-332 # ffffffffc0205ac0 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	2e5000ef          	jal	ra,ffffffffc020371a <mm_destroy>
...
ffffffffc0202c62:	e9250513          	addi	a0,a0,-366 # ffffffffc0205af0 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	ea650513          	addi	a0,a0,-346 # ffffffffc0205b10 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	1c468693          	addi	a3,a3,452 # ffffffffc0204e40 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	1cc60613          	addi	a2,a2,460 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202c8c:	0bb00593          	li	a1,187
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	c1850513          	addi	a0,a0,-1000 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	dfc68693          	addi	a3,a3,-516 # ffffffffc0205a98 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	1ac60613          	addi	a2,a2,428 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202cac:	0fb00593          	li	a1,251
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	bf850513          	addi	a0,a0,-1032 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	5ac60613          	addi	a2,a2,1452 # ffffffffc0205268 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	59050513          	addi	a0,a0,1424 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	56460613          	addi	a2,a2,1380 # ffffffffc0205238 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	57850513          	addi	a0,a0,1400 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	ce468693          	addi	a3,a3,-796 # ffffffffc02059d0 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	15c60613          	addi	a2,a2,348 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202cfc:	0dc00593          	li	a1,220
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	ba850513          	addi	a0,a0,-1112 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	cac68693          	addi	a3,a3,-852 # ffffffffc02059b8 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	13c60613          	addi	a2,a2,316 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202d1c:	0db00593          	li	a1,219
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	b8850513          	addi	a0,a0,-1144 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	b5c60613          	addi	a2,a2,-1188 # ffffffffc0205888 <default_pmm_manager+0x688>
ffffffffc0202d34:	02800593          	li	a1,40
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	b7050513          	addi	a0,a0,-1168 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	d3c68693          	addi	a3,a3,-708 # ffffffffc0205a80 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	10460613          	addi	a2,a2,260 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202d54:	0fa00593          	li	a1,250
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	b5050513          	addi	a0,a0,-1200 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	d0c68693          	addi	a3,a3,-756 # ffffffffc0205a70 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	0e460613          	addi	a2,a2,228 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202d74:	09e00593          	li	a1,158
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	b3050513          	addi	a0,a0,-1232 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	cec68693          	addi	a3,a3,-788 # ffffffffc0205a70 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	0c460613          	addi	a2,a2,196 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202d94:	0a000593          	li	a1,160
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	b1050513          	addi	a0,a0,-1264 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	28468693          	addi	a3,a3,644 # ffffffffc0205028 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	0a460613          	addi	a2,a2,164 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202db4:	0f200593          	li	a1,242
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	af050513          	addi	a0,a0,-1296 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	d2468693          	addi	a3,a3,-732 # ffffffffc0205ae8 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	08460613          	addi	a2,a2,132 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202dd4:	10100593          	li	a1,257
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	ad050513          	addi	a0,a0,-1328 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	b3c68693          	addi	a3,a3,-1220 # ffffffffc0205920 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	06460613          	addi	a2,a2,100 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202df4:	0cb00593          	li	a1,203
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	ab050513          	addi	a0,a0,-1360 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	b2c68693          	addi	a3,a3,-1236 # ffffffffc0205930 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	04460613          	addi	a2,a2,68 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202e14:	0ce00593          	li	a1,206
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	a9050513          	addi	a0,a0,-1392 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	b5468693          	addi	a3,a3,-1196 # ffffffffc0205978 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	02460613          	addi	a2,a2,36 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202e34:	0d600593          	li	a1,214
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	a7050513          	addi	a0,a0,-1424 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	03c68693          	addi	a3,a3,60 # ffffffffc0204e80 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	00460613          	addi	a2,a2,4 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202e54:	0be00593          	li	a1,190
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	a5050513          	addi	a0,a0,-1456 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	bec68693          	addi	a3,a3,-1044 # ffffffffc0205a50 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	fe460613          	addi	a2,a2,-28 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202e74:	09600593          	li	a1,150
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	a3050513          	addi	a0,a0,-1488 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	bcc68693          	addi	a3,a3,-1076 # ffffffffc0205a50 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	fc460613          	addi	a2,a2,-60 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202e94:	09800593          	li	a1,152
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	a1050513          	addi	a0,a0,-1520 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	bbc68693          	addi	a3,a3,-1092 # ffffffffc0205a60 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	fa460613          	addi	a2,a2,-92 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202eb4:	09a00593          	li	a1,154
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	9f050513          	addi	a0,a0,-1552 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	b9c68693          	addi	a3,a3,-1124 # ffffffffc0205a60 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	f8460613          	addi	a2,a2,-124 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202ed4:	09c00593          	li	a1,156
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	9d050513          	addi	a0,a0,-1584 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	b5c68693          	addi	a3,a3,-1188 # ffffffffc0205a40 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	f6460613          	addi	a2,a2,-156 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202ef4:	09200593          	li	a1,146
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	9b050513          	addi	a0,a0,-1616 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	b3c68693          	addi	a3,a3,-1220 # ffffffffc0205a40 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	f4460613          	addi	a2,a2,-188 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202f14:	09400593          	li	a1,148
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	99050513          	addi	a0,a0,-1648 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	9d468693          	addi	a3,a3,-1580 # ffffffffc02058f8 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	f2460613          	addi	a2,a2,-220 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202f34:	0c300593          	li	a1,195
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	97050513          	addi	a0,a0,-1680 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	9c468693          	addi	a3,a3,-1596 # ffffffffc0205908 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	f0460613          	addi	a2,a2,-252 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202f54:	0c600593          	li	a1,198
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	95050513          	addi	a0,a0,-1712 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	a8c68693          	addi	a3,a3,-1396 # ffffffffc02059f0 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	ee460613          	addi	a2,a2,-284 # ffffffffc0204e50 <commands+0x738>
ffffffffc0202f74:	0e900593          	li	a1,233
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	93050513          	addi	a0,a0,-1744 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	bccb0b13          	addi	s6,s6,-1076 # ffffffffc0205b90 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	bacb8b93          	addi	s7,s7,-1108 # ffffffffc0205b78 <default_pmm_manager+0x978>
...
ffffffffc0203040:	69f000ef          	jal	ra,ffffffffc0203ede <swapfs_write>
...
ffffffffc0203082:	ab250513          	addi	a0,a0,-1358 # ffffffffc0205b30 <default_pmm_manager+0x930>
...
ffffffffc0203094:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205b60 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	db860613          	addi	a2,a2,-584 # ffffffffc0204e50 <commands+0x738>
ffffffffc02030a0:	06700593          	li	a1,103
ffffffffc02030a4:	00003517          	auipc	a0,0x3
ffffffffc02030a8:	80450513          	addi	a0,a0,-2044 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	567000ef          	jal	ra,ffffffffc0203e44 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	af850513          	addi	a0,a0,-1288 # ffffffffc0205be0 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	ac668693          	addi	a3,a3,-1338 # ffffffffc0205bd0 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	d3e60613          	addi	a2,a2,-706 # ffffffffc0204e50 <commands+0x738>
ffffffffc020311a:	07d00593          	li	a1,125
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	78a50513          	addi	a0,a0,1930 # ffffffffc02058a8 <default_pmm_manager+0x6a8>
...
ffffffffc020312e:	fbe78793          	addi	a5,a5,-66 # ffffffffc02110e8 <pra_list_head2>
 *
 * 返回 0 表示初始化成功。
 */
...
ffffffffc020317e:	ace68693          	addi	a3,a3,-1330 # ffffffffc0205c48 <default_pmm_manager+0xa48>
ffffffffc0203182:	00002617          	auipc	a2,0x2
ffffffffc0203186:	cce60613          	addi	a2,a2,-818 # ffffffffc0204e50 <commands+0x738>
ffffffffc020318a:	04700593          	li	a1,71
ffffffffc020318e:	00003517          	auipc	a0,0x3
ffffffffc0203192:	aa250513          	addi	a0,a0,-1374 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc0203196:	9defd0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(head != NULL);
ffffffffc020319a:	00003697          	auipc	a3,0x3
ffffffffc020319e:	a8668693          	addi	a3,a3,-1402 # ffffffffc0205c20 <default_pmm_manager+0xa20>
ffffffffc02031a2:	00002617          	auipc	a2,0x2
ffffffffc02031a6:	cae60613          	addi	a2,a2,-850 # ffffffffc0204e50 <commands+0x738>
ffffffffc02031aa:	04600593          	li	a1,70
ffffffffc02031ae:	00003517          	auipc	a0,0x3
ffffffffc02031b2:	a8250513          	addi	a0,a0,-1406 # ffffffffc0205c30 <default_pmm_manager+0xa30>
...
ffffffffc02031d6:	a8668693          	addi	a3,a3,-1402 # ffffffffc0205c58 <default_pmm_manager+0xa58>
ffffffffc02031da:	00002617          	auipc	a2,0x2
ffffffffc02031de:	c7660613          	addi	a2,a2,-906 # ffffffffc0204e50 <commands+0x738>
ffffffffc02031e2:	03000593          	li	a1,48
ffffffffc02031e6:	00003517          	auipc	a0,0x3
ffffffffc02031ea:	a4a50513          	addi	a0,a0,-1462 # ffffffffc0205c30 <default_pmm_manager+0xa30>
                              struct Page *page, int swap_in) {
ffffffffc02031ee:	e406                	sd	ra,8(sp)
  assert(entry != NULL && head != NULL);
ffffffffc02031f0:	984fd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02031f4 <_lru_swap_access.part.0>:
static void _lru_swap_access(struct mm_struct *mm, uintptr_t addr) {
ffffffffc02031f4:	1141                	addi	sp,sp,-16
ffffffffc02031f6:	e022                	sd	s0,0(sp)
ffffffffc02031f8:	842a                	mv	s0,a0
    struct Page *p = get_page(mm->pgdir, addr, NULL);
ffffffffc02031fa:	6d08                	ld	a0,24(a0)
ffffffffc02031fc:	4601                	li	a2,0
static void _lru_swap_access(struct mm_struct *mm, uintptr_t addr) {
ffffffffc02031fe:	e406                	sd	ra,8(sp)
    struct Page *p = get_page(mm->pgdir, addr, NULL);
ffffffffc0203200:	ec2fe0ef          	jal	ra,ffffffffc02018c2 <get_page>
    list_entry_t *head = (list_entry_t *)mm->sm_priv;
ffffffffc0203204:	7414                	ld	a3,40(s0)
    if (head != NULL) {
ffffffffc0203206:	c285                	beqz	a3,ffffffffc0203226 <_lru_swap_access.part.0+0x32>
      list_entry_t *cur = head->next;
ffffffffc0203208:	669c                	ld	a5,8(a3)
      while (cur != head) {
ffffffffc020320a:	00f68e63          	beq	a3,a5,ffffffffc0203226 <_lru_swap_access.part.0+0x32>
        struct Page *page = le2page(cur, pra_page_link);
ffffffffc020320e:	fd078713          	addi	a4,a5,-48
        if (page == p) {
ffffffffc0203212:	00e51563          	bne	a0,a4,ffffffffc020321c <_lru_swap_access.part.0+0x28>
ffffffffc0203216:	a821                	j	ffffffffc020322e <_lru_swap_access.part.0+0x3a>
ffffffffc0203218:	00e50b63          	beq	a0,a4,ffffffffc020322e <_lru_swap_access.part.0+0x3a>
        cur = cur->next;
ffffffffc020321c:	679c                	ld	a5,8(a5)
        struct Page *page = le2page(cur, pra_page_link);
ffffffffc020321e:	fd078713          	addi	a4,a5,-48
      while (cur != head) {
ffffffffc0203222:	fef69be3          	bne	a3,a5,ffffffffc0203218 <_lru_swap_access.part.0+0x24>
}
ffffffffc0203226:	60a2                	ld	ra,8(sp)
ffffffffc0203228:	6402                	ld	s0,0(sp)
ffffffffc020322a:	0141                	addi	sp,sp,16
ffffffffc020322c:	8082                	ret
    __list_del(listelm->prev, listelm->next);
ffffffffc020322e:	638c                	ld	a1,0(a5)
ffffffffc0203230:	6790                	ld	a2,8(a5)
ffffffffc0203232:	60a2                	ld	ra,8(sp)
ffffffffc0203234:	6402                	ld	s0,0(sp)
    prev->next = next;
ffffffffc0203236:	e590                	sd	a2,8(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0203238:	6698                	ld	a4,8(a3)
    next->prev = prev;
ffffffffc020323a:	e20c                	sd	a1,0(a2)
    prev->next = next->prev = elm;
ffffffffc020323c:	e31c                	sd	a5,0(a4)
ffffffffc020323e:	e69c                	sd	a5,8(a3)
    elm->next = next;
ffffffffc0203240:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc0203242:	e394                	sd	a3,0(a5)
ffffffffc0203244:	0141                	addi	sp,sp,16
ffffffffc0203246:	8082                	ret

ffffffffc0203248 <_lru_check_swap>:
static int _lru_check_swap(void) {
ffffffffc0203248:	1101                	addi	sp,sp,-32
  cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc020324a:	00003517          	auipc	a0,0x3
ffffffffc020324e:	a2e50513          	addi	a0,a0,-1490 # ffffffffc0205c78 <default_pmm_manager+0xa78>
static int _lru_check_swap(void) {
ffffffffc0203252:	e822                	sd	s0,16(sp)
ffffffffc0203254:	ec06                	sd	ra,24(sp)
ffffffffc0203256:	e426                	sd	s1,8(sp)
  cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc0203258:	e63fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
  *(unsigned char *)0x4000 = 0x0d;
ffffffffc020325c:	6791                	lui	a5,0x4
ffffffffc020325e:	4735                	li	a4,13
ffffffffc0203260:	00e78023          	sb	a4,0(a5) # 4000 <kern_entry-0xffffffffc01fc000>
  _lru_swap_access(check_mm_struct, 0x4000);
ffffffffc0203264:	0000e417          	auipc	s0,0xe
ffffffffc0203268:	2f440413          	addi	s0,s0,756 # ffffffffc0211558 <check_mm_struct>
ffffffffc020326c:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc020326e:	c501                	beqz	a0,ffffffffc0203276 <_lru_check_swap+0x2e>
ffffffffc0203270:	6591                	lui	a1,0x4
ffffffffc0203272:	f83ff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 4);
ffffffffc0203276:	0000e717          	auipc	a4,0xe
ffffffffc020327a:	2ea72703          	lw	a4,746(a4) # ffffffffc0211560 <pgfault_num>
ffffffffc020327e:	4791                	li	a5,4
ffffffffc0203280:	0000e497          	auipc	s1,0xe
ffffffffc0203284:	2e048493          	addi	s1,s1,736 # ffffffffc0211560 <pgfault_num>
ffffffffc0203288:	16f71463          	bne	a4,a5,ffffffffc02033f0 <_lru_check_swap+0x1a8>
  cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc020328c:	00003517          	auipc	a0,0x3
ffffffffc0203290:	a2c50513          	addi	a0,a0,-1492 # ffffffffc0205cb8 <default_pmm_manager+0xab8>
ffffffffc0203294:	e27fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
  *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203298:	678d                	lui	a5,0x3
ffffffffc020329a:	4731                	li	a4,12
ffffffffc020329c:	00e78023          	sb	a4,0(a5) # 3000 <kern_entry-0xffffffffc01fd000>
  _lru_swap_access(check_mm_struct, 0x3000);
ffffffffc02032a0:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc02032a2:	c501                	beqz	a0,ffffffffc02032aa <_lru_check_swap+0x62>
ffffffffc02032a4:	658d                	lui	a1,0x3
ffffffffc02032a6:	f4fff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 4);
ffffffffc02032aa:	409c                	lw	a5,0(s1)
ffffffffc02032ac:	4711                	li	a4,4
ffffffffc02032ae:	2781                	sext.w	a5,a5
ffffffffc02032b0:	2ae79063          	bne	a5,a4,ffffffffc0203550 <_lru_check_swap+0x308>
  cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc02032b4:	00003517          	auipc	a0,0x3
ffffffffc02032b8:	9c450513          	addi	a0,a0,-1596 # ffffffffc0205c78 <default_pmm_manager+0xa78>
ffffffffc02032bc:	dfffc0ef          	jal	ra,ffffffffc02000ba <cprintf>
  *(unsigned char *)0x2000 = 0x0b;
ffffffffc02032c0:	6789                	lui	a5,0x2
ffffffffc02032c2:	472d                	li	a4,11
ffffffffc02032c4:	00e78023          	sb	a4,0(a5) # 2000 <kern_entry-0xffffffffc01fe000>
  _lru_swap_access(check_mm_struct, 0x2000);
ffffffffc02032c8:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc02032ca:	c501                	beqz	a0,ffffffffc02032d2 <_lru_check_swap+0x8a>
ffffffffc02032cc:	6589                	lui	a1,0x2
ffffffffc02032ce:	f27ff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 4);
ffffffffc02032d2:	409c                	lw	a5,0(s1)
ffffffffc02032d4:	4711                	li	a4,4
ffffffffc02032d6:	2781                	sext.w	a5,a5
ffffffffc02032d8:	24e79c63          	bne	a5,a4,ffffffffc0203530 <_lru_check_swap+0x2e8>
  cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc02032dc:	00003517          	auipc	a0,0x3
ffffffffc02032e0:	a0450513          	addi	a0,a0,-1532 # ffffffffc0205ce0 <default_pmm_manager+0xae0>
ffffffffc02032e4:	dd7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
  *(unsigned char *)0x1000 = 0x0a;
ffffffffc02032e8:	6785                	lui	a5,0x1
ffffffffc02032ea:	4729                	li	a4,10
ffffffffc02032ec:	00e78023          	sb	a4,0(a5) # 1000 <kern_entry-0xffffffffc01ff000>
  _lru_swap_access(check_mm_struct, 0x1000);
ffffffffc02032f0:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc02032f2:	c501                	beqz	a0,ffffffffc02032fa <_lru_check_swap+0xb2>
ffffffffc02032f4:	6585                	lui	a1,0x1
ffffffffc02032f6:	effff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 4);
ffffffffc02032fa:	409c                	lw	a5,0(s1)
ffffffffc02032fc:	4711                	li	a4,4
ffffffffc02032fe:	2781                	sext.w	a5,a5
ffffffffc0203300:	20e79863          	bne	a5,a4,ffffffffc0203510 <_lru_check_swap+0x2c8>
  *(unsigned char *)0x5000 = 0x0e;
ffffffffc0203304:	6795                	lui	a5,0x5
ffffffffc0203306:	4739                	li	a4,14
ffffffffc0203308:	00e78023          	sb	a4,0(a5) # 5000 <kern_entry-0xffffffffc01fb000>
  _lru_swap_access(check_mm_struct, 0x5000);
ffffffffc020330c:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc020330e:	c501                	beqz	a0,ffffffffc0203316 <_lru_check_swap+0xce>
ffffffffc0203310:	6595                	lui	a1,0x5
ffffffffc0203312:	ee3ff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 5);
ffffffffc0203316:	409c                	lw	a5,0(s1)
ffffffffc0203318:	4715                	li	a4,5
ffffffffc020331a:	2781                	sext.w	a5,a5
ffffffffc020331c:	1ce79a63          	bne	a5,a4,ffffffffc02034f0 <_lru_check_swap+0x2a8>
  *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203320:	6785                	lui	a5,0x1
ffffffffc0203322:	4729                	li	a4,10
ffffffffc0203324:	00e78023          	sb	a4,0(a5) # 1000 <kern_entry-0xffffffffc01ff000>
  _lru_swap_access(check_mm_struct, 0x1000);
ffffffffc0203328:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc020332a:	c501                	beqz	a0,ffffffffc0203332 <_lru_check_swap+0xea>
ffffffffc020332c:	6585                	lui	a1,0x1
ffffffffc020332e:	ec7ff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 5);
ffffffffc0203332:	409c                	lw	a5,0(s1)
ffffffffc0203334:	4715                	li	a4,5
ffffffffc0203336:	2781                	sext.w	a5,a5
ffffffffc0203338:	18e79c63          	bne	a5,a4,ffffffffc02034d0 <_lru_check_swap+0x288>
  *(unsigned char *)0x3000 = 0x0c;
ffffffffc020333c:	678d                	lui	a5,0x3
ffffffffc020333e:	4731                	li	a4,12
ffffffffc0203340:	00e78023          	sb	a4,0(a5) # 3000 <kern_entry-0xffffffffc01fd000>
  _lru_swap_access(check_mm_struct, 0x3000);
ffffffffc0203344:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc0203346:	c501                	beqz	a0,ffffffffc020334e <_lru_check_swap+0x106>
ffffffffc0203348:	658d                	lui	a1,0x3
ffffffffc020334a:	eabff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 5);
ffffffffc020334e:	409c                	lw	a5,0(s1)
ffffffffc0203350:	4715                	li	a4,5
ffffffffc0203352:	2781                	sext.w	a5,a5
ffffffffc0203354:	14e79e63          	bne	a5,a4,ffffffffc02034b0 <_lru_check_swap+0x268>
  *(unsigned char *)0x4000 = 0x0d;
ffffffffc0203358:	6791                	lui	a5,0x4
ffffffffc020335a:	4735                	li	a4,13
ffffffffc020335c:	00e78023          	sb	a4,0(a5) # 4000 <kern_entry-0xffffffffc01fc000>
  _lru_swap_access(check_mm_struct, 0x4000);
ffffffffc0203360:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc0203362:	c501                	beqz	a0,ffffffffc020336a <_lru_check_swap+0x122>
ffffffffc0203364:	6591                	lui	a1,0x4
ffffffffc0203366:	e8fff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 6);
ffffffffc020336a:	409c                	lw	a5,0(s1)
ffffffffc020336c:	4719                	li	a4,6
ffffffffc020336e:	2781                	sext.w	a5,a5
ffffffffc0203370:	12e79063          	bne	a5,a4,ffffffffc0203490 <_lru_check_swap+0x248>
  *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203374:	6789                	lui	a5,0x2
ffffffffc0203376:	472d                	li	a4,11
ffffffffc0203378:	00e78023          	sb	a4,0(a5) # 2000 <kern_entry-0xffffffffc01fe000>
  _lru_swap_access(check_mm_struct, 0x2000);
ffffffffc020337c:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc020337e:	c501                	beqz	a0,ffffffffc0203386 <_lru_check_swap+0x13e>
ffffffffc0203380:	6589                	lui	a1,0x2
ffffffffc0203382:	e73ff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 7);
ffffffffc0203386:	409c                	lw	a5,0(s1)
ffffffffc0203388:	471d                	li	a4,7
ffffffffc020338a:	2781                	sext.w	a5,a5
ffffffffc020338c:	0ee79263          	bne	a5,a4,ffffffffc0203470 <_lru_check_swap+0x228>
  *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203390:	678d                	lui	a5,0x3
ffffffffc0203392:	4731                	li	a4,12
ffffffffc0203394:	00e78023          	sb	a4,0(a5) # 3000 <kern_entry-0xffffffffc01fd000>
  _lru_swap_access(check_mm_struct, 0x3000);
ffffffffc0203398:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc020339a:	c501                	beqz	a0,ffffffffc02033a2 <_lru_check_swap+0x15a>
ffffffffc020339c:	658d                	lui	a1,0x3
ffffffffc020339e:	e57ff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 7);
ffffffffc02033a2:	409c                	lw	a5,0(s1)
ffffffffc02033a4:	471d                	li	a4,7
ffffffffc02033a6:	2781                	sext.w	a5,a5
ffffffffc02033a8:	0ae79463          	bne	a5,a4,ffffffffc0203450 <_lru_check_swap+0x208>
  *(unsigned char *)0x5000 = 0x0e;
...
ffffffffc02033b0:	00e78023          	sb	a4,0(a5) # 5000 <kern_entry-0xffffffffc01fb000>
  _lru_swap_access(check_mm_struct, 0x5000);
ffffffffc02033b4:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc02033b6:	c501                	beqz	a0,ffffffffc02033be <_lru_check_swap+0x176>
ffffffffc02033b8:	6595                	lui	a1,0x5
ffffffffc02033ba:	e3bff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 8);
ffffffffc02033be:	409c                	lw	a5,0(s1)
ffffffffc02033c0:	4721                	li	a4,8
ffffffffc02033c2:	2781                	sext.w	a5,a5
ffffffffc02033c4:	06e79663          	bne	a5,a4,ffffffffc0203430 <_lru_check_swap+0x1e8>
  *(unsigned char *)0x1000 = 0x0a;
ffffffffc02033c8:	6785                	lui	a5,0x1
ffffffffc02033ca:	4729                	li	a4,10
ffffffffc02033cc:	00e78023          	sb	a4,0(a5) # 1000 <kern_entry-0xffffffffc01ff000>
  _lru_swap_access(check_mm_struct, 0x1000);
ffffffffc02033d0:	6008                	ld	a0,0(s0)
  if (mm != NULL) {
ffffffffc02033d2:	c501                	beqz	a0,ffffffffc02033da <_lru_check_swap+0x192>
ffffffffc02033d4:	6585                	lui	a1,0x1
ffffffffc02033d6:	e1fff0ef          	jal	ra,ffffffffc02031f4 <_lru_swap_access.part.0>
  assert(pgfault_num == 9);
ffffffffc02033da:	409c                	lw	a5,0(s1)
ffffffffc02033dc:	4725                	li	a4,9
ffffffffc02033de:	2781                	sext.w	a5,a5
ffffffffc02033e0:	02e79863          	bne	a5,a4,ffffffffc0203410 <_lru_check_swap+0x1c8>
}
ffffffffc02033e4:	60e2                	ld	ra,24(sp)
ffffffffc02033e6:	6442                	ld	s0,16(sp)
ffffffffc02033e8:	64a2                	ld	s1,8(sp)
ffffffffc02033ea:	4501                	li	a0,0
ffffffffc02033ec:	6105                	addi	sp,sp,32
ffffffffc02033ee:	8082                	ret
  assert(pgfault_num == 4);
ffffffffc02033f0:	00003697          	auipc	a3,0x3
ffffffffc02033f4:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205ca0 <default_pmm_manager+0xaa0>
ffffffffc02033f8:	00002617          	auipc	a2,0x2
ffffffffc02033fc:	a5860613          	addi	a2,a2,-1448 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203400:	06b00593          	li	a1,107
ffffffffc0203404:	00003517          	auipc	a0,0x3
ffffffffc0203408:	82c50513          	addi	a0,a0,-2004 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020340c:	f69fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 9);
ffffffffc0203410:	00003697          	auipc	a3,0x3
ffffffffc0203414:	95868693          	addi	a3,a3,-1704 # ffffffffc0205d68 <default_pmm_manager+0xb68>
ffffffffc0203418:	00002617          	auipc	a2,0x2
ffffffffc020341c:	a3860613          	addi	a2,a2,-1480 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203420:	0a200593          	li	a1,162
ffffffffc0203424:	00003517          	auipc	a0,0x3
ffffffffc0203428:	80c50513          	addi	a0,a0,-2036 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020342c:	f49fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 8);
ffffffffc0203430:	00003697          	auipc	a3,0x3
ffffffffc0203434:	92068693          	addi	a3,a3,-1760 # ffffffffc0205d50 <default_pmm_manager+0xb50>
ffffffffc0203438:	00002617          	auipc	a2,0x2
ffffffffc020343c:	a1860613          	addi	a2,a2,-1512 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203440:	09d00593          	li	a1,157
ffffffffc0203444:	00002517          	auipc	a0,0x2
ffffffffc0203448:	7ec50513          	addi	a0,a0,2028 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020344c:	f29fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 7);
ffffffffc0203450:	00003697          	auipc	a3,0x3
ffffffffc0203454:	8e868693          	addi	a3,a3,-1816 # ffffffffc0205d38 <default_pmm_manager+0xb38>
ffffffffc0203458:	00002617          	auipc	a2,0x2
ffffffffc020345c:	9f860613          	addi	a2,a2,-1544 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203460:	09800593          	li	a1,152
ffffffffc0203464:	00002517          	auipc	a0,0x2
ffffffffc0203468:	7cc50513          	addi	a0,a0,1996 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020346c:	f09fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 7);
ffffffffc0203470:	00003697          	auipc	a3,0x3
ffffffffc0203474:	8c868693          	addi	a3,a3,-1848 # ffffffffc0205d38 <default_pmm_manager+0xb38>
ffffffffc0203478:	00002617          	auipc	a2,0x2
ffffffffc020347c:	9d860613          	addi	a2,a2,-1576 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203480:	09300593          	li	a1,147
ffffffffc0203484:	00002517          	auipc	a0,0x2
ffffffffc0203488:	7ac50513          	addi	a0,a0,1964 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020348c:	ee9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 6);
ffffffffc0203490:	00003697          	auipc	a3,0x3
ffffffffc0203494:	89068693          	addi	a3,a3,-1904 # ffffffffc0205d20 <default_pmm_manager+0xb20>
ffffffffc0203498:	00002617          	auipc	a2,0x2
ffffffffc020349c:	9b860613          	addi	a2,a2,-1608 # ffffffffc0204e50 <commands+0x738>
ffffffffc02034a0:	08e00593          	li	a1,142
ffffffffc02034a4:	00002517          	auipc	a0,0x2
ffffffffc02034a8:	78c50513          	addi	a0,a0,1932 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc02034ac:	ec9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 5);
ffffffffc02034b0:	00003697          	auipc	a3,0x3
ffffffffc02034b4:	85868693          	addi	a3,a3,-1960 # ffffffffc0205d08 <default_pmm_manager+0xb08>
ffffffffc02034b8:	00002617          	auipc	a2,0x2
ffffffffc02034bc:	99860613          	addi	a2,a2,-1640 # ffffffffc0204e50 <commands+0x738>
ffffffffc02034c0:	08900593          	li	a1,137
ffffffffc02034c4:	00002517          	auipc	a0,0x2
ffffffffc02034c8:	76c50513          	addi	a0,a0,1900 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc02034cc:	ea9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 5);
ffffffffc02034d0:	00003697          	auipc	a3,0x3
ffffffffc02034d4:	83868693          	addi	a3,a3,-1992 # ffffffffc0205d08 <default_pmm_manager+0xb08>
ffffffffc02034d8:	00002617          	auipc	a2,0x2
ffffffffc02034dc:	97860613          	addi	a2,a2,-1672 # ffffffffc0204e50 <commands+0x738>
ffffffffc02034e0:	08400593          	li	a1,132
ffffffffc02034e4:	00002517          	auipc	a0,0x2
ffffffffc02034e8:	74c50513          	addi	a0,a0,1868 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc02034ec:	e89fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 5);
ffffffffc02034f0:	00003697          	auipc	a3,0x3
ffffffffc02034f4:	81868693          	addi	a3,a3,-2024 # ffffffffc0205d08 <default_pmm_manager+0xb08>
ffffffffc02034f8:	00002617          	auipc	a2,0x2
ffffffffc02034fc:	95860613          	addi	a2,a2,-1704 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203500:	07f00593          	li	a1,127
ffffffffc0203504:	00002517          	auipc	a0,0x2
ffffffffc0203508:	72c50513          	addi	a0,a0,1836 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020350c:	e69fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 4);
ffffffffc0203510:	00002697          	auipc	a3,0x2
ffffffffc0203514:	79068693          	addi	a3,a3,1936 # ffffffffc0205ca0 <default_pmm_manager+0xaa0>
ffffffffc0203518:	00002617          	auipc	a2,0x2
ffffffffc020351c:	93860613          	addi	a2,a2,-1736 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203520:	07a00593          	li	a1,122
ffffffffc0203524:	00002517          	auipc	a0,0x2
ffffffffc0203528:	70c50513          	addi	a0,a0,1804 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020352c:	e49fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 4);
ffffffffc0203530:	00002697          	auipc	a3,0x2
ffffffffc0203534:	77068693          	addi	a3,a3,1904 # ffffffffc0205ca0 <default_pmm_manager+0xaa0>
ffffffffc0203538:	00002617          	auipc	a2,0x2
ffffffffc020353c:	91860613          	addi	a2,a2,-1768 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203540:	07500593          	li	a1,117
ffffffffc0203544:	00002517          	auipc	a0,0x2
ffffffffc0203548:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205c30 <default_pmm_manager+0xa30>
ffffffffc020354c:	e29fc0ef          	jal	ra,ffffffffc0200374 <__panic>
  assert(pgfault_num == 4);
ffffffffc0203550:	00002697          	auipc	a3,0x2
ffffffffc0203554:	75068693          	addi	a3,a3,1872 # ffffffffc0205ca0 <default_pmm_manager+0xaa0>
ffffffffc0203558:	00002617          	auipc	a2,0x2
ffffffffc020355c:	8f860613          	addi	a2,a2,-1800 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203560:	07000593          	li	a1,112
ffffffffc0203564:	00002517          	auipc	a0,0x2
ffffffffc0203568:	6cc50513          	addi	a0,a0,1740 # ffffffffc0205c30 <default_pmm_manager+0xa30>
...
ffffffffc0203576:	82668693          	addi	a3,a3,-2010 # ffffffffc0205d98 <default_pmm_manager+0xb98>
ffffffffc020357a:	00002617          	auipc	a2,0x2
ffffffffc020357e:	8d660613          	addi	a2,a2,-1834 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203582:	07d00593          	li	a1,125
ffffffffc0203586:	00003517          	auipc	a0,0x3
ffffffffc020358a:	83250513          	addi	a0,a0,-1998 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc020358e:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203590:	de5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203594 <mm_create>:
mm_create(void) {
ffffffffc0203594:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203596:	03000513          	li	a0,48
mm_create(void) {
ffffffffc020359a:	e022                	sd	s0,0(sp)
ffffffffc020359c:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020359e:	9daff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02035a2:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02035a4:	c105                	beqz	a0,ffffffffc02035c4 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02035a6:	e408                	sd	a0,8(s0)
ffffffffc02035a8:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02035aa:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02035ae:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02035b2:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02035b6:	0000e797          	auipc	a5,0xe
ffffffffc02035ba:	f9a7a783          	lw	a5,-102(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02035be:	eb81                	bnez	a5,ffffffffc02035ce <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02035c0:	02053423          	sd	zero,40(a0)
}
ffffffffc02035c4:	60a2                	ld	ra,8(sp)
ffffffffc02035c6:	8522                	mv	a0,s0
ffffffffc02035c8:	6402                	ld	s0,0(sp)
ffffffffc02035ca:	0141                	addi	sp,sp,16
ffffffffc02035cc:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02035ce:	9b7ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc02035d2:	60a2                	ld	ra,8(sp)
ffffffffc02035d4:	8522                	mv	a0,s0
ffffffffc02035d6:	6402                	ld	s0,0(sp)
ffffffffc02035d8:	0141                	addi	sp,sp,16
ffffffffc02035da:	8082                	ret

ffffffffc02035dc <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02035dc:	1101                	addi	sp,sp,-32
ffffffffc02035de:	e04a                	sd	s2,0(sp)
ffffffffc02035e0:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035e2:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02035e6:	e822                	sd	s0,16(sp)
ffffffffc02035e8:	e426                	sd	s1,8(sp)
ffffffffc02035ea:	ec06                	sd	ra,24(sp)
ffffffffc02035ec:	84ae                	mv	s1,a1
ffffffffc02035ee:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035f0:	988ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc02035f4:	c509                	beqz	a0,ffffffffc02035fe <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02035f6:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035fa:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035fc:	ed00                	sd	s0,24(a0)
}
ffffffffc02035fe:	60e2                	ld	ra,24(sp)
ffffffffc0203600:	6442                	ld	s0,16(sp)
ffffffffc0203602:	64a2                	ld	s1,8(sp)
ffffffffc0203604:	6902                	ld	s2,0(sp)
ffffffffc0203606:	6105                	addi	sp,sp,32
ffffffffc0203608:	8082                	ret

ffffffffc020360a <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc020360a:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc020360c:	c505                	beqz	a0,ffffffffc0203634 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc020360e:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203610:	c501                	beqz	a0,ffffffffc0203618 <find_vma+0xe>
ffffffffc0203612:	651c                	ld	a5,8(a0)
ffffffffc0203614:	02f5f263          	bgeu	a1,a5,ffffffffc0203638 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203618:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc020361a:	00f68d63          	beq	a3,a5,ffffffffc0203634 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020361e:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203622:	00e5e663          	bltu	a1,a4,ffffffffc020362e <find_vma+0x24>
ffffffffc0203626:	ff07b703          	ld	a4,-16(a5)
ffffffffc020362a:	00e5ec63          	bltu	a1,a4,ffffffffc0203642 <find_vma+0x38>
ffffffffc020362e:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203630:	fef697e3          	bne	a3,a5,ffffffffc020361e <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203634:	4501                	li	a0,0
}
ffffffffc0203636:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203638:	691c                	ld	a5,16(a0)
ffffffffc020363a:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203618 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020363e:	ea88                	sd	a0,16(a3)
ffffffffc0203640:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203642:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203646:	ea88                	sd	a0,16(a3)
ffffffffc0203648:	8082                	ret

ffffffffc020364a <insert_vma_struct>:
...
ffffffffc020364a:	6590                	ld	a2,8(a1)
ffffffffc020364c:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203650:	1141                	addi	sp,sp,-16
ffffffffc0203652:	e406                	sd	ra,8(sp)
ffffffffc0203654:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203656:	01066763          	bltu	a2,a6,ffffffffc0203664 <insert_vma_struct+0x1a>
ffffffffc020365a:	a085                	j	ffffffffc02036ba <insert_vma_struct+0x70>
...
ffffffffc0203660:	04e66863          	bltu	a2,a4,ffffffffc02036b0 <insert_vma_struct+0x66>
ffffffffc0203664:	86be                	mv	a3,a5
ffffffffc0203666:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0203668:	fef51ae3          	bne	a0,a5,ffffffffc020365c <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc020366c:	02a68463          	beq	a3,a0,ffffffffc0203694 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc0203670:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203674:	fe86b883          	ld	a7,-24(a3)
ffffffffc0203678:	08e8f163          	bgeu	a7,a4,ffffffffc02036fa <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020367c:	04e66f63          	bltu	a2,a4,ffffffffc02036da <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc0203680:	00f50a63          	beq	a0,a5,ffffffffc0203694 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203684:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203688:	05076963          	bltu	a4,a6,ffffffffc02036da <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc020368c:	ff07b603          	ld	a2,-16(a5)
ffffffffc0203690:	02c77363          	bgeu	a4,a2,ffffffffc02036b6 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203694:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc0203696:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203698:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc020369c:	e390                	sd	a2,0(a5)
ffffffffc020369e:	e690                	sd	a2,8(a3)
}
ffffffffc02036a0:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02036a2:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02036a4:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02036a6:	0017079b          	addiw	a5,a4,1
ffffffffc02036aa:	d11c                	sw	a5,32(a0)
}
ffffffffc02036ac:	0141                	addi	sp,sp,16
ffffffffc02036ae:	8082                	ret
    if (le_prev != list) {
ffffffffc02036b0:	fca690e3          	bne	a3,a0,ffffffffc0203670 <insert_vma_struct+0x26>
ffffffffc02036b4:	bfd1                	j	ffffffffc0203688 <insert_vma_struct+0x3e>
ffffffffc02036b6:	ebbff0ef          	jal	ra,ffffffffc0203570 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02036ba:	00002697          	auipc	a3,0x2
ffffffffc02036be:	70e68693          	addi	a3,a3,1806 # ffffffffc0205dc8 <default_pmm_manager+0xbc8>
ffffffffc02036c2:	00001617          	auipc	a2,0x1
ffffffffc02036c6:	78e60613          	addi	a2,a2,1934 # ffffffffc0204e50 <commands+0x738>
ffffffffc02036ca:	08400593          	li	a1,132
ffffffffc02036ce:	00002517          	auipc	a0,0x2
ffffffffc02036d2:	6ea50513          	addi	a0,a0,1770 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc02036d6:	c9ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02036da:	00002697          	auipc	a3,0x2
ffffffffc02036de:	72e68693          	addi	a3,a3,1838 # ffffffffc0205e08 <default_pmm_manager+0xc08>
ffffffffc02036e2:	00001617          	auipc	a2,0x1
ffffffffc02036e6:	76e60613          	addi	a2,a2,1902 # ffffffffc0204e50 <commands+0x738>
ffffffffc02036ea:	07c00593          	li	a1,124
ffffffffc02036ee:	00002517          	auipc	a0,0x2
ffffffffc02036f2:	6ca50513          	addi	a0,a0,1738 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc02036f6:	c7ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02036fa:	00002697          	auipc	a3,0x2
ffffffffc02036fe:	6ee68693          	addi	a3,a3,1774 # ffffffffc0205de8 <default_pmm_manager+0xbe8>
ffffffffc0203702:	00001617          	auipc	a2,0x1
ffffffffc0203706:	74e60613          	addi	a2,a2,1870 # ffffffffc0204e50 <commands+0x738>
ffffffffc020370a:	07b00593          	li	a1,123
ffffffffc020370e:	00002517          	auipc	a0,0x2
ffffffffc0203712:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203716:	c5ffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020371a <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc020371a:	1141                	addi	sp,sp,-16
ffffffffc020371c:	e022                	sd	s0,0(sp)
ffffffffc020371e:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203720:	6508                	ld	a0,8(a0)
ffffffffc0203722:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203724:	00a40e63          	beq	s0,a0,ffffffffc0203740 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203728:	6118                	ld	a4,0(a0)
ffffffffc020372a:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020372c:	03000593          	li	a1,48
ffffffffc0203730:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203732:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203734:	e398                	sd	a4,0(a5)
ffffffffc0203736:	8fcff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020373a:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020373c:	fea416e3          	bne	s0,a0,ffffffffc0203728 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203740:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203742:	6402                	ld	s0,0(sp)
ffffffffc0203744:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203746:	03000593          	li	a1,48
}
ffffffffc020374a:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020374c:	8e6ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203750 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203750:	715d                	addi	sp,sp,-80
ffffffffc0203752:	e486                	sd	ra,72(sp)
ffffffffc0203754:	f44e                	sd	s3,40(sp)
ffffffffc0203756:	f052                	sd	s4,32(sp)
ffffffffc0203758:	e0a2                	sd	s0,64(sp)
ffffffffc020375a:	fc26                	sd	s1,56(sp)
ffffffffc020375c:	f84a                	sd	s2,48(sp)
ffffffffc020375e:	ec56                	sd	s5,24(sp)
ffffffffc0203760:	e85a                	sd	s6,16(sp)
ffffffffc0203762:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203764:	f2ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020376a:	f29fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020376e:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203770:	03000513          	li	a0,48
ffffffffc0203774:	804ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc0203778:	56050863          	beqz	a0,ffffffffc0203ce8 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc020377c:	e508                	sd	a0,8(a0)
ffffffffc020377e:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203780:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203784:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203788:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020378c:	0000e797          	auipc	a5,0xe
ffffffffc0203790:	dc47a783          	lw	a5,-572(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203794:	84aa                	mv	s1,a0
ffffffffc0203796:	e7b9                	bnez	a5,ffffffffc02037e4 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc0203798:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc020379c:	03200413          	li	s0,50
ffffffffc02037a0:	a811                	j	ffffffffc02037b4 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02037a2:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037a4:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037a6:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02037aa:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02037ac:	8526                	mv	a0,s1
ffffffffc02037ae:	e9dff0ef          	jal	ra,ffffffffc020364a <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02037b2:	cc05                	beqz	s0,ffffffffc02037ea <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02037b4:	03000513          	li	a0,48
ffffffffc02037b8:	fc1fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02037bc:	85aa                	mv	a1,a0
ffffffffc02037be:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037c2:	f165                	bnez	a0,ffffffffc02037a2 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02037c4:	00002697          	auipc	a3,0x2
ffffffffc02037c8:	16c68693          	addi	a3,a3,364 # ffffffffc0205930 <default_pmm_manager+0x730>
ffffffffc02037cc:	00001617          	auipc	a2,0x1
ffffffffc02037d0:	68460613          	addi	a2,a2,1668 # ffffffffc0204e50 <commands+0x738>
ffffffffc02037d4:	0ce00593          	li	a1,206
ffffffffc02037d8:	00002517          	auipc	a0,0x2
ffffffffc02037dc:	5e050513          	addi	a0,a0,1504 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc02037e0:	b95fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02037e4:	fa0ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02037e8:	bf55                	j	ffffffffc020379c <vmm_init+0x4c>
ffffffffc02037ea:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037ee:	1f900913          	li	s2,505
ffffffffc02037f2:	a819                	j	ffffffffc0203808 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc02037f4:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037f6:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037f8:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037fc:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02037fe:	8526                	mv	a0,s1
ffffffffc0203800:	e4bff0ef          	jal	ra,ffffffffc020364a <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203804:	03240a63          	beq	s0,s2,ffffffffc0203838 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203808:	03000513          	li	a0,48
ffffffffc020380c:	f6dfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203810:	85aa                	mv	a1,a0
ffffffffc0203812:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203816:	fd79                	bnez	a0,ffffffffc02037f4 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203818:	00002697          	auipc	a3,0x2
ffffffffc020381c:	11868693          	addi	a3,a3,280 # ffffffffc0205930 <default_pmm_manager+0x730>
ffffffffc0203820:	00001617          	auipc	a2,0x1
ffffffffc0203824:	63060613          	addi	a2,a2,1584 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203828:	0d400593          	li	a1,212
ffffffffc020382c:	00002517          	auipc	a0,0x2
ffffffffc0203830:	58c50513          	addi	a0,a0,1420 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203834:	b41fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203838:	649c                	ld	a5,8(s1)
ffffffffc020383a:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020383c:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203840:	2ef48463          	beq	s1,a5,ffffffffc0203b28 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203844:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203848:	ffe70693          	addi	a3,a4,-2
ffffffffc020384c:	26d61e63          	bne	a2,a3,ffffffffc0203ac8 <vmm_init+0x378>
ffffffffc0203850:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203854:	26e69a63          	bne	a3,a4,ffffffffc0203ac8 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203858:	0715                	addi	a4,a4,5
ffffffffc020385a:	679c                	ld	a5,8(a5)
ffffffffc020385c:	feb712e3          	bne	a4,a1,ffffffffc0203840 <vmm_init+0xf0>
ffffffffc0203860:	4b1d                	li	s6,7
ffffffffc0203862:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203864:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203868:	85a2                	mv	a1,s0
ffffffffc020386a:	8526                	mv	a0,s1
ffffffffc020386c:	d9fff0ef          	jal	ra,ffffffffc020360a <find_vma>
ffffffffc0203870:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203872:	2c050b63          	beqz	a0,ffffffffc0203b48 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203876:	00140593          	addi	a1,s0,1
ffffffffc020387a:	8526                	mv	a0,s1
ffffffffc020387c:	d8fff0ef          	jal	ra,ffffffffc020360a <find_vma>
ffffffffc0203880:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203882:	2e050363          	beqz	a0,ffffffffc0203b68 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203886:	85da                	mv	a1,s6
ffffffffc0203888:	8526                	mv	a0,s1
ffffffffc020388a:	d81ff0ef          	jal	ra,ffffffffc020360a <find_vma>
        assert(vma3 == NULL);
ffffffffc020388e:	2e051d63          	bnez	a0,ffffffffc0203b88 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203892:	00340593          	addi	a1,s0,3
ffffffffc0203896:	8526                	mv	a0,s1
ffffffffc0203898:	d73ff0ef          	jal	ra,ffffffffc020360a <find_vma>
        assert(vma4 == NULL);
ffffffffc020389c:	30051663          	bnez	a0,ffffffffc0203ba8 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02038a0:	00440593          	addi	a1,s0,4
ffffffffc02038a4:	8526                	mv	a0,s1
ffffffffc02038a6:	d65ff0ef          	jal	ra,ffffffffc020360a <find_vma>
        assert(vma5 == NULL);
ffffffffc02038aa:	30051f63          	bnez	a0,ffffffffc0203bc8 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02038ae:	00893783          	ld	a5,8(s2)
ffffffffc02038b2:	24879b63          	bne	a5,s0,ffffffffc0203b08 <vmm_init+0x3b8>
ffffffffc02038b6:	01093783          	ld	a5,16(s2)
ffffffffc02038ba:	25679763          	bne	a5,s6,ffffffffc0203b08 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038be:	008ab783          	ld	a5,8(s5)
ffffffffc02038c2:	22879363          	bne	a5,s0,ffffffffc0203ae8 <vmm_init+0x398>
ffffffffc02038c6:	010ab783          	ld	a5,16(s5)
ffffffffc02038ca:	21679f63          	bne	a5,s6,ffffffffc0203ae8 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02038ce:	0415                	addi	s0,s0,5
ffffffffc02038d0:	0b15                	addi	s6,s6,5
ffffffffc02038d2:	f9741be3          	bne	s0,s7,ffffffffc0203868 <vmm_init+0x118>
ffffffffc02038d6:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02038d8:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02038da:	85a2                	mv	a1,s0
ffffffffc02038dc:	8526                	mv	a0,s1
ffffffffc02038de:	d2dff0ef          	jal	ra,ffffffffc020360a <find_vma>
ffffffffc02038e2:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc02038e6:	c90d                	beqz	a0,ffffffffc0203918 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc02038e8:	6914                	ld	a3,16(a0)
ffffffffc02038ea:	6510                	ld	a2,8(a0)
ffffffffc02038ec:	00002517          	auipc	a0,0x2
ffffffffc02038f0:	63c50513          	addi	a0,a0,1596 # ffffffffc0205f28 <default_pmm_manager+0xd28>
ffffffffc02038f4:	fc6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02038f8:	00002697          	auipc	a3,0x2
ffffffffc02038fc:	65868693          	addi	a3,a3,1624 # ffffffffc0205f50 <default_pmm_manager+0xd50>
ffffffffc0203900:	00001617          	auipc	a2,0x1
ffffffffc0203904:	55060613          	addi	a2,a2,1360 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203908:	0f600593          	li	a1,246
ffffffffc020390c:	00002517          	auipc	a0,0x2
ffffffffc0203910:	4ac50513          	addi	a0,a0,1196 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203914:	a61fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203918:	147d                	addi	s0,s0,-1
ffffffffc020391a:	fd2410e3          	bne	s0,s2,ffffffffc02038da <vmm_init+0x18a>
ffffffffc020391e:	a811                	j	ffffffffc0203932 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203920:	6118                	ld	a4,0(a0)
ffffffffc0203922:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203924:	03000593          	li	a1,48
ffffffffc0203928:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020392a:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020392c:	e398                	sd	a4,0(a5)
ffffffffc020392e:	f05fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203932:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203934:	fea496e3          	bne	s1,a0,ffffffffc0203920 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203938:	03000593          	li	a1,48
ffffffffc020393c:	8526                	mv	a0,s1
ffffffffc020393e:	ef5fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203942:	d51fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203946:	3caa1163          	bne	s4,a0,ffffffffc0203d08 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020394a:	00002517          	auipc	a0,0x2
ffffffffc020394e:	64650513          	addi	a0,a0,1606 # ffffffffc0205f90 <default_pmm_manager+0xd90>
ffffffffc0203952:	f68fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203956:	d3dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020395a:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020395c:	03000513          	li	a0,48
ffffffffc0203960:	e19fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203964:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203966:	2a050163          	beqz	a0,ffffffffc0203c08 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020396a:	0000e797          	auipc	a5,0xe
ffffffffc020396e:	be67a783          	lw	a5,-1050(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203972:	e508                	sd	a0,8(a0)
ffffffffc0203974:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203976:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020397a:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020397e:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203982:	14079063          	bnez	a5,ffffffffc0203ac2 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203986:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020398a:	0000e917          	auipc	s2,0xe
ffffffffc020398e:	b8e93903          	ld	s2,-1138(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203992:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203996:	0000e717          	auipc	a4,0xe
ffffffffc020399a:	bc873123          	sd	s0,-1086(a4) # ffffffffc0211558 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020399e:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02039a2:	24079363          	bnez	a5,ffffffffc0203be8 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02039a6:	03000513          	li	a0,48
ffffffffc02039aa:	dcffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02039ae:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02039b0:	28050063          	beqz	a0,ffffffffc0203c30 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02039b4:	002007b7          	lui	a5,0x200
ffffffffc02039b8:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02039bc:	4789                	li	a5,2
...
ffffffffc02039be:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02039c0:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02039c4:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02039c6:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02039ca:	c81ff0ef          	jal	ra,ffffffffc020364a <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02039ce:	10000593          	li	a1,256
ffffffffc02039d2:	8522                	mv	a0,s0
ffffffffc02039d4:	c37ff0ef          	jal	ra,ffffffffc020360a <find_vma>
ffffffffc02039d8:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02039dc:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02039e0:	26aa1863          	bne	s4,a0,ffffffffc0203c50 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc02039e4:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc02039e8:	0785                	addi	a5,a5,1
ffffffffc02039ea:	fee79de3          	bne	a5,a4,ffffffffc02039e4 <vmm_init+0x294>
        sum += i;
ffffffffc02039ee:	6705                	lui	a4,0x1
ffffffffc02039f0:	10000793          	li	a5,256
ffffffffc02039f4:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02039f8:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02039fc:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203a00:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203a02:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203a04:	fec79ce3          	bne	a5,a2,ffffffffc02039fc <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203a08:	26071463          	bnez	a4,ffffffffc0203c70 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203a0c:	4581                	li	a1,0
ffffffffc0203a0e:	854a                	mv	a0,s2
ffffffffc0203a10:	f0dfd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a14:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203a18:	0000e717          	auipc	a4,0xe
ffffffffc0203a1c:	b0873703          	ld	a4,-1272(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a20:	078a                	slli	a5,a5,0x2
ffffffffc0203a22:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203a24:	26e7f663          	bgeu	a5,a4,ffffffffc0203c90 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203a28:	00003717          	auipc	a4,0x3
ffffffffc0203a2c:	95073703          	ld	a4,-1712(a4) # ffffffffc0206378 <nbase>
ffffffffc0203a30:	8f99                	sub	a5,a5,a4
ffffffffc0203a32:	00379713          	slli	a4,a5,0x3
ffffffffc0203a36:	97ba                	add	a5,a5,a4
ffffffffc0203a38:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203a3a:	0000e517          	auipc	a0,0xe
ffffffffc0203a3e:	aee53503          	ld	a0,-1298(a0) # ffffffffc0211528 <pages>
ffffffffc0203a42:	953e                	add	a0,a0,a5
ffffffffc0203a44:	4585                	li	a1,1
ffffffffc0203a46:	c0dfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203a4a:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203a4c:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203a50:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a54:	00a40e63          	beq	s0,a0,ffffffffc0203a70 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a58:	6118                	ld	a4,0(a0)
ffffffffc0203a5a:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203a5c:	03000593          	li	a1,48
ffffffffc0203a60:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203a62:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203a64:	e398                	sd	a4,0(a5)
ffffffffc0203a66:	dcdfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203a6a:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a6c:	fea416e3          	bne	s0,a0,ffffffffc0203a58 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203a70:	03000593          	li	a1,48
ffffffffc0203a74:	8522                	mv	a0,s0
ffffffffc0203a76:	dbdfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203a7a:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203a7c:	0000e797          	auipc	a5,0xe
ffffffffc0203a80:	ac07be23          	sd	zero,-1316(a5) # ffffffffc0211558 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a84:	c0ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a88:	22a49063          	bne	s1,a0,ffffffffc0203ca8 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a8c:	00002517          	auipc	a0,0x2
ffffffffc0203a90:	55450513          	addi	a0,a0,1364 # ffffffffc0205fe0 <default_pmm_manager+0xde0>
ffffffffc0203a94:	e26fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a98:	bfbfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a9c:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a9e:	22a99563          	bne	s3,a0,ffffffffc0203cc8 <vmm_init+0x578>
}
ffffffffc0203aa2:	6406                	ld	s0,64(sp)
ffffffffc0203aa4:	60a6                	ld	ra,72(sp)
ffffffffc0203aa6:	74e2                	ld	s1,56(sp)
ffffffffc0203aa8:	7942                	ld	s2,48(sp)
ffffffffc0203aaa:	79a2                	ld	s3,40(sp)
ffffffffc0203aac:	7a02                	ld	s4,32(sp)
ffffffffc0203aae:	6ae2                	ld	s5,24(sp)
ffffffffc0203ab0:	6b42                	ld	s6,16(sp)
ffffffffc0203ab2:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203ab4:	00002517          	auipc	a0,0x2
ffffffffc0203ab8:	54c50513          	addi	a0,a0,1356 # ffffffffc0206000 <default_pmm_manager+0xe00>
}
ffffffffc0203abc:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203abe:	dfcfc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203ac2:	cc2ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203ac6:	b5d1                	j	ffffffffc020398a <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203ac8:	00002697          	auipc	a3,0x2
ffffffffc0203acc:	37868693          	addi	a3,a3,888 # ffffffffc0205e40 <default_pmm_manager+0xc40>
ffffffffc0203ad0:	00001617          	auipc	a2,0x1
ffffffffc0203ad4:	38060613          	addi	a2,a2,896 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203ad8:	0dd00593          	li	a1,221
ffffffffc0203adc:	00002517          	auipc	a0,0x2
ffffffffc0203ae0:	2dc50513          	addi	a0,a0,732 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203ae4:	891fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203ae8:	00002697          	auipc	a3,0x2
ffffffffc0203aec:	41068693          	addi	a3,a3,1040 # ffffffffc0205ef8 <default_pmm_manager+0xcf8>
ffffffffc0203af0:	00001617          	auipc	a2,0x1
ffffffffc0203af4:	36060613          	addi	a2,a2,864 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203af8:	0ee00593          	li	a1,238
ffffffffc0203afc:	00002517          	auipc	a0,0x2
ffffffffc0203b00:	2bc50513          	addi	a0,a0,700 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203b04:	871fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203b08:	00002697          	auipc	a3,0x2
ffffffffc0203b0c:	3c068693          	addi	a3,a3,960 # ffffffffc0205ec8 <default_pmm_manager+0xcc8>
ffffffffc0203b10:	00001617          	auipc	a2,0x1
ffffffffc0203b14:	34060613          	addi	a2,a2,832 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203b18:	0ed00593          	li	a1,237
ffffffffc0203b1c:	00002517          	auipc	a0,0x2
ffffffffc0203b20:	29c50513          	addi	a0,a0,668 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203b24:	851fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203b28:	00002697          	auipc	a3,0x2
ffffffffc0203b2c:	30068693          	addi	a3,a3,768 # ffffffffc0205e28 <default_pmm_manager+0xc28>
ffffffffc0203b30:	00001617          	auipc	a2,0x1
ffffffffc0203b34:	32060613          	addi	a2,a2,800 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203b38:	0db00593          	li	a1,219
ffffffffc0203b3c:	00002517          	auipc	a0,0x2
ffffffffc0203b40:	27c50513          	addi	a0,a0,636 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203b44:	831fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203b48:	00002697          	auipc	a3,0x2
ffffffffc0203b4c:	33068693          	addi	a3,a3,816 # ffffffffc0205e78 <default_pmm_manager+0xc78>
ffffffffc0203b50:	00001617          	auipc	a2,0x1
ffffffffc0203b54:	30060613          	addi	a2,a2,768 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203b58:	0e300593          	li	a1,227
ffffffffc0203b5c:	00002517          	auipc	a0,0x2
ffffffffc0203b60:	25c50513          	addi	a0,a0,604 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203b64:	811fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203b68:	00002697          	auipc	a3,0x2
ffffffffc0203b6c:	32068693          	addi	a3,a3,800 # ffffffffc0205e88 <default_pmm_manager+0xc88>
ffffffffc0203b70:	00001617          	auipc	a2,0x1
ffffffffc0203b74:	2e060613          	addi	a2,a2,736 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203b78:	0e500593          	li	a1,229
ffffffffc0203b7c:	00002517          	auipc	a0,0x2
ffffffffc0203b80:	23c50513          	addi	a0,a0,572 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203b84:	ff0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b88:	00002697          	auipc	a3,0x2
ffffffffc0203b8c:	31068693          	addi	a3,a3,784 # ffffffffc0205e98 <default_pmm_manager+0xc98>
ffffffffc0203b90:	00001617          	auipc	a2,0x1
ffffffffc0203b94:	2c060613          	addi	a2,a2,704 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203b98:	0e700593          	li	a1,231
ffffffffc0203b9c:	00002517          	auipc	a0,0x2
ffffffffc0203ba0:	21c50513          	addi	a0,a0,540 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203ba4:	fd0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ba8:	00002697          	auipc	a3,0x2
ffffffffc0203bac:	30068693          	addi	a3,a3,768 # ffffffffc0205ea8 <default_pmm_manager+0xca8>
ffffffffc0203bb0:	00001617          	auipc	a2,0x1
ffffffffc0203bb4:	2a060613          	addi	a2,a2,672 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203bb8:	0e900593          	li	a1,233
ffffffffc0203bbc:	00002517          	auipc	a0,0x2
ffffffffc0203bc0:	1fc50513          	addi	a0,a0,508 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203bc4:	fb0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203bc8:	00002697          	auipc	a3,0x2
ffffffffc0203bcc:	2f068693          	addi	a3,a3,752 # ffffffffc0205eb8 <default_pmm_manager+0xcb8>
ffffffffc0203bd0:	00001617          	auipc	a2,0x1
ffffffffc0203bd4:	28060613          	addi	a2,a2,640 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203bd8:	0eb00593          	li	a1,235
ffffffffc0203bdc:	00002517          	auipc	a0,0x2
ffffffffc0203be0:	1dc50513          	addi	a0,a0,476 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203be4:	f90fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203be8:	00002697          	auipc	a3,0x2
ffffffffc0203bec:	d3868693          	addi	a3,a3,-712 # ffffffffc0205920 <default_pmm_manager+0x720>
ffffffffc0203bf0:	00001617          	auipc	a2,0x1
ffffffffc0203bf4:	26060613          	addi	a2,a2,608 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203bf8:	10d00593          	li	a1,269
ffffffffc0203bfc:	00002517          	auipc	a0,0x2
ffffffffc0203c00:	1bc50513          	addi	a0,a0,444 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203c04:	f70fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203c08:	00002697          	auipc	a3,0x2
ffffffffc0203c0c:	41068693          	addi	a3,a3,1040 # ffffffffc0206018 <default_pmm_manager+0xe18>
ffffffffc0203c10:	00001617          	auipc	a2,0x1
ffffffffc0203c14:	24060613          	addi	a2,a2,576 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203c18:	10a00593          	li	a1,266
ffffffffc0203c1c:	00002517          	auipc	a0,0x2
ffffffffc0203c20:	19c50513          	addi	a0,a0,412 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
    check_mm_struct = mm_create();
ffffffffc0203c24:	0000e797          	auipc	a5,0xe
ffffffffc0203c28:	9207ba23          	sd	zero,-1740(a5) # ffffffffc0211558 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203c2c:	f48fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203c30:	00002697          	auipc	a3,0x2
ffffffffc0203c34:	d0068693          	addi	a3,a3,-768 # ffffffffc0205930 <default_pmm_manager+0x730>
ffffffffc0203c38:	00001617          	auipc	a2,0x1
ffffffffc0203c3c:	21860613          	addi	a2,a2,536 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203c40:	11100593          	li	a1,273
ffffffffc0203c44:	00002517          	auipc	a0,0x2
ffffffffc0203c48:	17450513          	addi	a0,a0,372 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203c4c:	f28fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c50:	00002697          	auipc	a3,0x2
ffffffffc0203c54:	36068693          	addi	a3,a3,864 # ffffffffc0205fb0 <default_pmm_manager+0xdb0>
ffffffffc0203c58:	00001617          	auipc	a2,0x1
ffffffffc0203c5c:	1f860613          	addi	a2,a2,504 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203c60:	11600593          	li	a1,278
ffffffffc0203c64:	00002517          	auipc	a0,0x2
ffffffffc0203c68:	15450513          	addi	a0,a0,340 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203c6c:	f08fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203c70:	00002697          	auipc	a3,0x2
ffffffffc0203c74:	36068693          	addi	a3,a3,864 # ffffffffc0205fd0 <default_pmm_manager+0xdd0>
ffffffffc0203c78:	00001617          	auipc	a2,0x1
ffffffffc0203c7c:	1d860613          	addi	a2,a2,472 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203c80:	12000593          	li	a1,288
ffffffffc0203c84:	00002517          	auipc	a0,0x2
ffffffffc0203c88:	13450513          	addi	a0,a0,308 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203c8c:	ee8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c90:	00001617          	auipc	a2,0x1
ffffffffc0203c94:	5a860613          	addi	a2,a2,1448 # ffffffffc0205238 <default_pmm_manager+0x38>
ffffffffc0203c98:	06500593          	li	a1,101
ffffffffc0203c9c:	00001517          	auipc	a0,0x1
ffffffffc0203ca0:	5bc50513          	addi	a0,a0,1468 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc0203ca4:	ed0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203ca8:	00002697          	auipc	a3,0x2
ffffffffc0203cac:	2c068693          	addi	a3,a3,704 # ffffffffc0205f68 <default_pmm_manager+0xd68>
ffffffffc0203cb0:	00001617          	auipc	a2,0x1
ffffffffc0203cb4:	1a060613          	addi	a2,a2,416 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203cb8:	12e00593          	li	a1,302
ffffffffc0203cbc:	00002517          	auipc	a0,0x2
ffffffffc0203cc0:	0fc50513          	addi	a0,a0,252 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203cc4:	eb0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cc8:	00002697          	auipc	a3,0x2
ffffffffc0203ccc:	2a068693          	addi	a3,a3,672 # ffffffffc0205f68 <default_pmm_manager+0xd68>
ffffffffc0203cd0:	00001617          	auipc	a2,0x1
ffffffffc0203cd4:	18060613          	addi	a2,a2,384 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203cd8:	0bd00593          	li	a1,189
ffffffffc0203cdc:	00002517          	auipc	a0,0x2
ffffffffc0203ce0:	0dc50513          	addi	a0,a0,220 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203ce4:	e90fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203ce8:	00002697          	auipc	a3,0x2
ffffffffc0203cec:	c1068693          	addi	a3,a3,-1008 # ffffffffc02058f8 <default_pmm_manager+0x6f8>
ffffffffc0203cf0:	00001617          	auipc	a2,0x1
ffffffffc0203cf4:	16060613          	addi	a2,a2,352 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203cf8:	0c700593          	li	a1,199
ffffffffc0203cfc:	00002517          	auipc	a0,0x2
ffffffffc0203d00:	0bc50513          	addi	a0,a0,188 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203d04:	e70fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203d08:	00002697          	auipc	a3,0x2
ffffffffc0203d0c:	26068693          	addi	a3,a3,608 # ffffffffc0205f68 <default_pmm_manager+0xd68>
ffffffffc0203d10:	00001617          	auipc	a2,0x1
ffffffffc0203d14:	14060613          	addi	a2,a2,320 # ffffffffc0204e50 <commands+0x738>
ffffffffc0203d18:	0fb00593          	li	a1,251
ffffffffc0203d1c:	00002517          	auipc	a0,0x2
ffffffffc0203d20:	09c50513          	addi	a0,a0,156 # ffffffffc0205db8 <default_pmm_manager+0xbb8>
ffffffffc0203d24:	e50fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d28 <do_pgfault>:
...
ffffffffc0203d28:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203d2a:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203d2c:	f822                	sd	s0,48(sp)
ffffffffc0203d2e:	f426                	sd	s1,40(sp)
ffffffffc0203d30:	fc06                	sd	ra,56(sp)
ffffffffc0203d32:	f04a                	sd	s2,32(sp)
ffffffffc0203d34:	ec4e                	sd	s3,24(sp)
ffffffffc0203d36:	8432                	mv	s0,a2
ffffffffc0203d38:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203d3a:	8d1ff0ef          	jal	ra,ffffffffc020360a <find_vma>

    pgfault_num++;
ffffffffc0203d3e:	0000e797          	auipc	a5,0xe
ffffffffc0203d42:	8227a783          	lw	a5,-2014(a5) # ffffffffc0211560 <pgfault_num>
ffffffffc0203d46:	2785                	addiw	a5,a5,1
ffffffffc0203d48:	0000e717          	auipc	a4,0xe
ffffffffc0203d4c:	80f72c23          	sw	a5,-2024(a4) # ffffffffc0211560 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203d50:	c549                	beqz	a0,ffffffffc0203dda <do_pgfault+0xb2>
ffffffffc0203d52:	651c                	ld	a5,8(a0)
ffffffffc0203d54:	08f46363          	bltu	s0,a5,ffffffffc0203dda <do_pgfault+0xb2>
...
ffffffffc0203d58:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203d5a:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203d5c:	8b89                	andi	a5,a5,2
ffffffffc0203d5e:	efa9                	bnez	a5,ffffffffc0203db8 <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d60:	75fd                	lui	a1,0xfffff
...
ffffffffc0203d62:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d64:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203d66:	85a2                	mv	a1,s0
ffffffffc0203d68:	4605                	li	a2,1
ffffffffc0203d6a:	963fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203d6e:	610c                	ld	a1,0(a0)
ffffffffc0203d70:	c5b1                	beqz	a1,ffffffffc0203dbc <do_pgfault+0x94>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203d72:	0000d797          	auipc	a5,0xd
ffffffffc0203d76:	7de7a783          	lw	a5,2014(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203d7a:	cbad                	beqz	a5,ffffffffc0203dec <do_pgfault+0xc4>
            //map of phy addr <--->
            //logical addr
...
ffffffffc0203d7c:	0030                	addi	a2,sp,8
ffffffffc0203d7e:	85a2                	mv	a1,s0
ffffffffc0203d80:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203d82:	e402                	sd	zero,8(sp)
            if (swap_in(mm, addr, &page) != 0) {
ffffffffc0203d84:	b2cff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
ffffffffc0203d88:	892a                	mv	s2,a0
ffffffffc0203d8a:	e92d                	bnez	a0,ffffffffc0203dfc <do_pgfault+0xd4>
                cprintf("swap_in in do_pgfault failed\n");
                goto failed;
            }
            // 建立物理地址和逻辑地址之间的映射
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203d8c:	65a2                	ld	a1,8(sp)
ffffffffc0203d8e:	6c88                	ld	a0,24(s1)
ffffffffc0203d90:	86ce                	mv	a3,s3
ffffffffc0203d92:	8622                	mv	a2,s0
ffffffffc0203d94:	c23fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            // 标记页面可交换
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203d98:	6622                	ld	a2,8(sp)
ffffffffc0203d9a:	4685                	li	a3,1
ffffffffc0203d9c:	85a2                	mv	a1,s0
ffffffffc0203d9e:	8526                	mv	a0,s1
ffffffffc0203da0:	9f0ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            
            page->pra_vaddr = addr;
ffffffffc0203da4:	67a2                	ld	a5,8(sp)
ffffffffc0203da6:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203da8:	70e2                	ld	ra,56(sp)
ffffffffc0203daa:	7442                	ld	s0,48(sp)
ffffffffc0203dac:	74a2                	ld	s1,40(sp)
ffffffffc0203dae:	69e2                	ld	s3,24(sp)
ffffffffc0203db0:	854a                	mv	a0,s2
ffffffffc0203db2:	7902                	ld	s2,32(sp)
ffffffffc0203db4:	6121                	addi	sp,sp,64
ffffffffc0203db6:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203db8:	49d9                	li	s3,22
ffffffffc0203dba:	b75d                	j	ffffffffc0203d60 <do_pgfault+0x38>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203dbc:	6c88                	ld	a0,24(s1)
ffffffffc0203dbe:	864e                	mv	a2,s3
ffffffffc0203dc0:	85a2                	mv	a1,s0
ffffffffc0203dc2:	8fffe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203dc6:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203dc8:	f165                	bnez	a0,ffffffffc0203da8 <do_pgfault+0x80>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203dca:	00002517          	auipc	a0,0x2
ffffffffc0203dce:	29650513          	addi	a0,a0,662 # ffffffffc0206060 <default_pmm_manager+0xe60>
ffffffffc0203dd2:	ae8fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203dd6:	5971                	li	s2,-4
            goto failed;
ffffffffc0203dd8:	bfc1                	j	ffffffffc0203da8 <do_pgfault+0x80>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203dda:	85a2                	mv	a1,s0
ffffffffc0203ddc:	00002517          	auipc	a0,0x2
ffffffffc0203de0:	25450513          	addi	a0,a0,596 # ffffffffc0206030 <default_pmm_manager+0xe30>
ffffffffc0203de4:	ad6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203de8:	5975                	li	s2,-3
        goto failed;
ffffffffc0203dea:	bf7d                	j	ffffffffc0203da8 <do_pgfault+0x80>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203dec:	00002517          	auipc	a0,0x2
ffffffffc0203df0:	2bc50513          	addi	a0,a0,700 # ffffffffc02060a8 <default_pmm_manager+0xea8>
ffffffffc0203df4:	ac6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203df8:	5971                	li	s2,-4
            goto failed;
ffffffffc0203dfa:	b77d                	j	ffffffffc0203da8 <do_pgfault+0x80>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203dfc:	00002517          	auipc	a0,0x2
ffffffffc0203e00:	28c50513          	addi	a0,a0,652 # ffffffffc0206088 <default_pmm_manager+0xe88>
ffffffffc0203e04:	ab6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203e08:	5971                	li	s2,-4
ffffffffc0203e0a:	bf79                	j	ffffffffc0203da8 <do_pgfault+0x80>

ffffffffc0203e0c <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203e0e:	4505                	li	a0,1
swapfs_init(void) {
ffffffffc0203e10:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203e12:	e82fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203e16:	cd01                	beqz	a0,ffffffffc0203e2e <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203e18:	4505                	li	a0,1
ffffffffc0203e1a:	e80fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203e1e:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203e20:	810d                	srli	a0,a0,0x3
ffffffffc0203e22:	0000d797          	auipc	a5,0xd
ffffffffc0203e26:	70a7bf23          	sd	a0,1822(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203e2a:	0141                	addi	sp,sp,16
ffffffffc0203e2c:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	2a260613          	addi	a2,a2,674 # ffffffffc02060d0 <default_pmm_manager+0xed0>
ffffffffc0203e36:	45b5                	li	a1,13
ffffffffc0203e38:	00002517          	auipc	a0,0x2
ffffffffc0203e3c:	2b850513          	addi	a0,a0,696 # ffffffffc02060f0 <default_pmm_manager+0xef0>
ffffffffc0203e40:	d34fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e44 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0203e44:	1141                	addi	sp,sp,-16
ffffffffc0203e46:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e48:	00855793          	srli	a5,a0,0x8
ffffffffc0203e4c:	c3a5                	beqz	a5,ffffffffc0203eac <swapfs_read+0x68>
ffffffffc0203e4e:	0000d717          	auipc	a4,0xd
ffffffffc0203e52:	6f273703          	ld	a4,1778(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e56:	04e7fb63          	bgeu	a5,a4,ffffffffc0203eac <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e5a:	0000d617          	auipc	a2,0xd
ffffffffc0203e5e:	6ce63603          	ld	a2,1742(a2) # ffffffffc0211528 <pages>
ffffffffc0203e62:	8d91                	sub	a1,a1,a2
ffffffffc0203e64:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e68:	00002597          	auipc	a1,0x2
ffffffffc0203e6c:	5085b583          	ld	a1,1288(a1) # ffffffffc0206370 <error_string+0x38>
ffffffffc0203e70:	02b60633          	mul	a2,a2,a1
ffffffffc0203e74:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e78:	00002797          	auipc	a5,0x2
ffffffffc0203e7c:	5007b783          	ld	a5,1280(a5) # ffffffffc0206378 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e80:	0000d717          	auipc	a4,0xd
ffffffffc0203e84:	6a073703          	ld	a4,1696(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e88:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e8a:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e8e:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e90:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e92:	02e7f963          	bgeu	a5,a4,ffffffffc0203ec4 <swapfs_read+0x80>
}
ffffffffc0203e96:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e98:	0000d797          	auipc	a5,0xd
ffffffffc0203e9c:	6a07b783          	ld	a5,1696(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203ea0:	46a1                	li	a3,8
ffffffffc0203ea2:	963e                	add	a2,a2,a5
ffffffffc0203ea4:	4505                	li	a0,1
}
ffffffffc0203ea6:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ea8:	df8fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203eac:	86aa                	mv	a3,a0
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	25a60613          	addi	a2,a2,602 # ffffffffc0206108 <default_pmm_manager+0xf08>
ffffffffc0203eb6:	45d1                	li	a1,20
ffffffffc0203eb8:	00002517          	auipc	a0,0x2
ffffffffc0203ebc:	23850513          	addi	a0,a0,568 # ffffffffc02060f0 <default_pmm_manager+0xef0>
ffffffffc0203ec0:	cb4fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203ec4:	86b2                	mv	a3,a2
ffffffffc0203ec6:	06a00593          	li	a1,106
ffffffffc0203eca:	00001617          	auipc	a2,0x1
ffffffffc0203ece:	3c660613          	addi	a2,a2,966 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc0203ed2:	00001517          	auipc	a0,0x1
ffffffffc0203ed6:	38650513          	addi	a0,a0,902 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc0203eda:	c9afc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203ede <swapfs_write>:
...
ffffffffc0203ee2:	00855793          	srli	a5,a0,0x8
ffffffffc0203ee6:	c3a5                	beqz	a5,ffffffffc0203f46 <swapfs_write+0x68>
ffffffffc0203ee8:	0000d717          	auipc	a4,0xd
ffffffffc0203eec:	65873703          	ld	a4,1624(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203ef0:	04e7fb63          	bgeu	a5,a4,ffffffffc0203f46 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ef4:	0000d617          	auipc	a2,0xd
ffffffffc0203ef8:	63463603          	ld	a2,1588(a2) # ffffffffc0211528 <pages>
ffffffffc0203efc:	8d91                	sub	a1,a1,a2
ffffffffc0203efe:	4035d613          	srai	a2,a1,0x3
ffffffffc0203f02:	00002597          	auipc	a1,0x2
ffffffffc0203f06:	46e5b583          	ld	a1,1134(a1) # ffffffffc0206370 <error_string+0x38>
ffffffffc0203f0a:	02b60633          	mul	a2,a2,a1
ffffffffc0203f0e:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203f12:	00002797          	auipc	a5,0x2
ffffffffc0203f16:	4667b783          	ld	a5,1126(a5) # ffffffffc0206378 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f1a:	0000d717          	auipc	a4,0xd
ffffffffc0203f1e:	60673703          	ld	a4,1542(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203f22:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f24:	00c61793          	slli	a5,a2,0xc
ffffffffc0203f28:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203f2a:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f2c:	02e7f963          	bgeu	a5,a4,ffffffffc0203f5e <swapfs_write+0x80>
}
ffffffffc0203f30:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f32:	0000d797          	auipc	a5,0xd
ffffffffc0203f36:	6067b783          	ld	a5,1542(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203f3a:	46a1                	li	a3,8
ffffffffc0203f3c:	963e                	add	a2,a2,a5
ffffffffc0203f3e:	4505                	li	a0,1
}
ffffffffc0203f40:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f42:	d82fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203f46:	86aa                	mv	a3,a0
ffffffffc0203f48:	00002617          	auipc	a2,0x2
ffffffffc0203f4c:	1c060613          	addi	a2,a2,448 # ffffffffc0206108 <default_pmm_manager+0xf08>
ffffffffc0203f50:	45e5                	li	a1,25
ffffffffc0203f52:	00002517          	auipc	a0,0x2
ffffffffc0203f56:	19e50513          	addi	a0,a0,414 # ffffffffc02060f0 <default_pmm_manager+0xef0>
ffffffffc0203f5a:	c1afc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203f5e:	86b2                	mv	a3,a2
ffffffffc0203f60:	06a00593          	li	a1,106
ffffffffc0203f64:	00001617          	auipc	a2,0x1
ffffffffc0203f68:	32c60613          	addi	a2,a2,812 # ffffffffc0205290 <default_pmm_manager+0x90>
ffffffffc0203f6c:	00001517          	auipc	a0,0x1
ffffffffc0203f70:	2ec50513          	addi	a0,a0,748 # ffffffffc0205258 <default_pmm_manager+0x58>
ffffffffc0203f74:	c00fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203f78 <printnum>:
 * */
static void
...
ffffffffc0203f78:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f7c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203f7e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f82:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203f84:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f88:	f022                	sd	s0,32(sp)
ffffffffc0203f8a:	ec26                	sd	s1,24(sp)
ffffffffc0203f8c:	e84a                	sd	s2,16(sp)
ffffffffc0203f8e:	f406                	sd	ra,40(sp)
ffffffffc0203f90:	e44e                	sd	s3,8(sp)
ffffffffc0203f92:	84aa                	mv	s1,a0
ffffffffc0203f94:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203f96:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203f9a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203f9c:	03067e63          	bgeu	a2,a6,ffffffffc0203fd8 <printnum+0x60>
ffffffffc0203fa0:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203fa2:	00805763          	blez	s0,ffffffffc0203fb0 <printnum+0x38>
ffffffffc0203fa6:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203fa8:	85ca                	mv	a1,s2
ffffffffc0203faa:	854e                	mv	a0,s3
ffffffffc0203fac:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203fae:	fc65                	bnez	s0,ffffffffc0203fa6 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fb0:	1a02                	slli	s4,s4,0x20
ffffffffc0203fb2:	00002797          	auipc	a5,0x2
ffffffffc0203fb6:	17678793          	addi	a5,a5,374 # ffffffffc0206128 <default_pmm_manager+0xf28>
ffffffffc0203fba:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203fbe:	9a3e                	add	s4,s4,a5
}
ffffffffc0203fc0:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fc2:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203fc6:	70a2                	ld	ra,40(sp)
ffffffffc0203fc8:	69a2                	ld	s3,8(sp)
ffffffffc0203fca:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fcc:	85ca                	mv	a1,s2
ffffffffc0203fce:	87a6                	mv	a5,s1
}
ffffffffc0203fd0:	6942                	ld	s2,16(sp)
ffffffffc0203fd2:	64e2                	ld	s1,24(sp)
ffffffffc0203fd4:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fd6:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203fd8:	03065633          	divu	a2,a2,a6
ffffffffc0203fdc:	8722                	mv	a4,s0
ffffffffc0203fde:	f9bff0ef          	jal	ra,ffffffffc0203f78 <printnum>
ffffffffc0203fe2:	b7f9                	j	ffffffffc0203fb0 <printnum+0x38>

ffffffffc0203fe4 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203fe6:	f4a6                	sd	s1,104(sp)
ffffffffc0203fe8:	f0ca                	sd	s2,96(sp)
ffffffffc0203fea:	ecce                	sd	s3,88(sp)
ffffffffc0203fec:	e8d2                	sd	s4,80(sp)
ffffffffc0203fee:	e4d6                	sd	s5,72(sp)
ffffffffc0203ff0:	e0da                	sd	s6,64(sp)
ffffffffc0203ff2:	fc5e                	sd	s7,56(sp)
ffffffffc0203ff4:	f06a                	sd	s10,32(sp)
ffffffffc0203ff6:	fc86                	sd	ra,120(sp)
ffffffffc0203ff8:	f8a2                	sd	s0,112(sp)
ffffffffc0203ffa:	f862                	sd	s8,48(sp)
ffffffffc0203ffc:	f466                	sd	s9,40(sp)
ffffffffc0203ffe:	ec6e                	sd	s11,24(sp)
ffffffffc0204000:	892a                	mv	s2,a0
ffffffffc0204002:	84ae                	mv	s1,a1
ffffffffc0204004:	8d32                	mv	s10,a2
ffffffffc0204006:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204008:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc020400c:	5b7d                	li	s6,-1
ffffffffc020400e:	00002a97          	auipc	s5,0x2
ffffffffc0204012:	14ea8a93          	addi	s5,s5,334 # ffffffffc020615c <default_pmm_manager+0xf5c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204016:	00002b97          	auipc	s7,0x2
ffffffffc020401a:	322b8b93          	addi	s7,s7,802 # ffffffffc0206338 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020401e:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0204022:	001d0413          	addi	s0,s10,1
ffffffffc0204026:	01350a63          	beq	a0,s3,ffffffffc020403a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc020402a:	c121                	beqz	a0,ffffffffc020406a <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204030:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204032:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204036:	ff351ae3          	bne	a0,s3,ffffffffc020402a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020403a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020403e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204042:	4c81                	li	s9,0
ffffffffc0204044:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204046:	5c7d                	li	s8,-1
ffffffffc0204048:	5dfd                	li	s11,-1
ffffffffc020404a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc020404e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204050:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204054:	0ff5f593          	zext.b	a1,a1
ffffffffc0204058:	00140d13          	addi	s10,s0,1
ffffffffc020405c:	04b56263          	bltu	a0,a1,ffffffffc02040a0 <vprintfmt+0xbc>
ffffffffc0204060:	058a                	slli	a1,a1,0x2
ffffffffc0204062:	95d6                	add	a1,a1,s5
ffffffffc0204064:	4194                	lw	a3,0(a1)
ffffffffc0204066:	96d6                	add	a3,a3,s5
ffffffffc0204068:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020406a:	70e6                	ld	ra,120(sp)
ffffffffc020406c:	7446                	ld	s0,112(sp)
ffffffffc020406e:	74a6                	ld	s1,104(sp)
ffffffffc0204070:	7906                	ld	s2,96(sp)
ffffffffc0204072:	69e6                	ld	s3,88(sp)
ffffffffc0204074:	6a46                	ld	s4,80(sp)
ffffffffc0204076:	6aa6                	ld	s5,72(sp)
ffffffffc0204078:	6b06                	ld	s6,64(sp)
ffffffffc020407a:	7be2                	ld	s7,56(sp)
ffffffffc020407c:	7c42                	ld	s8,48(sp)
ffffffffc020407e:	7ca2                	ld	s9,40(sp)
ffffffffc0204080:	7d02                	ld	s10,32(sp)
ffffffffc0204082:	6de2                	ld	s11,24(sp)
ffffffffc0204084:	6109                	addi	sp,sp,128
ffffffffc0204086:	8082                	ret
            padc = '0';
ffffffffc0204088:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc020408a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020408e:	846a                	mv	s0,s10
ffffffffc0204090:	00140d13          	addi	s10,s0,1
ffffffffc0204094:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204098:	0ff5f593          	zext.b	a1,a1
ffffffffc020409c:	fcb572e3          	bgeu	a0,a1,ffffffffc0204060 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc02040a0:	85a6                	mv	a1,s1
ffffffffc02040a2:	02500513          	li	a0,37
ffffffffc02040a6:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc02040a8:	fff44783          	lbu	a5,-1(s0)
ffffffffc02040ac:	8d22                	mv	s10,s0
ffffffffc02040ae:	f73788e3          	beq	a5,s3,ffffffffc020401e <vprintfmt+0x3a>
ffffffffc02040b2:	ffed4783          	lbu	a5,-2(s10)
ffffffffc02040b6:	1d7d                	addi	s10,s10,-1
ffffffffc02040b8:	ff379de3          	bne	a5,s3,ffffffffc02040b2 <vprintfmt+0xce>
ffffffffc02040bc:	b78d                	j	ffffffffc020401e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc02040be:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc02040c2:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c6:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc02040c8:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc02040cc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02040d0:	02d86463          	bltu	a6,a3,ffffffffc02040f8 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02040d4:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02040d8:	002c169b          	slliw	a3,s8,0x2
ffffffffc02040dc:	0186873b          	addw	a4,a3,s8
ffffffffc02040e0:	0017171b          	slliw	a4,a4,0x1
ffffffffc02040e4:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02040e6:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02040ea:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02040ec:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02040f0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02040f4:	fed870e3          	bgeu	a6,a3,ffffffffc02040d4 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02040f8:	f40ddce3          	bgez	s11,ffffffffc0204050 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02040fc:	8de2                	mv	s11,s8
ffffffffc02040fe:	5c7d                	li	s8,-1
ffffffffc0204100:	bf81                	j	ffffffffc0204050 <vprintfmt+0x6c>
            if (width < 0)
...
ffffffffc0204112:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204114:	bf35                	j	ffffffffc0204050 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204116:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020411a:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc020411e:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204120:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204122:	bfd9                	j	ffffffffc02040f8 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204124:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204126:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020412a:	01174463          	blt	a4,a7,ffffffffc0204132 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020412e:	1a088e63          	beqz	a7,ffffffffc02042ea <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204132:	000a3603          	ld	a2,0(s4)
ffffffffc0204136:	46c1                	li	a3,16
ffffffffc0204138:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020413a:	2781                	sext.w	a5,a5
ffffffffc020413c:	876e                	mv	a4,s11
ffffffffc020413e:	85a6                	mv	a1,s1
ffffffffc0204140:	854a                	mv	a0,s2
ffffffffc0204142:	e37ff0ef          	jal	ra,ffffffffc0203f78 <printnum>
            break;
ffffffffc0204146:	bde1                	j	ffffffffc020401e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204148:	000a2503          	lw	a0,0(s4)
ffffffffc020414c:	85a6                	mv	a1,s1
ffffffffc020414e:	0a21                	addi	s4,s4,8
ffffffffc0204150:	9902                	jalr	s2
            break;
ffffffffc0204152:	b5f1                	j	ffffffffc020401e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204154:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204156:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020415a:	01174463          	blt	a4,a7,ffffffffc0204162 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020415e:	18088163          	beqz	a7,ffffffffc02042e0 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204162:	000a3603          	ld	a2,0(s4)
ffffffffc0204166:	46a9                	li	a3,10
ffffffffc0204168:	8a2e                	mv	s4,a1
ffffffffc020416a:	bfc1                	j	ffffffffc020413a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020416c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204170:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204172:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204174:	bdf1                	j	ffffffffc0204050 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204176:	85a6                	mv	a1,s1
ffffffffc0204178:	02500513          	li	a0,37
ffffffffc020417c:	9902                	jalr	s2
            break;
ffffffffc020417e:	b545                	j	ffffffffc020401e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204180:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204184:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204186:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204188:	b5e1                	j	ffffffffc0204050 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020418a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020418c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204190:	01174463          	blt	a4,a7,ffffffffc0204198 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204194:	14088163          	beqz	a7,ffffffffc02042d6 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204198:	000a3603          	ld	a2,0(s4)
ffffffffc020419c:	46a1                	li	a3,8
ffffffffc020419e:	8a2e                	mv	s4,a1
ffffffffc02041a0:	bf69                	j	ffffffffc020413a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02041a2:	03000513          	li	a0,48
ffffffffc02041a6:	85a6                	mv	a1,s1
ffffffffc02041a8:	e03e                	sd	a5,0(sp)
ffffffffc02041aa:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02041ac:	85a6                	mv	a1,s1
ffffffffc02041ae:	07800513          	li	a0,120
ffffffffc02041b2:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02041b4:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02041b6:	6782                	ld	a5,0(sp)
ffffffffc02041b8:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02041ba:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02041be:	bfb5                	j	ffffffffc020413a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02041c0:	000a3403          	ld	s0,0(s4)
ffffffffc02041c4:	008a0713          	addi	a4,s4,8
ffffffffc02041c8:	e03a                	sd	a4,0(sp)
ffffffffc02041ca:	14040263          	beqz	s0,ffffffffc020430e <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02041ce:	0fb05763          	blez	s11,ffffffffc02042bc <vprintfmt+0x2d8>
ffffffffc02041d2:	02d00693          	li	a3,45
ffffffffc02041d6:	0cd79163          	bne	a5,a3,ffffffffc0204298 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041da:	00044783          	lbu	a5,0(s0)
ffffffffc02041de:	0007851b          	sext.w	a0,a5
ffffffffc02041e2:	cf85                	beqz	a5,ffffffffc020421a <vprintfmt+0x236>
ffffffffc02041e4:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041e8:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041ec:	000c4563          	bltz	s8,ffffffffc02041f6 <vprintfmt+0x212>
ffffffffc02041f0:	3c7d                	addiw	s8,s8,-1
ffffffffc02041f2:	036c0263          	beq	s8,s6,ffffffffc0204216 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02041f6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041f8:	0e0c8e63          	beqz	s9,ffffffffc02042f4 <vprintfmt+0x310>
ffffffffc02041fc:	3781                	addiw	a5,a5,-32
ffffffffc02041fe:	0ef47b63          	bgeu	s0,a5,ffffffffc02042f4 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204202:	03f00513          	li	a0,63
ffffffffc0204206:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204208:	000a4783          	lbu	a5,0(s4)
ffffffffc020420c:	3dfd                	addiw	s11,s11,-1
ffffffffc020420e:	0a05                	addi	s4,s4,1
ffffffffc0204210:	0007851b          	sext.w	a0,a5
ffffffffc0204214:	ffe1                	bnez	a5,ffffffffc02041ec <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204216:	01b05963          	blez	s11,ffffffffc0204228 <vprintfmt+0x244>
ffffffffc020421a:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020421c:	85a6                	mv	a1,s1
ffffffffc020421e:	02000513          	li	a0,32
ffffffffc0204222:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204224:	fe0d9be3          	bnez	s11,ffffffffc020421a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204228:	6a02                	ld	s4,0(sp)
ffffffffc020422a:	bbd5                	j	ffffffffc020401e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020422c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020422e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204232:	01174463          	blt	a4,a7,ffffffffc020423a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204236:	08088d63          	beqz	a7,ffffffffc02042d0 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc020423a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020423e:	0a044d63          	bltz	s0,ffffffffc02042f8 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204242:	8622                	mv	a2,s0
ffffffffc0204244:	8a66                	mv	s4,s9
ffffffffc0204246:	46a9                	li	a3,10
ffffffffc0204248:	bdcd                	j	ffffffffc020413a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc020424a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020424e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204250:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204252:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204256:	8fb5                	xor	a5,a5,a3
ffffffffc0204258:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020425c:	02d74163          	blt	a4,a3,ffffffffc020427e <vprintfmt+0x29a>
ffffffffc0204260:	00369793          	slli	a5,a3,0x3
ffffffffc0204264:	97de                	add	a5,a5,s7
ffffffffc0204266:	639c                	ld	a5,0(a5)
ffffffffc0204268:	cb99                	beqz	a5,ffffffffc020427e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020426a:	86be                	mv	a3,a5
ffffffffc020426c:	00002617          	auipc	a2,0x2
ffffffffc0204270:	eec60613          	addi	a2,a2,-276 # ffffffffc0206158 <default_pmm_manager+0xf58>
ffffffffc0204274:	85a6                	mv	a1,s1
ffffffffc0204276:	854a                	mv	a0,s2
ffffffffc0204278:	0ce000ef          	jal	ra,ffffffffc0204346 <printfmt>
ffffffffc020427c:	b34d                	j	ffffffffc020401e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020427e:	00002617          	auipc	a2,0x2
ffffffffc0204282:	eca60613          	addi	a2,a2,-310 # ffffffffc0206148 <default_pmm_manager+0xf48>
ffffffffc0204286:	85a6                	mv	a1,s1
ffffffffc0204288:	854a                	mv	a0,s2
ffffffffc020428a:	0bc000ef          	jal	ra,ffffffffc0204346 <printfmt>
ffffffffc020428e:	bb41                	j	ffffffffc020401e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204290:	00002417          	auipc	s0,0x2
ffffffffc0204294:	eb040413          	addi	s0,s0,-336 # ffffffffc0206140 <default_pmm_manager+0xf40>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204298:	85e2                	mv	a1,s8
ffffffffc020429a:	8522                	mv	a0,s0
ffffffffc020429c:	e43e                	sd	a5,8(sp)
ffffffffc020429e:	196000ef          	jal	ra,ffffffffc0204434 <strnlen>
ffffffffc02042a2:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02042a6:	01b05b63          	blez	s11,ffffffffc02042bc <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02042aa:	67a2                	ld	a5,8(sp)
ffffffffc02042ac:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02042b0:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02042b2:	85a6                	mv	a1,s1
ffffffffc02042b4:	8552                	mv	a0,s4
ffffffffc02042b6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02042b8:	fe0d9ce3          	bnez	s11,ffffffffc02042b0 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02042bc:	00044783          	lbu	a5,0(s0)
ffffffffc02042c0:	00140a13          	addi	s4,s0,1
ffffffffc02042c4:	0007851b          	sext.w	a0,a5
ffffffffc02042c8:	d3a5                	beqz	a5,ffffffffc0204228 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02042ca:	05e00413          	li	s0,94
ffffffffc02042ce:	bf39                	j	ffffffffc02041ec <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02042d0:	000a2403          	lw	s0,0(s4)
ffffffffc02042d4:	b7ad                	j	ffffffffc020423e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02042d6:	000a6603          	lwu	a2,0(s4)
ffffffffc02042da:	46a1                	li	a3,8
ffffffffc02042dc:	8a2e                	mv	s4,a1
ffffffffc02042de:	bdb1                	j	ffffffffc020413a <vprintfmt+0x156>
ffffffffc02042e0:	000a6603          	lwu	a2,0(s4)
ffffffffc02042e4:	46a9                	li	a3,10
ffffffffc02042e6:	8a2e                	mv	s4,a1
ffffffffc02042e8:	bd89                	j	ffffffffc020413a <vprintfmt+0x156>
ffffffffc02042ea:	000a6603          	lwu	a2,0(s4)
ffffffffc02042ee:	46c1                	li	a3,16
ffffffffc02042f0:	8a2e                	mv	s4,a1
ffffffffc02042f2:	b5a1                	j	ffffffffc020413a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02042f4:	9902                	jalr	s2
ffffffffc02042f6:	bf09                	j	ffffffffc0204208 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02042f8:	85a6                	mv	a1,s1
ffffffffc02042fa:	02d00513          	li	a0,45
ffffffffc02042fe:	e03e                	sd	a5,0(sp)
ffffffffc0204300:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204302:	6782                	ld	a5,0(sp)
ffffffffc0204304:	8a66                	mv	s4,s9
ffffffffc0204306:	40800633          	neg	a2,s0
ffffffffc020430a:	46a9                	li	a3,10
ffffffffc020430c:	b53d                	j	ffffffffc020413a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc020430e:	03b05163          	blez	s11,ffffffffc0204330 <vprintfmt+0x34c>
ffffffffc0204312:	02d00693          	li	a3,45
ffffffffc0204316:	f6d79de3          	bne	a5,a3,ffffffffc0204290 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc020431a:	00002417          	auipc	s0,0x2
ffffffffc020431e:	e2640413          	addi	s0,s0,-474 # ffffffffc0206140 <default_pmm_manager+0xf40>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204322:	02800793          	li	a5,40
ffffffffc0204326:	02800513          	li	a0,40
ffffffffc020432a:	00140a13          	addi	s4,s0,1
ffffffffc020432e:	bd6d                	j	ffffffffc02041e8 <vprintfmt+0x204>
ffffffffc0204330:	00002a17          	auipc	s4,0x2
ffffffffc0204334:	e11a0a13          	addi	s4,s4,-495 # ffffffffc0206141 <default_pmm_manager+0xf41>
ffffffffc0204338:	02800513          	li	a0,40
ffffffffc020433c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204340:	05e00413          	li	s0,94
ffffffffc0204344:	b565                	j	ffffffffc02041ec <vprintfmt+0x208>

ffffffffc0204346 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204346:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204348:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020434c:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020434e:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204350:	ec06                	sd	ra,24(sp)
ffffffffc0204352:	f83a                	sd	a4,48(sp)
ffffffffc0204354:	fc3e                	sd	a5,56(sp)
ffffffffc0204356:	e0c2                	sd	a6,64(sp)
ffffffffc0204358:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020435a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020435c:	c89ff0ef          	jal	ra,ffffffffc0203fe4 <vprintfmt>
}
ffffffffc0204360:	60e2                	ld	ra,24(sp)
ffffffffc0204362:	6161                	addi	sp,sp,80
ffffffffc0204364:	8082                	ret

ffffffffc0204366 <readline>:
...
ffffffffc0204368:	e486                	sd	ra,72(sp)
ffffffffc020436a:	e0a6                	sd	s1,64(sp)
ffffffffc020436c:	fc4a                	sd	s2,56(sp)
ffffffffc020436e:	f84e                	sd	s3,48(sp)
ffffffffc0204370:	f452                	sd	s4,40(sp)
ffffffffc0204372:	f056                	sd	s5,32(sp)
ffffffffc0204374:	ec5a                	sd	s6,24(sp)
ffffffffc0204376:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204378:	c901                	beqz	a0,ffffffffc0204388 <readline+0x22>
ffffffffc020437a:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc020437c:	00002517          	auipc	a0,0x2
ffffffffc0204380:	ddc50513          	addi	a0,a0,-548 # ffffffffc0206158 <default_pmm_manager+0xf58>
ffffffffc0204384:	d37fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc020438a:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc020438c:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc020438e:	4aa9                	li	s5,10
ffffffffc0204390:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0204392:	0000db97          	auipc	s7,0xd
ffffffffc0204396:	d66b8b93          	addi	s7,s7,-666 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020439a:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020439e:	d55fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02043a2:	00054a63          	bltz	a0,ffffffffc02043b6 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02043a6:	00a95a63          	bge	s2,a0,ffffffffc02043ba <readline+0x54>
ffffffffc02043aa:	029a5263          	bge	s4,s1,ffffffffc02043ce <readline+0x68>
        c = getchar();
ffffffffc02043ae:	d45fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02043b2:	fe055ae3          	bgez	a0,ffffffffc02043a6 <readline+0x40>
            return NULL;
ffffffffc02043b6:	4501                	li	a0,0
ffffffffc02043b8:	a091                	j	ffffffffc02043fc <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02043ba:	03351463          	bne	a0,s3,ffffffffc02043e2 <readline+0x7c>
ffffffffc02043be:	e8a9                	bnez	s1,ffffffffc0204410 <readline+0xaa>
        c = getchar();
ffffffffc02043c0:	d33fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02043c4:	fe0549e3          	bltz	a0,ffffffffc02043b6 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02043c8:	fea959e3          	bge	s2,a0,ffffffffc02043ba <readline+0x54>
ffffffffc02043cc:	4481                	li	s1,0
            cputchar(c);
ffffffffc02043ce:	e42a                	sd	a0,8(sp)
ffffffffc02043d0:	d21fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02043d4:	6522                	ld	a0,8(sp)
ffffffffc02043d6:	009b87b3          	add	a5,s7,s1
ffffffffc02043da:	2485                	addiw	s1,s1,1
ffffffffc02043dc:	00a78023          	sb	a0,0(a5)
ffffffffc02043e0:	bf7d                	j	ffffffffc020439e <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02043e2:	01550463          	beq	a0,s5,ffffffffc02043ea <readline+0x84>
ffffffffc02043e6:	fb651ce3          	bne	a0,s6,ffffffffc020439e <readline+0x38>
            cputchar(c);
ffffffffc02043ea:	d07fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02043ee:	0000d517          	auipc	a0,0xd
ffffffffc02043f2:	d0a50513          	addi	a0,a0,-758 # ffffffffc02110f8 <buf>
ffffffffc02043f6:	94aa                	add	s1,s1,a0
ffffffffc02043f8:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02043fc:	60a6                	ld	ra,72(sp)
ffffffffc02043fe:	6486                	ld	s1,64(sp)
ffffffffc0204400:	7962                	ld	s2,56(sp)
ffffffffc0204402:	79c2                	ld	s3,48(sp)
ffffffffc0204404:	7a22                	ld	s4,40(sp)
ffffffffc0204406:	7a82                	ld	s5,32(sp)
ffffffffc0204408:	6b62                	ld	s6,24(sp)
ffffffffc020440a:	6bc2                	ld	s7,16(sp)
ffffffffc020440c:	6161                	addi	sp,sp,80
ffffffffc020440e:	8082                	ret
            cputchar(c);
ffffffffc0204410:	4521                	li	a0,8
ffffffffc0204412:	cdffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204416:	34fd                	addiw	s1,s1,-1
ffffffffc0204418:	b759                	j	ffffffffc020439e <readline+0x38>

ffffffffc020441a <strlen>:
...
strlen(const char *s) {
ffffffffc020441e:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204420:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204422:	cb81                	beqz	a5,ffffffffc0204432 <strlen+0x18>
        cnt ++;
ffffffffc0204424:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204426:	00a707b3          	add	a5,a4,a0
ffffffffc020442a:	0007c783          	lbu	a5,0(a5)
ffffffffc020442e:	fbfd                	bnez	a5,ffffffffc0204424 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204434:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204436:	e589                	bnez	a1,ffffffffc0204440 <strnlen+0xc>
ffffffffc0204438:	a811                	j	ffffffffc020444c <strnlen+0x18>
        cnt ++;
ffffffffc020443a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020443c:	00f58863          	beq	a1,a5,ffffffffc020444c <strnlen+0x18>
ffffffffc0204440:	00f50733          	add	a4,a0,a5
ffffffffc0204444:	00074703          	lbu	a4,0(a4)
ffffffffc0204448:	fb6d                	bnez	a4,ffffffffc020443a <strnlen+0x6>
ffffffffc020444a:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020444c:	852e                	mv	a0,a1
ffffffffc020444e:	8082                	ret

ffffffffc0204450 <strcpy>:
char *
...
ffffffffc0204450:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204452:	0005c703          	lbu	a4,0(a1)
ffffffffc0204456:	0785                	addi	a5,a5,1
ffffffffc0204458:	0585                	addi	a1,a1,1
ffffffffc020445a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020445e:	fb75                	bnez	a4,ffffffffc0204452 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204462:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204466:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020446a:	cb89                	beqz	a5,ffffffffc020447c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020446c:	0505                	addi	a0,a0,1
ffffffffc020446e:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204470:	fee789e3          	beq	a5,a4,ffffffffc0204462 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204474:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204478:	9d19                	subw	a0,a0,a4
ffffffffc020447a:	8082                	ret
ffffffffc020447c:	4501                	li	a0,0
ffffffffc020447e:	bfed                	j	ffffffffc0204478 <strcmp+0x16>

ffffffffc0204480 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204480:	00054783          	lbu	a5,0(a0)
ffffffffc0204484:	c799                	beqz	a5,ffffffffc0204492 <strchr+0x12>
        if (*s == c) {
ffffffffc0204486:	00f58763          	beq	a1,a5,ffffffffc0204494 <strchr+0x14>
    while (*s != '\0') {
ffffffffc020448a:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc020448e:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204490:	fbfd                	bnez	a5,ffffffffc0204486 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204496:	ca01                	beqz	a2,ffffffffc02044a6 <memset+0x10>
ffffffffc0204498:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc020449a:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc020449c:	0785                	addi	a5,a5,1
ffffffffc020449e:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02044a2:	fec79de3          	bne	a5,a2,ffffffffc020449c <memset+0x6>
    }
    return s;
...
ffffffffc02044a8 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02044a8:	ca19                	beqz	a2,ffffffffc02044be <memcpy+0x16>
ffffffffc02044aa:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02044ac:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02044ae:	0005c703          	lbu	a4,0(a1)
ffffffffc02044b2:	0585                	addi	a1,a1,1
ffffffffc02044b4:	0785                	addi	a5,a5,1
ffffffffc02044b6:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02044ba:	fec59ae3          	bne	a1,a2,ffffffffc02044ae <memcpy+0x6>
    }
    return dst;
