...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	689040ef          	jal	ra,ffffffffc0204ed2 <memset>
...
ffffffffc0200056:	ece58593          	addi	a1,a1,-306 # ffffffffc0204f20 <etext>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	ee650513          	addi	a0,a0,-282 # ffffffffc0204f40 <etext+0x20>
...
ffffffffc0200076:	195030ef          	jal	ra,ffffffffc0203a0a <vmm_init>
    proc_init();                // init process table完成了idleproc内核线程和initproc内核线程的创建或复制工作
ffffffffc020007a:	60e040ef          	jal	ra,ffffffffc0204688 <proc_init>
...
ffffffffc020008e:	079040ef          	jal	ra,ffffffffc0204906 <cpu_idle>
...
ffffffffc02000ac:	ea050513          	addi	a0,a0,-352 # ffffffffc0204f48 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	161040ef          	jal	ra,ffffffffc0204ad4 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	12b040ef          	jal	ra,ffffffffc0204ad4 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d8650513          	addi	a0,a0,-634 # ffffffffc0204f50 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d9050513          	addi	a0,a0,-624 # ffffffffc0204f70 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d3458593          	addi	a1,a1,-716 # ffffffffc0204f20 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d9c50513          	addi	a0,a0,-612 # ffffffffc0204f90 <etext+0x70>
...
ffffffffc020020c:	da850513          	addi	a0,a0,-600 # ffffffffc0204fb0 <etext+0x90>
...
ffffffffc0200220:	db450513          	addi	a0,a0,-588 # ffffffffc0204fd0 <etext+0xb0>
...
ffffffffc020024e:	da650513          	addi	a0,a0,-602 # ffffffffc0204ff0 <etext+0xd0>
}
...
ffffffffc020025c:	dc860613          	addi	a2,a2,-568 # ffffffffc0205020 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	dd450513          	addi	a0,a0,-556 # ffffffffc0205038 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	ddc60613          	addi	a2,a2,-548 # ffffffffc0205050 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	df458593          	addi	a1,a1,-524 # ffffffffc0205070 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	df450513          	addi	a0,a0,-524 # ffffffffc0205078 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	df660613          	addi	a2,a2,-522 # ffffffffc0205088 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e1658593          	addi	a1,a1,-490 # ffffffffc02050b0 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	dd650513          	addi	a0,a0,-554 # ffffffffc0205078 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e1260613          	addi	a2,a2,-494 # ffffffffc02050c0 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e2a58593          	addi	a1,a1,-470 # ffffffffc02050e0 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dba50513          	addi	a0,a0,-582 # ffffffffc0205078 <etext+0x158>
...
ffffffffc02002fc:	df850513          	addi	a0,a0,-520 # ffffffffc02050f0 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dfe50513          	addi	a0,a0,-514 # ffffffffc0205118 <etext+0x1f8>
...
ffffffffc0200348:	dfc90913          	addi	s2,s2,-516 # ffffffffc0205140 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dfc48493          	addi	s1,s1,-516 # ffffffffc0205148 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	dfab0b13          	addi	s6,s6,-518 # ffffffffc0205150 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d12a0a13          	addi	s4,s4,-750 # ffffffffc0205070 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	311040ef          	jal	ra,ffffffffc0204e9e <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2fd040ef          	jal	ra,ffffffffc0204e9e <strcmp>
...
ffffffffc02003e0:	2dd040ef          	jal	ra,ffffffffc0204ebc <strchr>
...
ffffffffc020041e:	29f040ef          	jal	ra,ffffffffc0204ebc <strchr>
...
ffffffffc020043c:	d3850513          	addi	a0,a0,-712 # ffffffffc0205170 <etext+0x250>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	159040ef          	jal	ra,ffffffffc0204ee4 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	135040ef          	jal	ra,ffffffffc0204ee4 <memcpy>
    return 0;
}
...
ffffffffc0200b6c <forkrets>:
    #设置内核线程时，epc 成员设置为了 kernel_thread_entry 所以此时 __trapret 会将跳转到 kernel_thread_entry
...
ffffffffc0201bbe:	314030ef          	jal	ra,ffffffffc0204ed2 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	282030ef          	jal	ra,ffffffffc0204ed2 <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	33b020ef          	jal	ra,ffffffffc0204e8c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	341020ef          	jal	ra,ffffffffc0204e9e <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2c3020ef          	jal	ra,ffffffffc0204e56 <strlen>
...
ffffffffc0204214:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204216:	456000ef          	jal	ra,ffffffffc020466c <do_exit>

ffffffffc020421a <forkret>:
...
forkret(void) {
    forkrets(current->tf);
ffffffffc020421a:	00012797          	auipc	a5,0x12
ffffffffc020421e:	3967b783          	ld	a5,918(a5) # ffffffffc02165b0 <current>
ffffffffc0204222:	73c8                	ld	a0,160(a5)
ffffffffc0204224:	949fc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc0204228 <init_main>:
    panic("process exit!!.\n");
}
...
static int
init_main(void *arg) {
ffffffffc0204228:	7179                	addi	sp,sp,-48
ffffffffc020422a:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc020422c:	00012497          	auipc	s1,0x12
ffffffffc0204230:	2ec48493          	addi	s1,s1,748 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc0204234:	f022                	sd	s0,32(sp)
ffffffffc0204236:	e84a                	sd	s2,16(sp)
ffffffffc0204238:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020423a:	00012917          	auipc	s2,0x12
ffffffffc020423e:	37693903          	ld	s2,886(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
ffffffffc0204242:	4641                	li	a2,16
ffffffffc0204244:	4581                	li	a1,0
ffffffffc0204246:	8526                	mv	a0,s1
init_main(void *arg) {
ffffffffc0204248:	f406                	sd	ra,40(sp)
ffffffffc020424a:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020424c:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc0204250:	483000ef          	jal	ra,ffffffffc0204ed2 <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204254:	0b490593          	addi	a1,s2,180
ffffffffc0204258:	463d                	li	a2,15
ffffffffc020425a:	8526                	mv	a0,s1
ffffffffc020425c:	489000ef          	jal	ra,ffffffffc0204ee4 <memcpy>
ffffffffc0204260:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0204262:	85ce                	mv	a1,s3
ffffffffc0204264:	00003517          	auipc	a0,0x3
ffffffffc0204268:	9a450513          	addi	a0,a0,-1628 # ffffffffc0206c08 <default_pmm_manager+0xf98>
ffffffffc020426c:	f15fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc0204270:	85a2                	mv	a1,s0
ffffffffc0204272:	00003517          	auipc	a0,0x3
ffffffffc0204276:	9be50513          	addi	a0,a0,-1602 # ffffffffc0206c30 <default_pmm_manager+0xfc0>
ffffffffc020427a:	f07fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc020427e:	00003517          	auipc	a0,0x3
ffffffffc0204282:	9c250513          	addi	a0,a0,-1598 # ffffffffc0206c40 <default_pmm_manager+0xfd0>
ffffffffc0204286:	efbfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc020428a:	70a2                	ld	ra,40(sp)
ffffffffc020428c:	7402                	ld	s0,32(sp)
ffffffffc020428e:	64e2                	ld	s1,24(sp)
ffffffffc0204290:	6942                	ld	s2,16(sp)
ffffffffc0204292:	69a2                	ld	s3,8(sp)
ffffffffc0204294:	4501                	li	a0,0
ffffffffc0204296:	6145                	addi	sp,sp,48
ffffffffc0204298:	8082                	ret

ffffffffc020429a <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc020429a:	7179                	addi	sp,sp,-48
ffffffffc020429c:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc020429e:	00012497          	auipc	s1,0x12
ffffffffc02042a2:	31248493          	addi	s1,s1,786 # ffffffffc02165b0 <current>
ffffffffc02042a6:	6098                	ld	a4,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc02042a8:	f406                	sd	ra,40(sp)
ffffffffc02042aa:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc02042ac:	02a70863          	beq	a4,a0,ffffffffc02042dc <proc_run+0x42>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02042b0:	100027f3          	csrr	a5,sstatus
ffffffffc02042b4:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02042b6:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02042b8:	ef8d                	bnez	a5,ffffffffc02042f2 <proc_run+0x58>
        lcr3(proc->cr3);
ffffffffc02042ba:	755c                	ld	a5,168(a0)
...
ffffffffc02042bc:	800006b7          	lui	a3,0x80000
        current = proc;
ffffffffc02042c0:	e088                	sd	a0,0(s1)
ffffffffc02042c2:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc02042c6:	8fd5                	or	a5,a5,a3
ffffffffc02042c8:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(next->context));
ffffffffc02042cc:	03050593          	addi	a1,a0,48
ffffffffc02042d0:	03070513          	addi	a0,a4,48
ffffffffc02042d4:	64e000ef          	jal	ra,ffffffffc0204922 <switch_to>
    if (flag) {
ffffffffc02042d8:	00091763          	bnez	s2,ffffffffc02042e6 <proc_run+0x4c>
}
ffffffffc02042dc:	70a2                	ld	ra,40(sp)
ffffffffc02042de:	7482                	ld	s1,32(sp)
ffffffffc02042e0:	6962                	ld	s2,24(sp)
ffffffffc02042e2:	6145                	addi	sp,sp,48
ffffffffc02042e4:	8082                	ret
ffffffffc02042e6:	70a2                	ld	ra,40(sp)
ffffffffc02042e8:	7482                	ld	s1,32(sp)
ffffffffc02042ea:	6962                	ld	s2,24(sp)
ffffffffc02042ec:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc02042ee:	acefc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc02042f2:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc02042f4:	acefc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        struct proc_struct *prev = current;
ffffffffc02042f8:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc02042fa:	6522                	ld	a0,8(sp)
ffffffffc02042fc:	4905                	li	s2,1
ffffffffc02042fe:	bf75                	j	ffffffffc02042ba <proc_run+0x20>

ffffffffc0204300 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204300:	7139                	addi	sp,sp,-64
ffffffffc0204302:	f426                	sd	s1,40(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204304:	00012497          	auipc	s1,0x12
ffffffffc0204308:	2c448493          	addi	s1,s1,708 # ffffffffc02165c8 <nr_process>
ffffffffc020430c:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020430e:	fc06                	sd	ra,56(sp)
ffffffffc0204310:	f822                	sd	s0,48(sp)
...
ffffffffc0204318:	e456                	sd	s5,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020431a:	6785                	lui	a5,0x1
ffffffffc020431c:	28f75763          	bge	a4,a5,ffffffffc02045aa <do_fork+0x2aa>
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204320:	0e800513          	li	a0,232
ffffffffc0204324:	892e                	mv	s2,a1
ffffffffc0204326:	8432                	mv	s0,a2
ffffffffc0204328:	d26fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020432c:	89aa                	mv	s3,a0
    if (proc != NULL) {
ffffffffc020432e:	20050963          	beqz	a0,ffffffffc0204540 <do_fork+0x240>
        memset(proc, 0, sizeof(struct proc_struct));
ffffffffc0204332:	0e800613          	li	a2,232
ffffffffc0204336:	4581                	li	a1,0
ffffffffc0204338:	39b000ef          	jal	ra,ffffffffc0204ed2 <memset>
        proc->state = PROC_UNINIT;
ffffffffc020433c:	5a7d                	li	s4,-1
ffffffffc020433e:	020a1793          	slli	a5,s4,0x20
ffffffffc0204342:	00f9b023          	sd	a5,0(s3)
    proc->parent = current;//fork 产生的进程一定是由父进程产生的
ffffffffc0204346:	00012a97          	auipc	s5,0x12
ffffffffc020434a:	26aa8a93          	addi	s5,s5,618 # ffffffffc02165b0 <current>
ffffffffc020434e:	000ab783          	ld	a5,0(s5)
        proc->cr3 = boot_cr3;
ffffffffc0204352:	00012717          	auipc	a4,0x12
ffffffffc0204356:	20673703          	ld	a4,518(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc020435a:	0ae9b423          	sd	a4,168(s3)
    proc->parent = current;//fork 产生的进程一定是由父进程产生的
ffffffffc020435e:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204362:	4509                	li	a0,2
ffffffffc0204364:	ec8fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc0204368:	1e050b63          	beqz	a0,ffffffffc020455e <do_fork+0x25e>
    return page - pages + nbase;
ffffffffc020436c:	00012697          	auipc	a3,0x12
ffffffffc0204370:	2046b683          	ld	a3,516(a3) # ffffffffc0216570 <pages>
ffffffffc0204374:	40d506b3          	sub	a3,a0,a3
ffffffffc0204378:	8699                	srai	a3,a3,0x6
ffffffffc020437a:	00003517          	auipc	a0,0x3
ffffffffc020437e:	c8653503          	ld	a0,-890(a0) # ffffffffc0207000 <nbase>
ffffffffc0204382:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc0204384:	00ca5a13          	srli	s4,s4,0xc
ffffffffc0204388:	0146fa33          	and	s4,a3,s4
ffffffffc020438c:	00012797          	auipc	a5,0x12
ffffffffc0204390:	1dc7b783          	ld	a5,476(a5) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc0204394:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204396:	22fa7f63          	bgeu	s4,a5,ffffffffc02045d4 <do_fork+0x2d4>
    assert(current->mm == NULL);
ffffffffc020439a:	000ab783          	ld	a5,0(s5)
ffffffffc020439e:	00012717          	auipc	a4,0x12
ffffffffc02043a2:	1e273703          	ld	a4,482(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc02043a6:	96ba                	add	a3,a3,a4
ffffffffc02043a8:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043aa:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043ae:	20079363          	bnez	a5,ffffffffc02045b4 <do_fork+0x2b4>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043b2:	6789                	lui	a5,0x2
ffffffffc02043b4:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043b8:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02043ba:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043bc:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02043c0:	87b6                	mv	a5,a3
ffffffffc02043c2:	12040893          	addi	a7,s0,288
ffffffffc02043c6:	00063803          	ld	a6,0(a2)
ffffffffc02043ca:	6608                	ld	a0,8(a2)
ffffffffc02043cc:	6a0c                	ld	a1,16(a2)
ffffffffc02043ce:	6e18                	ld	a4,24(a2)
ffffffffc02043d0:	0107b023          	sd	a6,0(a5)
ffffffffc02043d4:	e788                	sd	a0,8(a5)
ffffffffc02043d6:	eb8c                	sd	a1,16(a5)
ffffffffc02043d8:	ef98                	sd	a4,24(a5)
ffffffffc02043da:	02060613          	addi	a2,a2,32
ffffffffc02043de:	02078793          	addi	a5,a5,32
ffffffffc02043e2:	ff1612e3          	bne	a2,a7,ffffffffc02043c6 <do_fork+0xc6>
    proc->tf->gpr.a0 = 0;//将返回值（a0）设置为 0 表示这是一个 fork 得到的子进程
ffffffffc02043e6:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02043ea:	12090663          	beqz	s2,ffffffffc0204516 <do_fork+0x216>
ffffffffc02043ee:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02043f2:	00000797          	auipc	a5,0x0
ffffffffc02043f6:	e2878793          	addi	a5,a5,-472 # ffffffffc020421a <forkret>
ffffffffc02043fa:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02043fe:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204402:	100027f3          	csrr	a5,sstatus
ffffffffc0204406:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204408:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020440a:	12079763          	bnez	a5,ffffffffc0204538 <do_fork+0x238>
    if (++ last_pid >= MAX_PID) {
ffffffffc020440e:	00007817          	auipc	a6,0x7
ffffffffc0204412:	c4a80813          	addi	a6,a6,-950 # ffffffffc020b058 <last_pid.1>
ffffffffc0204416:	00082783          	lw	a5,0(a6)
ffffffffc020441a:	6709                	lui	a4,0x2
ffffffffc020441c:	0017851b          	addiw	a0,a5,1
ffffffffc0204420:	00a82023          	sw	a0,0(a6)
ffffffffc0204424:	08e55263          	bge	a0,a4,ffffffffc02044a8 <do_fork+0x1a8>
    if (last_pid >= next_safe) {
ffffffffc0204428:	00007317          	auipc	t1,0x7
ffffffffc020442c:	c3430313          	addi	t1,t1,-972 # ffffffffc020b05c <next_safe.0>
ffffffffc0204430:	00032783          	lw	a5,0(t1)
ffffffffc0204434:	00012417          	auipc	s0,0x12
ffffffffc0204438:	0f440413          	addi	s0,s0,244 # ffffffffc0216528 <proc_list>
ffffffffc020443c:	06f55e63          	bge	a0,a5,ffffffffc02044b8 <do_fork+0x1b8>
    proc->pid = get_pid();
ffffffffc0204440:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204444:	45a9                	li	a1,10
ffffffffc0204446:	2501                	sext.w	a0,a0
ffffffffc0204448:	60a000ef          	jal	ra,ffffffffc0204a52 <hash32>
ffffffffc020444c:	02051793          	slli	a5,a0,0x20
ffffffffc0204450:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204454:	0000e797          	auipc	a5,0xe
ffffffffc0204458:	0c478793          	addi	a5,a5,196 # ffffffffc0212518 <hash_list>
ffffffffc020445c:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020445e:	6510                	ld	a2,8(a0)
ffffffffc0204460:	0d898793          	addi	a5,s3,216
ffffffffc0204464:	6414                	ld	a3,8(s0)
    nr_process++;
ffffffffc0204466:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc0204468:	e21c                	sd	a5,0(a2)
ffffffffc020446a:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc020446c:	0ec9b023          	sd	a2,224(s3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0204470:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc0204474:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc0204478:	e29c                	sd	a5,0(a3)
    nr_process++;
ffffffffc020447a:	2705                	addiw	a4,a4,1
ffffffffc020447c:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc020447e:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc0204482:	0c89b423          	sd	s0,200(s3)
ffffffffc0204486:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc0204488:	0a091e63          	bnez	s2,ffffffffc0204544 <do_fork+0x244>
    wakeup_proc(proc);// 进程状态设置为 PROC_RUNNABLE,至此完成了初始化工作,之后会在cpu_idle中进行调度
ffffffffc020448c:	854e                	mv	a0,s3
ffffffffc020448e:	4fe000ef          	jal	ra,ffffffffc020498c <wakeup_proc>
    ret = proc->pid;
ffffffffc0204492:	0049a503          	lw	a0,4(s3)
}
...
ffffffffc02044aa:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044ae:	4505                	li	a0,1
ffffffffc02044b0:	00007317          	auipc	t1,0x7
ffffffffc02044b4:	bac30313          	addi	t1,t1,-1108 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc02044b8:	00012417          	auipc	s0,0x12
ffffffffc02044bc:	07040413          	addi	s0,s0,112 # ffffffffc0216528 <proc_list>
ffffffffc02044c0:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02044c4:	6789                	lui	a5,0x2
ffffffffc02044c6:	00f32023          	sw	a5,0(t1)
ffffffffc02044ca:	86aa                	mv	a3,a0
ffffffffc02044cc:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02044ce:	6e89                	lui	t4,0x2
ffffffffc02044d0:	088e0263          	beq	t3,s0,ffffffffc0204554 <do_fork+0x254>
ffffffffc02044d4:	88ae                	mv	a7,a1
ffffffffc02044d6:	87f2                	mv	a5,t3
ffffffffc02044d8:	6609                	lui	a2,0x2
ffffffffc02044da:	a811                	j	ffffffffc02044ee <do_fork+0x1ee>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044dc:	00e6d663          	bge	a3,a4,ffffffffc02044e8 <do_fork+0x1e8>
ffffffffc02044e0:	00c75463          	bge	a4,a2,ffffffffc02044e8 <do_fork+0x1e8>
ffffffffc02044e4:	863a                	mv	a2,a4
ffffffffc02044e6:	4885                	li	a7,1
ffffffffc02044e8:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02044ea:	00878d63          	beq	a5,s0,ffffffffc0204504 <do_fork+0x204>
            if (proc->pid == last_pid) {
ffffffffc02044ee:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc02044f2:	fed715e3          	bne	a4,a3,ffffffffc02044dc <do_fork+0x1dc>
                if (++ last_pid >= next_safe) {
ffffffffc02044f6:	2685                	addiw	a3,a3,1
ffffffffc02044f8:	04c6d963          	bge	a3,a2,ffffffffc020454a <do_fork+0x24a>
ffffffffc02044fc:	679c                	ld	a5,8(a5)
ffffffffc02044fe:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204500:	fe8797e3          	bne	a5,s0,ffffffffc02044ee <do_fork+0x1ee>
ffffffffc0204504:	c581                	beqz	a1,ffffffffc020450c <do_fork+0x20c>
ffffffffc0204506:	00d82023          	sw	a3,0(a6)
ffffffffc020450a:	8536                	mv	a0,a3
ffffffffc020450c:	f2088ae3          	beqz	a7,ffffffffc0204440 <do_fork+0x140>
ffffffffc0204510:	00c32023          	sw	a2,0(t1)
ffffffffc0204514:	b735                	j	ffffffffc0204440 <do_fork+0x140>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204516:	8936                	mv	s2,a3
ffffffffc0204518:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020451c:	00000797          	auipc	a5,0x0
ffffffffc0204520:	cfe78793          	addi	a5,a5,-770 # ffffffffc020421a <forkret>
ffffffffc0204524:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204528:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204532:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204534:	ec078de3          	beqz	a5,ffffffffc020440e <do_fork+0x10e>
        intr_disable();
ffffffffc0204538:	88afc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020453c:	4905                	li	s2,1
ffffffffc020453e:	bdc1                	j	ffffffffc020440e <do_fork+0x10e>
    ret = -E_NO_MEM;
ffffffffc0204540:	5571                	li	a0,-4
    return ret;
ffffffffc0204542:	bf91                	j	ffffffffc0204496 <do_fork+0x196>
        intr_enable();
ffffffffc0204544:	878fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc0204548:	b791                	j	ffffffffc020448c <do_fork+0x18c>
                    if (last_pid >= MAX_PID) {
ffffffffc020454a:	01d6c363          	blt	a3,t4,ffffffffc0204550 <do_fork+0x250>
                        last_pid = 1;
ffffffffc020454e:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204550:	4585                	li	a1,1
ffffffffc0204552:	bfbd                	j	ffffffffc02044d0 <do_fork+0x1d0>
ffffffffc0204554:	cda9                	beqz	a1,ffffffffc02045ae <do_fork+0x2ae>
ffffffffc0204556:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020455a:	8536                	mv	a0,a3
ffffffffc020455c:	b5d5                	j	ffffffffc0204440 <do_fork+0x140>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020455e:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc0204562:	c02007b7          	lui	a5,0xc0200
ffffffffc0204566:	08f6ef63          	bltu	a3,a5,ffffffffc0204604 <do_fork+0x304>
ffffffffc020456a:	00012797          	auipc	a5,0x12
ffffffffc020456e:	0167b783          	ld	a5,22(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc0204572:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0204576:	83b1                	srli	a5,a5,0xc
ffffffffc0204578:	00012717          	auipc	a4,0x12
ffffffffc020457c:	ff073703          	ld	a4,-16(a4) # ffffffffc0216568 <npage>
ffffffffc0204580:	06e7f663          	bgeu	a5,a4,ffffffffc02045ec <do_fork+0x2ec>
    return &pages[PPN(pa) - nbase];
ffffffffc0204584:	00003717          	auipc	a4,0x3
ffffffffc0204588:	a7c73703          	ld	a4,-1412(a4) # ffffffffc0207000 <nbase>
ffffffffc020458c:	8f99                	sub	a5,a5,a4
ffffffffc020458e:	079a                	slli	a5,a5,0x6
ffffffffc0204590:	00012517          	auipc	a0,0x12
ffffffffc0204594:	fe053503          	ld	a0,-32(a0) # ffffffffc0216570 <pages>
ffffffffc0204598:	953e                	add	a0,a0,a5
ffffffffc020459a:	4589                	li	a1,2
ffffffffc020459c:	d22fd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045a0:	854e                	mv	a0,s3
ffffffffc02045a2:	b5cfd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045a6:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045a8:	b5fd                	j	ffffffffc0204496 <do_fork+0x196>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045aa:	556d                	li	a0,-5
ffffffffc02045ac:	b5ed                	j	ffffffffc0204496 <do_fork+0x196>
    return last_pid;
ffffffffc02045ae:	00082503          	lw	a0,0(a6)
ffffffffc02045b2:	b579                	j	ffffffffc0204440 <do_fork+0x140>
    assert(current->mm == NULL);
ffffffffc02045b4:	00002697          	auipc	a3,0x2
ffffffffc02045b8:	6ac68693          	addi	a3,a3,1708 # ffffffffc0206c60 <default_pmm_manager+0xff0>
ffffffffc02045bc:	00001617          	auipc	a2,0x1
ffffffffc02045c0:	30460613          	addi	a2,a2,772 # ffffffffc02058c0 <commands+0x738>
ffffffffc02045c4:	10f00593          	li	a1,271
ffffffffc02045c8:	00002517          	auipc	a0,0x2
ffffffffc02045cc:	6b050513          	addi	a0,a0,1712 # ffffffffc0206c78 <default_pmm_manager+0x1008>
ffffffffc02045d0:	e77fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02045d4:	00001617          	auipc	a2,0x1
ffffffffc02045d8:	6d460613          	addi	a2,a2,1748 # ffffffffc0205ca8 <default_pmm_manager+0x38>
ffffffffc02045dc:	06900593          	li	a1,105
ffffffffc02045e0:	00001517          	auipc	a0,0x1
ffffffffc02045e4:	6f050513          	addi	a0,a0,1776 # ffffffffc0205cd0 <default_pmm_manager+0x60>
ffffffffc02045e8:	e5ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02045ec:	00001617          	auipc	a2,0x1
ffffffffc02045f0:	78c60613          	addi	a2,a2,1932 # ffffffffc0205d78 <default_pmm_manager+0x108>
ffffffffc02045f4:	06200593          	li	a1,98
ffffffffc02045f8:	00001517          	auipc	a0,0x1
ffffffffc02045fc:	6d850513          	addi	a0,a0,1752 # ffffffffc0205cd0 <default_pmm_manager+0x60>
ffffffffc0204600:	e47fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204604:	00001617          	auipc	a2,0x1
ffffffffc0204608:	74c60613          	addi	a2,a2,1868 # ffffffffc0205d50 <default_pmm_manager+0xe0>
ffffffffc020460c:	06e00593          	li	a1,110
ffffffffc0204610:	00001517          	auipc	a0,0x1
ffffffffc0204614:	6c050513          	addi	a0,a0,1728 # ffffffffc0205cd0 <default_pmm_manager+0x60>
ffffffffc0204618:	e2ffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020461c <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020461c:	7129                	addi	sp,sp,-320
ffffffffc020461e:	fa22                	sd	s0,304(sp)
ffffffffc0204620:	f626                	sd	s1,296(sp)
ffffffffc0204622:	f24a                	sd	s2,288(sp)
ffffffffc0204624:	84ae                	mv	s1,a1
ffffffffc0204626:	892a                	mv	s2,a0
ffffffffc0204628:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020462a:	4581                	li	a1,0
ffffffffc020462c:	12000613          	li	a2,288
ffffffffc0204630:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204632:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204634:	09f000ef          	jal	ra,ffffffffc0204ed2 <memset>
    tf.gpr.s0 = (uintptr_t)fn;// s0 寄存器保存函数指针
ffffffffc0204638:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;// s1 寄存器保存函数参数
ffffffffc020463a:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020463c:	100027f3          	csrr	a5,sstatus
ffffffffc0204640:	edd7f793          	andi	a5,a5,-291
ffffffffc0204644:	1207e793          	ori	a5,a5,288
ffffffffc0204648:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020464a:	860a                	mv	a2,sp
ffffffffc020464c:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204650:	00000797          	auipc	a5,0x0
ffffffffc0204654:	bc278793          	addi	a5,a5,-1086 # ffffffffc0204212 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204658:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020465a:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020465c:	ca5ff0ef          	jal	ra,ffffffffc0204300 <do_fork>
}
ffffffffc0204660:	70f2                	ld	ra,312(sp)
ffffffffc0204662:	7452                	ld	s0,304(sp)
ffffffffc0204664:	74b2                	ld	s1,296(sp)
ffffffffc0204666:	7912                	ld	s2,288(sp)
ffffffffc0204668:	6131                	addi	sp,sp,320
ffffffffc020466a:	8082                	ret

ffffffffc020466c <do_exit>:
do_exit(int error_code) {
ffffffffc020466c:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc020466e:	00002617          	auipc	a2,0x2
ffffffffc0204672:	62260613          	addi	a2,a2,1570 # ffffffffc0206c90 <default_pmm_manager+0x1020>
ffffffffc0204676:	17b00593          	li	a1,379
ffffffffc020467a:	00002517          	auipc	a0,0x2
ffffffffc020467e:	5fe50513          	addi	a0,a0,1534 # ffffffffc0206c78 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc0204682:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204684:	dc3fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204688 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0204688:	7139                	addi	sp,sp,-64
ffffffffc020468a:	f426                	sd	s1,40(sp)
    elm->prev = elm->next = elm;
ffffffffc020468c:	00012797          	auipc	a5,0x12
ffffffffc0204690:	e9c78793          	addi	a5,a5,-356 # ffffffffc0216528 <proc_list>
ffffffffc0204694:	fc06                	sd	ra,56(sp)
ffffffffc0204696:	f822                	sd	s0,48(sp)
ffffffffc0204698:	f04a                	sd	s2,32(sp)
ffffffffc020469a:	ec4e                	sd	s3,24(sp)
ffffffffc020469c:	e852                	sd	s4,16(sp)
ffffffffc020469e:	e456                	sd	s5,8(sp)
ffffffffc02046a0:	0000e497          	auipc	s1,0xe
ffffffffc02046a4:	e7848493          	addi	s1,s1,-392 # ffffffffc0212518 <hash_list>
ffffffffc02046a8:	e79c                	sd	a5,8(a5)
ffffffffc02046aa:	e39c                	sd	a5,0(a5)
    int i;
...
ffffffffc02046b0:	e6c70713          	addi	a4,a4,-404 # ffffffffc0216518 <name.2>
ffffffffc02046b4:	87a6                	mv	a5,s1
ffffffffc02046b6:	e79c                	sd	a5,8(a5)
ffffffffc02046b8:	e39c                	sd	a5,0(a5)
ffffffffc02046ba:	07c1                	addi	a5,a5,16
ffffffffc02046bc:	fef71de3          	bne	a4,a5,ffffffffc02046b6 <proc_init+0x2e>
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc02046c0:	0e800513          	li	a0,232
ffffffffc02046c4:	98afd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc02046c8:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc02046ca:	1c050263          	beqz	a0,ffffffffc020488e <proc_init+0x206>
        proc->state = PROC_UNINIT;
ffffffffc02046ce:	59fd                	li	s3,-1
        memset(proc, 0, sizeof(struct proc_struct));
ffffffffc02046d0:	0e800613          	li	a2,232
ffffffffc02046d4:	4581                	li	a1,0
        proc->state = PROC_UNINIT;
ffffffffc02046d6:	1982                	slli	s3,s3,0x20
        memset(proc, 0, sizeof(struct proc_struct));
ffffffffc02046d8:	7fa000ef          	jal	ra,ffffffffc0204ed2 <memset>
        proc->cr3 = boot_cr3;
ffffffffc02046dc:	00012a97          	auipc	s5,0x12
ffffffffc02046e0:	e7ca8a93          	addi	s5,s5,-388 # ffffffffc0216558 <boot_cr3>
        proc->state = PROC_UNINIT;
ffffffffc02046e4:	01343023          	sd	s3,0(s0)
        proc->cr3 = boot_cr3;
ffffffffc02046e8:	000ab783          	ld	a5,0(s5)
        list_init(hash_list + i);
    }
    //alloc_proc() 函数分配并初始化一个新的进程结构体，返回 idleproc（空闲进程）的指针。
    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046ec:	00012917          	auipc	s2,0x12
ffffffffc02046f0:	ecc90913          	addi	s2,s2,-308 # ffffffffc02165b8 <idleproc>
    }
...
ffffffffc02046f4:	07000513          	li	a0,112
        proc->cr3 = boot_cr3;
ffffffffc02046f8:	f45c                	sd	a5,168(s0)
    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046fa:	00893023          	sd	s0,0(s2)
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046fe:	950fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc0204708:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020470a:	7c8000ef          	jal	ra,ffffffffc0204ed2 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc020470e:	00093503          	ld	a0,0(s2)
ffffffffc0204712:	85a2                	mv	a1,s0
ffffffffc0204714:	07000613          	li	a2,112
ffffffffc0204718:	03050513          	addi	a0,a0,48
ffffffffc020471c:	7e0000ef          	jal	ra,ffffffffc0204efc <memcmp>
ffffffffc0204720:	8a2a                	mv	s4,a0
...
ffffffffc020472c:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020472e:	7a4000ef          	jal	ra,ffffffffc0204ed2 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204732:	00093503          	ld	a0,0(s2)
ffffffffc0204736:	463d                	li	a2,15
ffffffffc0204738:	85a2                	mv	a1,s0
ffffffffc020473a:	0b450513          	addi	a0,a0,180
ffffffffc020473e:	7be000ef          	jal	ra,ffffffffc0204efc <memcmp>
...
ffffffffc0204742:	00093783          	ld	a5,0(s2)
ffffffffc0204746:	000ab703          	ld	a4,0(s5)
ffffffffc020474a:	77d4                	ld	a3,168(a5)
ffffffffc020474c:	0ee68663          	beq	a3,a4,ffffffffc0204838 <proc_init+0x1b0>
...
ffffffffc0204754:	00004717          	auipc	a4,0x4
ffffffffc0204758:	8ac70713          	addi	a4,a4,-1876 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020475c:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204760:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc0204762:	4705                	li	a4,1
ffffffffc0204764:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204766:	4641                	li	a2,16
ffffffffc0204768:	4581                	li	a1,0
ffffffffc020476a:	8522                	mv	a0,s0
ffffffffc020476c:	766000ef          	jal	ra,ffffffffc0204ed2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204770:	463d                	li	a2,15
ffffffffc0204772:	00002597          	auipc	a1,0x2
ffffffffc0204776:	54e58593          	addi	a1,a1,1358 # ffffffffc0206cc0 <default_pmm_manager+0x1050>
ffffffffc020477a:	8522                	mv	a0,s0
ffffffffc020477c:	768000ef          	jal	ra,ffffffffc0204ee4 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0204780:	00012717          	auipc	a4,0x12
ffffffffc0204784:	e4870713          	addi	a4,a4,-440 # ffffffffc02165c8 <nr_process>
ffffffffc0204788:	431c                	lw	a5,0(a4)

    current = idleproc;//set curr proc
ffffffffc020478a:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);//调用 kernel_thread 创建一个新的内核线程 init_main
ffffffffc020478e:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204790:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);//调用 kernel_thread 创建一个新的内核线程 init_main
ffffffffc0204792:	00002597          	auipc	a1,0x2
ffffffffc0204796:	53658593          	addi	a1,a1,1334 # ffffffffc0206cc8 <default_pmm_manager+0x1058>
ffffffffc020479a:	00000517          	auipc	a0,0x0
ffffffffc020479e:	a8e50513          	addi	a0,a0,-1394 # ffffffffc0204228 <init_main>
    nr_process ++;
ffffffffc02047a2:	c31c                	sw	a5,0(a4)
    current = idleproc;//set curr proc
ffffffffc02047a4:	00012797          	auipc	a5,0x12
ffffffffc02047a8:	e0d7b623          	sd	a3,-500(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);//调用 kernel_thread 创建一个新的内核线程 init_main
ffffffffc02047ac:	e71ff0ef          	jal	ra,ffffffffc020461c <kernel_thread>
ffffffffc02047b0:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047b2:	0ea05e63          	blez	a0,ffffffffc02048ae <proc_init+0x226>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047b6:	6789                	lui	a5,0x2
ffffffffc02047b8:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047bc:	17f9                	addi	a5,a5,-2
ffffffffc02047be:	2501                	sext.w	a0,a0
ffffffffc02047c0:	02e7e363          	bltu	a5,a4,ffffffffc02047e6 <proc_init+0x15e>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047c4:	45a9                	li	a1,10
ffffffffc02047c6:	28c000ef          	jal	ra,ffffffffc0204a52 <hash32>
ffffffffc02047ca:	02051793          	slli	a5,a0,0x20
ffffffffc02047ce:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047d2:	96a6                	add	a3,a3,s1
ffffffffc02047d4:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047d6:	a029                	j	ffffffffc02047e0 <proc_init+0x158>
            if (proc->pid == pid) {
ffffffffc02047d8:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc02047dc:	0a870663          	beq	a4,s0,ffffffffc0204888 <proc_init+0x200>
    return listelm->next;
ffffffffc02047e0:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02047e2:	fef69be3          	bne	a3,a5,ffffffffc02047d8 <proc_init+0x150>
    return NULL;
ffffffffc02047e6:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047e8:	0b478493          	addi	s1,a5,180
ffffffffc02047ec:	4641                	li	a2,16
ffffffffc02047ee:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }
    //根据进程 ID 查找 initproc 进程，并将其名称设置为 "init"。
    initproc = find_proc(pid);
ffffffffc02047f0:	00012417          	auipc	s0,0x12
ffffffffc02047f4:	dd040413          	addi	s0,s0,-560 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047f8:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047fa:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047fc:	6d6000ef          	jal	ra,ffffffffc0204ed2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204800:	463d                	li	a2,15
ffffffffc0204802:	00002597          	auipc	a1,0x2
ffffffffc0204806:	4f658593          	addi	a1,a1,1270 # ffffffffc0206cf8 <default_pmm_manager+0x1088>
ffffffffc020480a:	8526                	mv	a0,s1
ffffffffc020480c:	6d8000ef          	jal	ra,ffffffffc0204ee4 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204810:	00093783          	ld	a5,0(s2)
ffffffffc0204814:	cbe9                	beqz	a5,ffffffffc02048e6 <proc_init+0x25e>
ffffffffc0204816:	43dc                	lw	a5,4(a5)
ffffffffc0204818:	e7f9                	bnez	a5,ffffffffc02048e6 <proc_init+0x25e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020481a:	601c                	ld	a5,0(s0)
ffffffffc020481c:	c7cd                	beqz	a5,ffffffffc02048c6 <proc_init+0x23e>
ffffffffc020481e:	43d8                	lw	a4,4(a5)
ffffffffc0204820:	4785                	li	a5,1
ffffffffc0204822:	0af71263          	bne	a4,a5,ffffffffc02048c6 <proc_init+0x23e>
}
ffffffffc0204826:	70e2                	ld	ra,56(sp)
ffffffffc0204828:	7442                	ld	s0,48(sp)
ffffffffc020482a:	74a2                	ld	s1,40(sp)
ffffffffc020482c:	7902                	ld	s2,32(sp)
ffffffffc020482e:	69e2                	ld	s3,24(sp)
ffffffffc0204830:	6a42                	ld	s4,16(sp)
ffffffffc0204832:	6aa2                	ld	s5,8(sp)
ffffffffc0204834:	6121                	addi	sp,sp,64
ffffffffc0204836:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204838:	73d8                	ld	a4,160(a5)
ffffffffc020483a:	f0071be3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
ffffffffc020483e:	f00a19e3          	bnez	s4,ffffffffc0204750 <proc_init+0xc8>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204842:	6398                	ld	a4,0(a5)
ffffffffc0204844:	f13716e3          	bne	a4,s3,ffffffffc0204750 <proc_init+0xc8>
ffffffffc0204848:	4798                	lw	a4,8(a5)
ffffffffc020484a:	f00713e3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc020484e:	6b98                	ld	a4,16(a5)
ffffffffc0204850:	f00710e3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
ffffffffc0204854:	4f98                	lw	a4,24(a5)
ffffffffc0204856:	2701                	sext.w	a4,a4
ffffffffc0204858:	ee071ce3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
ffffffffc020485c:	7398                	ld	a4,32(a5)
ffffffffc020485e:	ee0719e3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204862:	7798                	ld	a4,40(a5)
ffffffffc0204864:	ee0716e3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
ffffffffc0204868:	0b07a703          	lw	a4,176(a5)
ffffffffc020486c:	8d59                	or	a0,a0,a4
ffffffffc020486e:	0005071b          	sext.w	a4,a0
ffffffffc0204872:	ec071fe3          	bnez	a4,ffffffffc0204750 <proc_init+0xc8>
        cprintf("alloc_proc() correct!\n");
ffffffffc0204876:	00002517          	auipc	a0,0x2
ffffffffc020487a:	43250513          	addi	a0,a0,1074 # ffffffffc0206ca8 <default_pmm_manager+0x1038>
ffffffffc020487e:	903fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc0204882:	00093783          	ld	a5,0(s2)
ffffffffc0204886:	b5e9                	j	ffffffffc0204750 <proc_init+0xc8>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204888:	f2878793          	addi	a5,a5,-216
ffffffffc020488c:	bfb1                	j	ffffffffc02047e8 <proc_init+0x160>
        panic("cannot alloc idleproc.\n");
ffffffffc020488e:	00002617          	auipc	a2,0x2
ffffffffc0204892:	4c260613          	addi	a2,a2,1218 # ffffffffc0206d50 <default_pmm_manager+0x10e0>
ffffffffc0204896:	19400593          	li	a1,404
ffffffffc020489a:	00002517          	auipc	a0,0x2
ffffffffc020489e:	3de50513          	addi	a0,a0,990 # ffffffffc0206c78 <default_pmm_manager+0x1008>
    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02048a2:	00012797          	auipc	a5,0x12
ffffffffc02048a6:	d007bb23          	sd	zero,-746(a5) # ffffffffc02165b8 <idleproc>
        panic("cannot alloc idleproc.\n");
ffffffffc02048aa:	b9dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048ae:	00002617          	auipc	a2,0x2
ffffffffc02048b2:	42a60613          	addi	a2,a2,1066 # ffffffffc0206cd8 <default_pmm_manager+0x1068>
ffffffffc02048b6:	1be00593          	li	a1,446
ffffffffc02048ba:	00002517          	auipc	a0,0x2
ffffffffc02048be:	3be50513          	addi	a0,a0,958 # ffffffffc0206c78 <default_pmm_manager+0x1008>
ffffffffc02048c2:	b85fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048c6:	00002697          	auipc	a3,0x2
ffffffffc02048ca:	46268693          	addi	a3,a3,1122 # ffffffffc0206d28 <default_pmm_manager+0x10b8>
ffffffffc02048ce:	00001617          	auipc	a2,0x1
ffffffffc02048d2:	ff260613          	addi	a2,a2,-14 # ffffffffc02058c0 <commands+0x738>
ffffffffc02048d6:	1c500593          	li	a1,453
ffffffffc02048da:	00002517          	auipc	a0,0x2
ffffffffc02048de:	39e50513          	addi	a0,a0,926 # ffffffffc0206c78 <default_pmm_manager+0x1008>
ffffffffc02048e2:	b65fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048e6:	00002697          	auipc	a3,0x2
ffffffffc02048ea:	41a68693          	addi	a3,a3,1050 # ffffffffc0206d00 <default_pmm_manager+0x1090>
ffffffffc02048ee:	00001617          	auipc	a2,0x1
ffffffffc02048f2:	fd260613          	addi	a2,a2,-46 # ffffffffc02058c0 <commands+0x738>
ffffffffc02048f6:	1c400593          	li	a1,452
ffffffffc02048fa:	00002517          	auipc	a0,0x2
ffffffffc02048fe:	37e50513          	addi	a0,a0,894 # ffffffffc0206c78 <default_pmm_manager+0x1008>
ffffffffc0204902:	b45fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204906 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204906:	1141                	addi	sp,sp,-16
ffffffffc0204908:	e022                	sd	s0,0(sp)
ffffffffc020490a:	e406                	sd	ra,8(sp)
ffffffffc020490c:	00012417          	auipc	s0,0x12
ffffffffc0204910:	ca440413          	addi	s0,s0,-860 # ffffffffc02165b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204914:	6018                	ld	a4,0(s0)
ffffffffc0204916:	4f1c                	lw	a5,24(a4)
ffffffffc0204918:	2781                	sext.w	a5,a5
ffffffffc020491a:	dff5                	beqz	a5,ffffffffc0204916 <cpu_idle+0x10>
            schedule();
ffffffffc020491c:	0a2000ef          	jal	ra,ffffffffc02049be <schedule>
ffffffffc0204920:	bfd5                	j	ffffffffc0204914 <cpu_idle+0xe>

ffffffffc0204922 <switch_to>:
.text
...
ffffffffc0204922:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204926:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020492a:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020492c:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020492e:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204932:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204936:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020493a:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020493e:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204942:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204946:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020494a:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020494e:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204952:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204956:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc020495a:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020495e:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204960:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204962:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204966:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc020496a:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020496e:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204972:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204976:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020497a:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020497e:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204982:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204986:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc020498a:	8082                	ret

ffffffffc020498c <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc020498c:	411c                	lw	a5,0(a0)
ffffffffc020498e:	4705                	li	a4,1
ffffffffc0204990:	37f9                	addiw	a5,a5,-2
ffffffffc0204992:	00f77563          	bgeu	a4,a5,ffffffffc020499c <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204996:	4789                	li	a5,2
ffffffffc0204998:	c11c                	sw	a5,0(a0)
ffffffffc020499a:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc020499c:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020499e:	00002697          	auipc	a3,0x2
ffffffffc02049a2:	3ca68693          	addi	a3,a3,970 # ffffffffc0206d68 <default_pmm_manager+0x10f8>
ffffffffc02049a6:	00001617          	auipc	a2,0x1
ffffffffc02049aa:	f1a60613          	addi	a2,a2,-230 # ffffffffc02058c0 <commands+0x738>
ffffffffc02049ae:	45a5                	li	a1,9
ffffffffc02049b0:	00002517          	auipc	a0,0x2
ffffffffc02049b4:	3f850513          	addi	a0,a0,1016 # ffffffffc0206da8 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049b8:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049ba:	a8dfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049be <schedule>:
}
...
ffffffffc02049c2:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049c4:	100027f3          	csrr	a5,sstatus
ffffffffc02049c8:	8b89                	andi	a5,a5,2
ffffffffc02049ca:	4401                	li	s0,0
ffffffffc02049cc:	efbd                	bnez	a5,ffffffffc0204a4a <schedule+0x8c>
...
ffffffffc02049ce:	00012897          	auipc	a7,0x12
ffffffffc02049d2:	be28b883          	ld	a7,-1054(a7) # ffffffffc02165b0 <current>
ffffffffc02049d6:	0008ac23          	sw	zero,24(a7)
        //如果当前进程是 idleproc，则从 proc_list 的开头开始查找下一个可运行进程。
        //否则，从当前进程的链表位置（list_link）开始查找。
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049da:	00012517          	auipc	a0,0x12
ffffffffc02049de:	bde53503          	ld	a0,-1058(a0) # ffffffffc02165b8 <idleproc>
ffffffffc02049e2:	04a88e63          	beq	a7,a0,ffffffffc0204a3e <schedule+0x80>
ffffffffc02049e6:	0c888693          	addi	a3,a7,200
ffffffffc02049ea:	00012617          	auipc	a2,0x12
ffffffffc02049ee:	b3e60613          	addi	a2,a2,-1218 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc02049f2:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02049f6:	4809                	li	a6,2
ffffffffc02049f8:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049fa:	00c78863          	beq	a5,a2,ffffffffc0204a0a <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049fe:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a02:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a06:	03070163          	beq	a4,a6,ffffffffc0204a28 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a0a:	fef697e3          	bne	a3,a5,ffffffffc02049f8 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a0e:	ed89                	bnez	a1,ffffffffc0204a28 <schedule+0x6a>
            next = idleproc;
        }
        /*增加所选进程的运行次数计数（runs）。
        如果所选进程与当前进程不同，则调用 proc_run(next) 进行上下文切换。*/
        next->runs ++;
ffffffffc0204a10:	451c                	lw	a5,8(a0)
ffffffffc0204a12:	2785                	addiw	a5,a5,1
ffffffffc0204a14:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a16:	00a88463          	beq	a7,a0,ffffffffc0204a1e <schedule+0x60>
            proc_run(next);
ffffffffc0204a1a:	881ff0ef          	jal	ra,ffffffffc020429a <proc_run>
    if (flag) {
ffffffffc0204a1e:	e819                	bnez	s0,ffffffffc0204a34 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a20:	60a2                	ld	ra,8(sp)
ffffffffc0204a22:	6402                	ld	s0,0(sp)
ffffffffc0204a24:	0141                	addi	sp,sp,16
ffffffffc0204a26:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a28:	4198                	lw	a4,0(a1)
ffffffffc0204a2a:	4789                	li	a5,2
ffffffffc0204a2c:	fef712e3          	bne	a4,a5,ffffffffc0204a10 <schedule+0x52>
ffffffffc0204a30:	852e                	mv	a0,a1
ffffffffc0204a32:	bff9                	j	ffffffffc0204a10 <schedule+0x52>
}
ffffffffc0204a34:	6402                	ld	s0,0(sp)
ffffffffc0204a36:	60a2                	ld	ra,8(sp)
ffffffffc0204a38:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a3a:	b83fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a3e:	00012617          	auipc	a2,0x12
ffffffffc0204a42:	aea60613          	addi	a2,a2,-1302 # ffffffffc0216528 <proc_list>
ffffffffc0204a46:	86b2                	mv	a3,a2
ffffffffc0204a48:	b76d                	j	ffffffffc02049f2 <schedule+0x34>
        intr_disable();
ffffffffc0204a4a:	b79fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a4e:	4405                	li	s0,1
ffffffffc0204a50:	bfbd                	j	ffffffffc02049ce <schedule+0x10>

ffffffffc0204a52 <hash32>:
 *
...
ffffffffc0204a52:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a56:	2785                	addiw	a5,a5,1
ffffffffc0204a58:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a5c:	02000793          	li	a5,32
ffffffffc0204a60:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a62:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a66:	8082                	ret

ffffffffc0204a68 <printnum>:
 * */
static void
...
ffffffffc0204a68:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a6c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a6e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a72:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a74:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a78:	f022                	sd	s0,32(sp)
ffffffffc0204a7a:	ec26                	sd	s1,24(sp)
ffffffffc0204a7c:	e84a                	sd	s2,16(sp)
ffffffffc0204a7e:	f406                	sd	ra,40(sp)
ffffffffc0204a80:	e44e                	sd	s3,8(sp)
ffffffffc0204a82:	84aa                	mv	s1,a0
ffffffffc0204a84:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a86:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a8a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a8c:	03067e63          	bgeu	a2,a6,ffffffffc0204ac8 <printnum+0x60>
ffffffffc0204a90:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a92:	00805763          	blez	s0,ffffffffc0204aa0 <printnum+0x38>
ffffffffc0204a96:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a98:	85ca                	mv	a1,s2
ffffffffc0204a9a:	854e                	mv	a0,s3
ffffffffc0204a9c:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a9e:	fc65                	bnez	s0,ffffffffc0204a96 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aa0:	1a02                	slli	s4,s4,0x20
ffffffffc0204aa2:	00002797          	auipc	a5,0x2
ffffffffc0204aa6:	31e78793          	addi	a5,a5,798 # ffffffffc0206dc0 <default_pmm_manager+0x1150>
ffffffffc0204aaa:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204aae:	9a3e                	add	s4,s4,a5
}
ffffffffc0204ab0:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ab2:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204ab6:	70a2                	ld	ra,40(sp)
ffffffffc0204ab8:	69a2                	ld	s3,8(sp)
ffffffffc0204aba:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204abc:	85ca                	mv	a1,s2
ffffffffc0204abe:	87a6                	mv	a5,s1
}
ffffffffc0204ac0:	6942                	ld	s2,16(sp)
ffffffffc0204ac2:	64e2                	ld	s1,24(sp)
ffffffffc0204ac4:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ac6:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ac8:	03065633          	divu	a2,a2,a6
ffffffffc0204acc:	8722                	mv	a4,s0
ffffffffc0204ace:	f9bff0ef          	jal	ra,ffffffffc0204a68 <printnum>
ffffffffc0204ad2:	b7f9                	j	ffffffffc0204aa0 <printnum+0x38>

ffffffffc0204ad4 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204ad4:	7119                	addi	sp,sp,-128
ffffffffc0204ad6:	f4a6                	sd	s1,104(sp)
ffffffffc0204ad8:	f0ca                	sd	s2,96(sp)
ffffffffc0204ada:	ecce                	sd	s3,88(sp)
ffffffffc0204adc:	e8d2                	sd	s4,80(sp)
ffffffffc0204ade:	e4d6                	sd	s5,72(sp)
ffffffffc0204ae0:	e0da                	sd	s6,64(sp)
ffffffffc0204ae2:	fc5e                	sd	s7,56(sp)
ffffffffc0204ae4:	f06a                	sd	s10,32(sp)
ffffffffc0204ae6:	fc86                	sd	ra,120(sp)
ffffffffc0204ae8:	f8a2                	sd	s0,112(sp)
ffffffffc0204aea:	f862                	sd	s8,48(sp)
ffffffffc0204aec:	f466                	sd	s9,40(sp)
ffffffffc0204aee:	ec6e                	sd	s11,24(sp)
ffffffffc0204af0:	892a                	mv	s2,a0
ffffffffc0204af2:	84ae                	mv	s1,a1
ffffffffc0204af4:	8d32                	mv	s10,a2
ffffffffc0204af6:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204af8:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204afc:	5b7d                	li	s6,-1
ffffffffc0204afe:	00002a97          	auipc	s5,0x2
ffffffffc0204b02:	2eea8a93          	addi	s5,s5,750 # ffffffffc0206dec <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b06:	00002b97          	auipc	s7,0x2
ffffffffc0204b0a:	4c2b8b93          	addi	s7,s7,1218 # ffffffffc0206fc8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b0e:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b12:	001d0413          	addi	s0,s10,1
ffffffffc0204b16:	01350a63          	beq	a0,s3,ffffffffc0204b2a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b1a:	c121                	beqz	a0,ffffffffc0204b5a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204b1c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b1e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204b20:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b22:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b26:	ff351ae3          	bne	a0,s3,ffffffffc0204b1a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b2a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b2e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b32:	4c81                	li	s9,0
ffffffffc0204b34:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b36:	5c7d                	li	s8,-1
ffffffffc0204b38:	5dfd                	li	s11,-1
ffffffffc0204b3a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b3e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b40:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b44:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b48:	00140d13          	addi	s10,s0,1
ffffffffc0204b4c:	04b56263          	bltu	a0,a1,ffffffffc0204b90 <vprintfmt+0xbc>
ffffffffc0204b50:	058a                	slli	a1,a1,0x2
ffffffffc0204b52:	95d6                	add	a1,a1,s5
ffffffffc0204b54:	4194                	lw	a3,0(a1)
ffffffffc0204b56:	96d6                	add	a3,a3,s5
ffffffffc0204b58:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b5a:	70e6                	ld	ra,120(sp)
ffffffffc0204b5c:	7446                	ld	s0,112(sp)
ffffffffc0204b5e:	74a6                	ld	s1,104(sp)
ffffffffc0204b60:	7906                	ld	s2,96(sp)
ffffffffc0204b62:	69e6                	ld	s3,88(sp)
ffffffffc0204b64:	6a46                	ld	s4,80(sp)
ffffffffc0204b66:	6aa6                	ld	s5,72(sp)
ffffffffc0204b68:	6b06                	ld	s6,64(sp)
ffffffffc0204b6a:	7be2                	ld	s7,56(sp)
ffffffffc0204b6c:	7c42                	ld	s8,48(sp)
ffffffffc0204b6e:	7ca2                	ld	s9,40(sp)
ffffffffc0204b70:	7d02                	ld	s10,32(sp)
ffffffffc0204b72:	6de2                	ld	s11,24(sp)
ffffffffc0204b74:	6109                	addi	sp,sp,128
ffffffffc0204b76:	8082                	ret
            padc = '0';
ffffffffc0204b78:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b7a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b7e:	846a                	mv	s0,s10
ffffffffc0204b80:	00140d13          	addi	s10,s0,1
ffffffffc0204b84:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b88:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b8c:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b50 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b90:	85a6                	mv	a1,s1
ffffffffc0204b92:	02500513          	li	a0,37
ffffffffc0204b96:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b98:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b9c:	8d22                	mv	s10,s0
ffffffffc0204b9e:	f73788e3          	beq	a5,s3,ffffffffc0204b0e <vprintfmt+0x3a>
ffffffffc0204ba2:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204ba6:	1d7d                	addi	s10,s10,-1
ffffffffc0204ba8:	ff379de3          	bne	a5,s3,ffffffffc0204ba2 <vprintfmt+0xce>
ffffffffc0204bac:	b78d                	j	ffffffffc0204b0e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bae:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bb2:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb6:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204bb8:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204bbc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bc0:	02d86463          	bltu	a6,a3,ffffffffc0204be8 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bc4:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bc8:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bcc:	0186873b          	addw	a4,a3,s8
ffffffffc0204bd0:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bd4:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bd6:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bda:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bdc:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204be0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204be4:	fed870e3          	bgeu	a6,a3,ffffffffc0204bc4 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204be8:	f40ddce3          	bgez	s11,ffffffffc0204b40 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bec:	8de2                	mv	s11,s8
ffffffffc0204bee:	5c7d                	li	s8,-1
ffffffffc0204bf0:	bf81                	j	ffffffffc0204b40 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bf2:	fffdc693          	not	a3,s11
ffffffffc0204bf6:	96fd                	srai	a3,a3,0x3f
ffffffffc0204bf8:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bfc:	00144603          	lbu	a2,1(s0)
ffffffffc0204c00:	2d81                	sext.w	s11,s11
ffffffffc0204c02:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c04:	bf35                	j	ffffffffc0204b40 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c06:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c0a:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c0e:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c10:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c12:	bfd9                	j	ffffffffc0204be8 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c14:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c16:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c1a:	01174463          	blt	a4,a7,ffffffffc0204c22 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c1e:	1a088e63          	beqz	a7,ffffffffc0204dda <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c22:	000a3603          	ld	a2,0(s4)
ffffffffc0204c26:	46c1                	li	a3,16
ffffffffc0204c28:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c2a:	2781                	sext.w	a5,a5
ffffffffc0204c2c:	876e                	mv	a4,s11
ffffffffc0204c2e:	85a6                	mv	a1,s1
ffffffffc0204c30:	854a                	mv	a0,s2
ffffffffc0204c32:	e37ff0ef          	jal	ra,ffffffffc0204a68 <printnum>
            break;
ffffffffc0204c36:	bde1                	j	ffffffffc0204b0e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c38:	000a2503          	lw	a0,0(s4)
ffffffffc0204c3c:	85a6                	mv	a1,s1
ffffffffc0204c3e:	0a21                	addi	s4,s4,8
ffffffffc0204c40:	9902                	jalr	s2
            break;
ffffffffc0204c42:	b5f1                	j	ffffffffc0204b0e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c44:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c46:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c4a:	01174463          	blt	a4,a7,ffffffffc0204c52 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c4e:	18088163          	beqz	a7,ffffffffc0204dd0 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c52:	000a3603          	ld	a2,0(s4)
ffffffffc0204c56:	46a9                	li	a3,10
ffffffffc0204c58:	8a2e                	mv	s4,a1
ffffffffc0204c5a:	bfc1                	j	ffffffffc0204c2a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c5c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c60:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c62:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c64:	bdf1                	j	ffffffffc0204b40 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c66:	85a6                	mv	a1,s1
ffffffffc0204c68:	02500513          	li	a0,37
ffffffffc0204c6c:	9902                	jalr	s2
            break;
ffffffffc0204c6e:	b545                	j	ffffffffc0204b0e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c70:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c74:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c76:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c78:	b5e1                	j	ffffffffc0204b40 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c7a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c7c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c80:	01174463          	blt	a4,a7,ffffffffc0204c88 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c84:	14088163          	beqz	a7,ffffffffc0204dc6 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c88:	000a3603          	ld	a2,0(s4)
ffffffffc0204c8c:	46a1                	li	a3,8
ffffffffc0204c8e:	8a2e                	mv	s4,a1
ffffffffc0204c90:	bf69                	j	ffffffffc0204c2a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c92:	03000513          	li	a0,48
ffffffffc0204c96:	85a6                	mv	a1,s1
ffffffffc0204c98:	e03e                	sd	a5,0(sp)
ffffffffc0204c9a:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c9c:	85a6                	mv	a1,s1
ffffffffc0204c9e:	07800513          	li	a0,120
ffffffffc0204ca2:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204ca4:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204ca6:	6782                	ld	a5,0(sp)
ffffffffc0204ca8:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204caa:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204cae:	bfb5                	j	ffffffffc0204c2a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cb0:	000a3403          	ld	s0,0(s4)
ffffffffc0204cb4:	008a0713          	addi	a4,s4,8
ffffffffc0204cb8:	e03a                	sd	a4,0(sp)
ffffffffc0204cba:	14040263          	beqz	s0,ffffffffc0204dfe <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cbe:	0fb05763          	blez	s11,ffffffffc0204dac <vprintfmt+0x2d8>
ffffffffc0204cc2:	02d00693          	li	a3,45
ffffffffc0204cc6:	0cd79163          	bne	a5,a3,ffffffffc0204d88 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cca:	00044783          	lbu	a5,0(s0)
ffffffffc0204cce:	0007851b          	sext.w	a0,a5
ffffffffc0204cd2:	cf85                	beqz	a5,ffffffffc0204d0a <vprintfmt+0x236>
ffffffffc0204cd4:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cd8:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cdc:	000c4563          	bltz	s8,ffffffffc0204ce6 <vprintfmt+0x212>
ffffffffc0204ce0:	3c7d                	addiw	s8,s8,-1
ffffffffc0204ce2:	036c0263          	beq	s8,s6,ffffffffc0204d06 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204ce6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204ce8:	0e0c8e63          	beqz	s9,ffffffffc0204de4 <vprintfmt+0x310>
ffffffffc0204cec:	3781                	addiw	a5,a5,-32
ffffffffc0204cee:	0ef47b63          	bgeu	s0,a5,ffffffffc0204de4 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cf2:	03f00513          	li	a0,63
ffffffffc0204cf6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cf8:	000a4783          	lbu	a5,0(s4)
ffffffffc0204cfc:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cfe:	0a05                	addi	s4,s4,1
ffffffffc0204d00:	0007851b          	sext.w	a0,a5
ffffffffc0204d04:	ffe1                	bnez	a5,ffffffffc0204cdc <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d06:	01b05963          	blez	s11,ffffffffc0204d18 <vprintfmt+0x244>
...
ffffffffc0204d12:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d14:	fe0d9be3          	bnez	s11,ffffffffc0204d0a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d18:	6a02                	ld	s4,0(sp)
ffffffffc0204d1a:	bbd5                	j	ffffffffc0204b0e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d1c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d1e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d22:	01174463          	blt	a4,a7,ffffffffc0204d2a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d26:	08088d63          	beqz	a7,ffffffffc0204dc0 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d2a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d2e:	0a044d63          	bltz	s0,ffffffffc0204de8 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d32:	8622                	mv	a2,s0
ffffffffc0204d34:	8a66                	mv	s4,s9
ffffffffc0204d36:	46a9                	li	a3,10
ffffffffc0204d38:	bdcd                	j	ffffffffc0204c2a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d3a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d3e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d40:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d42:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d46:	8fb5                	xor	a5,a5,a3
ffffffffc0204d48:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d4c:	02d74163          	blt	a4,a3,ffffffffc0204d6e <vprintfmt+0x29a>
ffffffffc0204d50:	00369793          	slli	a5,a3,0x3
ffffffffc0204d54:	97de                	add	a5,a5,s7
ffffffffc0204d56:	639c                	ld	a5,0(a5)
ffffffffc0204d58:	cb99                	beqz	a5,ffffffffc0204d6e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d5a:	86be                	mv	a3,a5
ffffffffc0204d5c:	00000617          	auipc	a2,0x0
ffffffffc0204d60:	1ec60613          	addi	a2,a2,492 # ffffffffc0204f48 <etext+0x28>
ffffffffc0204d64:	85a6                	mv	a1,s1
ffffffffc0204d66:	854a                	mv	a0,s2
ffffffffc0204d68:	0ce000ef          	jal	ra,ffffffffc0204e36 <printfmt>
ffffffffc0204d6c:	b34d                	j	ffffffffc0204b0e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d6e:	00002617          	auipc	a2,0x2
ffffffffc0204d72:	07260613          	addi	a2,a2,114 # ffffffffc0206de0 <default_pmm_manager+0x1170>
ffffffffc0204d76:	85a6                	mv	a1,s1
ffffffffc0204d78:	854a                	mv	a0,s2
ffffffffc0204d7a:	0bc000ef          	jal	ra,ffffffffc0204e36 <printfmt>
ffffffffc0204d7e:	bb41                	j	ffffffffc0204b0e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d80:	00002417          	auipc	s0,0x2
ffffffffc0204d84:	05840413          	addi	s0,s0,88 # ffffffffc0206dd8 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d88:	85e2                	mv	a1,s8
ffffffffc0204d8a:	8522                	mv	a0,s0
ffffffffc0204d8c:	e43e                	sd	a5,8(sp)
ffffffffc0204d8e:	0e2000ef          	jal	ra,ffffffffc0204e70 <strnlen>
ffffffffc0204d92:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d96:	01b05b63          	blez	s11,ffffffffc0204dac <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d9a:	67a2                	ld	a5,8(sp)
ffffffffc0204d9c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da0:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204da2:	85a6                	mv	a1,s1
ffffffffc0204da4:	8552                	mv	a0,s4
ffffffffc0204da6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da8:	fe0d9ce3          	bnez	s11,ffffffffc0204da0 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dac:	00044783          	lbu	a5,0(s0)
ffffffffc0204db0:	00140a13          	addi	s4,s0,1
ffffffffc0204db4:	0007851b          	sext.w	a0,a5
ffffffffc0204db8:	d3a5                	beqz	a5,ffffffffc0204d18 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dba:	05e00413          	li	s0,94
ffffffffc0204dbe:	bf39                	j	ffffffffc0204cdc <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dc0:	000a2403          	lw	s0,0(s4)
ffffffffc0204dc4:	b7ad                	j	ffffffffc0204d2e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204dc6:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dca:	46a1                	li	a3,8
ffffffffc0204dcc:	8a2e                	mv	s4,a1
ffffffffc0204dce:	bdb1                	j	ffffffffc0204c2a <vprintfmt+0x156>
ffffffffc0204dd0:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dd4:	46a9                	li	a3,10
ffffffffc0204dd6:	8a2e                	mv	s4,a1
ffffffffc0204dd8:	bd89                	j	ffffffffc0204c2a <vprintfmt+0x156>
ffffffffc0204dda:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dde:	46c1                	li	a3,16
ffffffffc0204de0:	8a2e                	mv	s4,a1
ffffffffc0204de2:	b5a1                	j	ffffffffc0204c2a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204de4:	9902                	jalr	s2
ffffffffc0204de6:	bf09                	j	ffffffffc0204cf8 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204de8:	85a6                	mv	a1,s1
ffffffffc0204dea:	02d00513          	li	a0,45
ffffffffc0204dee:	e03e                	sd	a5,0(sp)
ffffffffc0204df0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204df2:	6782                	ld	a5,0(sp)
ffffffffc0204df4:	8a66                	mv	s4,s9
ffffffffc0204df6:	40800633          	neg	a2,s0
ffffffffc0204dfa:	46a9                	li	a3,10
ffffffffc0204dfc:	b53d                	j	ffffffffc0204c2a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204dfe:	03b05163          	blez	s11,ffffffffc0204e20 <vprintfmt+0x34c>
ffffffffc0204e02:	02d00693          	li	a3,45
ffffffffc0204e06:	f6d79de3          	bne	a5,a3,ffffffffc0204d80 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e0a:	00002417          	auipc	s0,0x2
ffffffffc0204e0e:	fce40413          	addi	s0,s0,-50 # ffffffffc0206dd8 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e12:	02800793          	li	a5,40
ffffffffc0204e16:	02800513          	li	a0,40
ffffffffc0204e1a:	00140a13          	addi	s4,s0,1
ffffffffc0204e1e:	bd6d                	j	ffffffffc0204cd8 <vprintfmt+0x204>
ffffffffc0204e20:	00002a17          	auipc	s4,0x2
ffffffffc0204e24:	fb9a0a13          	addi	s4,s4,-71 # ffffffffc0206dd9 <default_pmm_manager+0x1169>
ffffffffc0204e28:	02800513          	li	a0,40
ffffffffc0204e2c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e30:	05e00413          	li	s0,94
ffffffffc0204e34:	b565                	j	ffffffffc0204cdc <vprintfmt+0x208>

ffffffffc0204e36 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e36:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e38:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
...
ffffffffc0204e4a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e4c:	c89ff0ef          	jal	ra,ffffffffc0204ad4 <vprintfmt>
}
ffffffffc0204e50:	60e2                	ld	ra,24(sp)
ffffffffc0204e52:	6161                	addi	sp,sp,80
...
ffffffffc0204e74:	a811                	j	ffffffffc0204e88 <strnlen+0x18>
        cnt ++;
ffffffffc0204e76:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
...
ffffffffc0204e92:	0785                	addi	a5,a5,1
ffffffffc0204e94:	0585                	addi	a1,a1,1
...
ffffffffc0204ea2:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ea6:	cb89                	beqz	a5,ffffffffc0204eb8 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ea8:	0505                	addi	a0,a0,1
ffffffffc0204eaa:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204eac:	fee789e3          	beq	a5,a4,ffffffffc0204e9e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eb0:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204eb4:	9d19                	subw	a0,a0,a4
ffffffffc0204eb6:	8082                	ret
ffffffffc0204eb8:	4501                	li	a0,0
ffffffffc0204eba:	bfed                	j	ffffffffc0204eb4 <strcmp+0x16>

ffffffffc0204ebc <strchr>:
...
ffffffffc0204ec0:	c799                	beqz	a5,ffffffffc0204ece <strchr+0x12>
        if (*s == c) {
ffffffffc0204ec2:	00f58763          	beq	a1,a5,ffffffffc0204ed0 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204ec6:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204eca:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204ecc:	fbfd                	bnez	a5,ffffffffc0204ec2 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204ed2:	ca01                	beqz	a2,ffffffffc0204ee2 <memset+0x10>
ffffffffc0204ed4:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ed6:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ed8:	0785                	addi	a5,a5,1
ffffffffc0204eda:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204ede:	fec79de3          	bne	a5,a2,ffffffffc0204ed8 <memset+0x6>
    }
    return s;
...
ffffffffc0204ee4 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204ee4:	ca19                	beqz	a2,ffffffffc0204efa <memcpy+0x16>
ffffffffc0204ee6:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204ee8:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204eea:	0005c703          	lbu	a4,0(a1)
ffffffffc0204eee:	0585                	addi	a1,a1,1
ffffffffc0204ef0:	0785                	addi	a5,a5,1
ffffffffc0204ef2:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204ef6:	fec59ae3          	bne	a1,a2,ffffffffc0204eea <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204efc:	c205                	beqz	a2,ffffffffc0204f1c <memcmp+0x20>
ffffffffc0204efe:	962e                	add	a2,a2,a1
ffffffffc0204f00:	a019                	j	ffffffffc0204f06 <memcmp+0xa>
ffffffffc0204f02:	00c58d63          	beq	a1,a2,ffffffffc0204f1c <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204f06:	00054783          	lbu	a5,0(a0)
ffffffffc0204f0a:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204f0e:	0505                	addi	a0,a0,1
ffffffffc0204f10:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f12:	fee788e3          	beq	a5,a4,ffffffffc0204f02 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f16:	40e7853b          	subw	a0,a5,a4
